// www.devildrey33.es
// Ejemplo 3.9 - Crear objeto Instalador
...
// NOTA2 los paths de los archivos a leer y escribir son relativos, si estas en modo debug la aplicacion se creara en \3.9 Tutorial crear ObjetoZLIB\Debug\
 ...
 protected :
  void						Crear(void) {
								CrearVentana( NULL, TEXT("MiVentana"), WS_OVERLAPPEDWINDOW | WS_VISIBLE, 
                                           TEXT("Ejemplo tutorial 3.9"), 100, 100, 400, 160, NULL );

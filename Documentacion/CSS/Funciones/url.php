...
<p>Esta función permite especificar un archivo externo.</p>
<p>Se puede utilizar en las propiedades <a href='/Doc/CSS/Propiedades/background'>background</a>,  <a href='/Doc/CSS/Propiedades/background'>background-image</a>, <a href='/Doc/CSS/Propiedades/filter'>filter</a>, y <a href='/Doc/CSS/Propiedades/clip-path'>clip-path</a>.</p>
...
Para la propiedad <code>clip-path</code> se puede especificar la url de un svg externo y la ID del objeto, o se puede especificar únicamente una ID si nos queremos referir a un objeto de un svg que esté dentro del mismo código html.
</div>
</div>
<br />

<p>Esta propiedad nos permite especificar el estilo del borde para la parte superior del objeto.</p>
<hr />
<h2>Sintaxis</h2>
<pre class='devildrey33_Marco Pre_Sintaxis'>border-top-style: <b>Valor</b>;</pre>
<table class='Tabla'>
    <tr>
        <td><b>none</b></td>
        <td>Sin borde.</td>

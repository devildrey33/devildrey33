...
<p>Esta propiedad permite definir un area no rectangular para un objeto, de forma que el navegador incluso es capaz de utilizar una figura SVG (path) para especificar la figura de un objeto.</p>
...
clip-path:url(#id_svg_inrustado_en_el_html)</pre>
    ...
    <tr>
        <td><b>inset()</b></td>
        <td>
            Especifica que el área a recortar será un rectangulo, el tamaño se puede especificar en pixeles o utilizando un porcentaje. 
...
clip-path:inset(10px 20px, 30px, 40px) /* 10 pixeles para el top, 20 pixeles para el right, 30 pixeles para el bottom, 40 pixeles para el left */                
    ...
    <tr>
        <td><b>circle()</b></td>
        <td>
            Especifica un circulo. El primer valor es el rádio (se puede especificar en pixeles o en porcentaje) y no es opcional, y luego se puede espeficicar la posición inicial añadiendo <code>at X Y</code>.
            Por Ejemplo :
            <pre>clip-path:circle(10% at 5px 10px) /* 10% de radio empezando 5 pixeles a la derecha y 10 desde arriba */
    ...
    <tr>
        <td><b>ellipse()</b></td>
        <td>Especifica una <i>figura básica</i>. Por defecto se tomaran las coordenadas del area del border-box, pero se puede especificar otra <i>área rectangular</i> pre-definida de referéncia desde donde partira la figura básica.</td>
    </tr>
    <tr>
        <td><b>polygon()</b></td>
        <td>Especifica una <i>figura básica</i>. Por defecto se tomaran las coordenadas del area del border-box, pero se puede especificar otra <i>área rectangular</i> pre-definida de referéncia desde donde partira la figura básica.</td>

<p>Esta propiedad nos permite especificar el color del borde para la parte superior del objeto.</p>
<hr />
<h2>Sintaxis</h2>
<pre class='devildrey33_Marco Pre_Sintaxis'>border-top-color: <b>Color</b> | <b>transparent</b> | <b>inherit</b>;</pre>
<table class='Tabla'>
    <tr>
        <td><b>Color</b></td>
        <td>Especifica el color del borde superior. Para mas información sobre los colores en CSS visita este enlace <a href="/Doc/CSS/Colores/" target="_blank">Referencia CSS : Colores</a></td>
    </tr>
    <tr>

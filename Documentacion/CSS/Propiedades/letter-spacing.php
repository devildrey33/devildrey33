...
<table class='Tabla'>
    ...
    <tr>
        ...
        <td>Especifica el espacio extra entre carácteres. Puedes especificar valores negativos también.<br />Para más información sobre los tipos de unidades consulta la <a href="/Doc/CSS/Unidades/" target="_blank" title='px, ex, em, %, cm, mm, in, pt, pc'>Referencia CSS : Unidades</a>
        </td>
    </tr>
    <tr>
        <td><b>inherit</b></td>

...
<hr />
<h2>Sintaxis</h2>
<pre class='devildrey33_Marco Pre_Sintaxis'>height: <b>tamaño</b>;</pre>
<table class='Tabla'>
    <tr>
        <td><b>auto</b></td>
        <td>El navegador calculara la altura. Este es el valor por defecto.</td>
    </tr>
    <tr>
        <td><i><b>tamaño</b></i></td>
        <td>Especifica la altura en cualquiera de las unidades válidas. Para más información consulta la <a href="/Doc/CSS/Unidades/" target="_blank" title='px, ex, em, %, cm, mm, in, pt, pc'>Referencia CSS : Unidades</a>.</td>
    </tr>
    <tr>
        <td><b>inherit</b></td>

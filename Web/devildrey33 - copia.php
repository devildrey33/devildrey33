...
//        "<link rel='alternate' type='application/rss+xml' title='RSS 2.0' href='http://devildrey33.es/rss.xml' />".Intro();
    ...
    "</head>".Intro();
        ...
        "<nav id='BarraPrincipal'>".Intro().
            ...
            "<label class='Menu_Boton_Label' for='BarraPrincipal_Boton_Estado'></label>".Intro().
            ...
            "<div id='BarraPrincipal_Submenus'>".Intro().
                ...
                "<div class='Menu' mostrar='true'>".Intro().
                    ...
                    "<label class='Menu_Boton_Label' for='BarraPrincipal_BotonCSS_Estado'></label>".Intro().
                    "<div class='Menu_Boton'>".Intro().
                ...
                "<div class='Menu' mostrar='true'>".Intro().
                    ...
                    "<label class='Menu_Boton_Label' for='BarraPrincipal_BotonCPP_Estado'></label>".Intro().
                    "<div class='Menu_Boton'>".Intro().
                        "<span class='Menu_Boton_Cruz'>".Intro().
...
//                "<a href='/Categorias/HTML' class='Menu_Boton'><span>HTML</span></a>".
                ...
                "<div class='Menu' mostrar='true'>".Intro().
                    ...
                    "<label class='Menu_Boton_Label' for='BarraPrincipal_BotonJS_Estado'></label>".Intro().
                    "<div class='Menu_Boton'>".Intro().
                        "<span class='Menu_Boton_Cruz'>".Intro().
                ...
                "<div class='Menu' mostrar='true'>".Intro().
                    ...
                    "<label class='Menu_Boton_Label' for='BarraPrincipal_BotonPHP_Estado'></label>".Intro().
                    "<div class='Menu_Boton'>".Intro().
                        "<span class='Menu_Boton_Cruz'>".Intro().
                ...
                "<div class='Menu' mostrar='true'>".Intro().
                    ...
                    "<label class='Menu_Boton_Label' for='BarraPrincipal_BotonBuscar_Estado'></label>".Intro().
                    "<div class='Menu_Boton'>".Intro().
                        "<span class='Menu_Boton_Cruz'>".Intro().
...
/*                        "<span></span>".Intro().  */
                ...
                "<div id ='BarraNavegacion_LabMarcoVer'>".Intro().                                       
                    ...
                    "<label tooltip-es='Ver Filas' tooltip-en='Rows' tooltip-pos='T' class='Menu_Boton_Label Lab_BotonVerFilas' for='Lab_VerFilas_Estado'></label>".Intro().                    
                    "<div class='Menu_Boton'>".Intro().
                        "<span class='Menu_Boton_Cruz' id='BarraNavegacion_Lab_IconoVer'>".Intro().
                    ...
                    "<label tooltip-es='Ver Columnas' tooltip-en='Columns' tooltip-pos='T' class='Menu_Boton_Label Lab_BotonVerColumnas' for='Lab_VerColumnas_Estado'></label>".Intro().
                    "<div class='Menu_Boton'>".Intro().
                        "<span class='Menu_Boton_Cruz' id='BarraNavegacion_Lab_IconoVer'>".Intro().
                    ...
                    "<label tooltip-es='Ver Código' tooltip-en='Code' tooltip-pos='T' class='Menu_Boton_Label Lab_BotonVerCodigo' for='Lab_VerCodigo_Estado'></label>".Intro().
                    "<div class='Menu_Boton'>".Intro().
                        "<span class='Menu_Boton_Cruz' id='BarraNavegacion_Lab_IconoVer'>".Intro().
                    ...
                    "<label tooltip-es='Ver Pre-visualización' tooltip-en='Preview' tooltip-pos='T' class='Menu_Boton_Label Lab_BotonVerPreview' for='Lab_VerPreview_Estado'></label>".Intro().
                    "<div class='Menu_Boton'>".Intro().
                        "<span class='Menu_Boton_Cruz' id='BarraNavegacion_Lab_IconoVer'>".Intro().
...
//                "<span class='Menu_Boton_Cruz'>Ejem</span>".Intro().
            ...
            "<div id='BarraNavegacion_RedesSociales' class='Menu' mostrar='true'>".Intro().
                ...
                "<div id='BarraNavegacion_MarcoRedesSociales'>".
                    "<div class='Menu_Boton' id='BarraNavegacion_MarcoRedesSociales_Facebook'>".Intro().
                        "<span class='Menu_Boton_Cruz'>".Intro().
                            "<img class='Menu_Boton_SVG' src='/Web/SVG/Iconos50x50.svg#svg-facebook' />".Intro().
                        "</span>".Intro().
                    "</div>".Intro().
                    "<div class='Menu_Boton' id='BarraNavegacion_MarcoRedesSociales_Twitter'>".Intro().
                        "<span class='Menu_Boton_Cruz'>".Intro().
                            "<img class='Menu_Boton_SVG' src='/Web/SVG/Iconos50x50.svg#svg-twitter' />".Intro().
                        "</span>".Intro().
                    "</div>".Intro().
                    "<div class='Menu_Boton' id='BarraNavegacion_MarcoRedesSociales_GooglePlus'>".Intro().
                        "<span class='Menu_Boton_Cruz'>".Intro().
    ...
    static public function HerramientasAdmin($Login, $Pass, $Loguear = TRUE) {
        ...
        if (devildrey33_Opciones::Administrador() > 0) {            
            ...
            $HTMLAdmin = "<input id='BarraPrincipal_Boton33_Estado' class='Menu_Boton_Input' type='checkbox' />".Intro().
                "<label class='Menu_Boton_Label' for='BarraPrincipal_Boton33_Estado'></label>".Intro().
                "<div class='Menu_Boton'>".Intro().
                    "<span class='Menu_Boton_Cruz'>".Intro().

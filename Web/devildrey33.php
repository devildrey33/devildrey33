...
/*        "<div id='cse' style='width: 100%;'>Cargando</div>
        ...
        "<nav id='BarraPrincipal'>".Intro().
            ...
            "<div id='BarraPrincipal_Submenus'>".Intro().
                ...
                // <!-- CSS -->
                "<div class='Menu_BotonCheck'>".Intro().
...
//                "<a href='/Categorias/HTML' class='BarraPrincipal_BotonMenu'><span>HTML</span></a>".
            ...
            "</div>".Intro().
            "<div id='Marco33' class='Menu_BotonCheck'>".Intro(); // Marco que contiene las herramientas de administrador
        ...
        "<nav id='BarraNavegacion'>".Intro().
            /* Home */
            "<a href='/' id='BarraNavegacion_Cerrar' title='Volver al indice' class='BarraPrincipal_BotonMenu'></a>".Intro().
            /* Lab Ver */
            "<div id ='BarraNavegacion_LabVer' class='Menu_BotonCheck'>".Intro().
                "<input id='BarraNavegacion_BotonVer_Estado' class='BarraPrincipal_Boton_Input' type='checkbox' />".Intro().
                "<label class='BarraPrincipal_Boton' for='BarraNavegacion_BotonVer_Estado'></label>".Intro().
                "<div class='BarraPrincipal_BotonMenu'>".Intro().
                ...
                "<div id ='BarraNavegacion_LabMarcoVer'>".Intro().                                       
                    ...
                    "<label title='Filas' class='BarraPrincipal_BotonMenu Lab_BotonVerFilas' for='Lab_VerFilas_Estado'></label>".Intro().
                    "<input id='Lab_VerColumnas_Estado' class='BarraPrincipal_Boton_Input' type='radio' name='Lab_Ver' />".Intro().
                    "<label title='Columnas'  class='BarraPrincipal_BotonMenu Lab_BotonVerColumas' for='Lab_VerColumnas_Estado'></label>".Intro().
                    "<input id='Lab_VerCodigo_Estado' class='BarraPrincipal_Boton_Input' type='radio' name='Lab_Ver' />".Intro().
                    "<label title='Código' class='BarraPrincipal_BotonMenu Lab_BotonVerCodigo' for='Lab_VerCodigo_Estado'></label>".Intro().
                    "<input id='Lab_VerPreview_Estado' class='BarraPrincipal_Boton_Input' type='radio' name='Lab_Ver' />".Intro().
                    "<label  title='Pre-visualización' class='BarraPrincipal_BotonMenu Lab_BotonVerPreview' for='Lab_VerPreview_Estado'></label>".Intro().
/*                    "<div><span>Filas</span></div>".Intro().
            ...
            /* Lab explorar */
            "<div id='BarraNavegacion_LabExplorar' class='Menu_BotonCheck'>".Intro().                    
                "<input id='BarraNavegacion_BotonExplorar_Estado' class='BarraPrincipal_Boton_Input' type='checkbox' />".Intro().
                "<label class='BarraPrincipal_Boton' for='BarraNavegacion_BotonExplorar_Estado' title='Explorar ejemplos'></label>".Intro().
                "<div class='BarraPrincipal_BotonMenu'>".Intro().
...
//                "<span class='IcoTexto'>Ejem</span>".Intro().
            ...
            /* Blog Subindice */
            "<div id='BarraNavegacion_Indice' class='Menu_BotonCheck'>".Intro().
                "<input id='BarraNavegacion_Indice_Estado' class='BarraPrincipal_Boton_Input' type='checkbox' />".Intro().
                "<label class='BarraPrincipal_Boton' for='BarraNavegacion_Indice_Estado' title='Sub-indice'></label>".Intro().
                "<div class='BarraPrincipal_BotonMenu'>".Intro().
                    "<span class='IcoTexto'><span></span></span>".Intro().
                "</div>".Intro().
                "<div id='BarraNavegacion_SubIndice'></div>".Intro().
            "</div>".Intro().
                    
            /* Prev / Next */
            "<div id='BarraNavegacion_NextPrev' class='Menu_BotonCheck'>".Intro().
                "<input id='BarraNavegacion_PrevNext_Estado' class='BarraPrincipal_Boton_Input' type='checkbox' />".Intro().
                "<label class='BarraPrincipal_Boton' for='BarraNavegacion_PrevNext_Estado' title='Navegación'></label>".Intro().
                "<div class='BarraPrincipal_BotonMenu'>".Intro().
                    "<span class='IcoTexto'><span></span></span>".Intro().
                "</div>".Intro().
            ...
            /* Redes sociales */
            "<div id='BarraNavegacion_RedesSocuales' class='Menu_BotonCheck'>".Intro().
                "<input id='BarraNavegacion_RedesSociales_Estado' class='BarraPrincipal_Boton_Input' type='checkbox' />".Intro().
                "<label class='BarraPrincipal_Boton' for='BarraNavegacion_RedesSociales_Estado' title='Redes sociales'></label>".Intro().
                "<div class='BarraPrincipal_BotonMenu'>".Intro().
                    "<span class='IcoTexto'><span></span></span>".Intro().
                "</div>".Intro().
            ...
            /* Lab Guardar */
            "<div id='BarraNavegacion_LabGuardar' title='Guardar archivo' class='BarraPrincipal_BotonMenu'></div>".Intro().
            "<div id='BarraNavegacion_LabGuardarCache' title='Guardar cache explorador' class='BarraPrincipal_BotonMenu'></div>".Intro().
...
/*        echo    "<div class='Cabecera Cabecera_Img".rand(1, 4)."'>";
    ...
    //                "<span>Muchas gracias!</span>".Intro().
    ...
    public function LeerDatos($Archivo, $TituloH1) {
        ...
        for ($i = 0; $i < $Entradas->Total(); $i++) {
            if ($Entradas->Datos[$i]["URL"].".php" == $Archivo) {
...
//        echo $ArchivoSinEntrada;
    ...
    public function CompatibilidadNavegadores($Chrome = true, $FireFox = true, $Opera = true, $Safari = true, $IE = true) {
        echo "<div class='Compatibilidad_Navegadores'>".Intro();

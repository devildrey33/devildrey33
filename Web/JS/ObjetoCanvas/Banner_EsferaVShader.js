...
Banner_EsferaVShader.prototype = Object.assign( Object.create(ObjetoCanvas.prototype) , {
    ...
    MouseEnter      : function(Evento) { this.Uniforms.MouseDentro.value = true; },
    // Función que se llama al salir con el mouse del canvas
    MouseLeave      : function(Evento) { this.Uniforms.MouseDentro.value = false; },
...
/*                        "//",
                        ...
                        "}",
                        "void main() {",
                            "float Amplitud = (MouseDentro == false) ? 0.75 : 2.0;",

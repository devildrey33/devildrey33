...
if(nUrl.indexOf(".")===-1){this.TotalTipos["Documentos"]++;return 4;}
...
return{"Nombre":Nombre,"NombreCorto":NombreCorto,"Version":Version,"Plataforma":Plataforma,"PlataformaCorto":PlataformaCorto,"Tipo":Tipo};};this.ClickCheckOpciones=function(){var Checks=this.ObtenerChecks();var Checks2={0:document.getElementById('ChNavegadores').checked,1:document.getElementById('ChBots').checked,2:document.getElementById('ChDesconocido').checked};console.log("---------------");for(var i=0;i<this.Ips.length;i++){var Pos=-1;if(Checks2[this.Ips[i]["Info"]["Tipo"]]===true){for(var e=0;e<this.Ips[i]["Destacados"].length;e++){if(Checks[this.Ips[i]["Destacados"][e]["Relevancia"]]===true){Pos=e;break;}}
if(Pos>-1){document.getElementById("EntradaLog"+i).style.display="table";var Url=$("#EntradaLog"+i+" .EntradaLog_Url");console.log(this.ColorRelevancia(this.Ips[i]["Destacados"][Pos]["Relevancia"]));Url.attr('class',"EntradaLog_Url "+this.ColorRelevancia(this.Ips[i]["Destacados"][Pos]["Relevancia"]));Url.html(this.Ips[i]["Destacados"][Pos]["Url"]);console.log(this.Ips[i]["Destacados"][Pos]["Url"]);if(this.Ips[i]["Abierto"]===true){this.Ips[i]["Abierto"]=false;this.ExpandirIp("EntradaLog"+i);}}

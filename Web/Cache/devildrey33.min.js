...
window.addEventListener('offline',function(event){$Base.MostrarMensaje("Conexión con el servidor perdida...");});window.addEventListener('online',function(event){console.log("Se ha restablecido la conexión con el servidor.");});};this.MostrarLoginEsc=function(){$("#VentanaLogin").attr({"Visible":"false"});document.getElementById('devildrey33_Password').setAttribute('type','text');};this.MostrarLogin=function(FuncionPostLogin){if(typeof(FuncionPostLogin)!=="undefined")this.FPL=FuncionPostLogin;document.getElementById('devildrey33_Password').setAttribute('type','password');$("#VentanaLogin").attr({"Visible":"true"});setTimeout(function(){if(typeof localStorage["Comentarios_Usuario"]==='undefined'){$("#devildrey33_Usuario").focus();}

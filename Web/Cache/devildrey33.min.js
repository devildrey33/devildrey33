...
$Lab.Lab_Temporizador=0;},400);});this.Original=$("#Lab_Codigo").val();if(this.ForzarVista==='-1'){this.ForzarVista=(typeof(localStorage["Lab_Vista"])==="undefined")?"0":localStorage["Lab_Vista"];}
switch(this.ForzarVista){case"0":$(".Lab_BotonVerFilas").trigger("click");break;case"1":$(".Lab_BotonVerColumnas").trigger("click");break;case"2":$(".Lab_BotonVerCodigo").trigger("click");break;case"3":$(".Lab_BotonVerPreview").trigger("click");break;}
this.ActualizarResultado();};this.ClickDirectorio=function(Objeto){console.log("Lab.ClickDirectorio",Objeto);Animacion=Objeto.next();Directorio=Animacion.find(".Lab_Lista");var Altura=Animacion.css("height");var AltoPadre=0;if(parseInt(Altura)===0){Animacion.css({"height":Directorio.height()});AltoPadre=Directorio.height();}

...
$Lab=new function(){this.Lab_Temporizador=0;this.Editor=new Object;this.Archivo="";this.Original="";this.ForzarVista="-1";this.Iniciar=function(){console.log("Lab.Iniciar",this.Archivo);this.EnlazarEventosExplorador();this.Editor=CodeMirror.fromTextArea(document.getElementById('Lab_Codigo'),{mode:'text/html',indentUnit:4,fixedGutter:false,lineNumbers:true,autoCloseTags:true,autoCloseBrackets:true,matchTags:{bothTags:true},extraKeys:{"Ctrl-S":function(instance){if(typeof $Admin!=="undefined"){$Admin.Lab_Guardar();}
...
$Lab.Lab_Temporizador=0;},400);});this.Original=$("#Lab_Codigo").val();if(this.ForzarVista==='-1'){this.ForzarVista="0";}

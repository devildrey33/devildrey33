...
else{$("#devildrey33_Password").focus();}},200);};this.MostrarErroresPHP=function(){console.log("Base.MostrarErroresPHP");$EFP=$("#ErroresFinPlantilla").html();if($EFP!==""){$("#ErroresFinPlantilla").html("");$("#ErroresPHP_Info").html($EFP);}

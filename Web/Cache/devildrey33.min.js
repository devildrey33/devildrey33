...
this.Color="rgb(234, 80, 78)";this.ColorPuntos="rgb(255, 155, 155)";this.DegradadoTranslucido=this.Context.createLinearGradient(0,0,this.DegradadoTranslucido_Ancho,0);this.DegradadoTranslucido.addColorStop(0,"rgba(49, 46, 53, 1)");this.DegradadoTranslucido.addColorStop(1,"rgba(49, 46, 53, 0)");this.Velocidad1=(Math.PI/90);this.Velocidad2=4;this.Iniciar();this.Cargando(false);};Banner_Sinusoidal.prototype=Object.assign(Object.create(ObjetoBanner.prototype),{constructor:Banner_Sinusoidal,Nombre:"Onda Sinusoidal",IdeaOriginal:"devildrey33",URL:"/Lab/Ejemplos/BannerTest/Sinusoidal.html",NombreURL:"Lab : Sinusoidal",Redimensionar:function(){this.Iniciar();},Scroll:function(){},MouseMove:function(Evento){},Iniciar:function(){this.DegradadoTranslucido_Ancho=this.Ancho/8;this.AnchoGrafico=this.Ancho*0.7;this.PosCirculo=this.Ancho*0.9,this.ImgOnda=new BufferCanvas((this.AnchoGrafico)+360,this.Alto);this.ImgOnda.Context.strokeStyle=this.Color;this.DiametroCirculo=this.ImgOnda.Alto/5;this.ImgOnda.Context.moveTo(0,this.ImgOnda.Alto/2);var Avance=0;var y,y2;for(var x=0;x<=(this.AnchoGrafico)+360;x++){Avance-=this.Velocidad1;y=Math.sin(Avance)*this.DiametroCirculo;y2=Math.sin(Avance*this.Velocidad2)*this.DiametroCirculo;this.ImgOnda.Context.lineTo(x,y+y2+(this.Alto/2));}
this.ImgOnda.Context.stroke();this.Avance=-Math.floor(this.AnchoGrafico);this.Avance2=0;},Pintar:function(){this.Context.fillStyle="rgba(49, 46, 53, 0.95)";this.Context.fillRect(0,0,this.Ancho,this.Alto);this.Avance+=1;if(this.Avance>=360)this.Avance=0;this.Context.drawImage(this.ImgOnda.Canvas,this.Avance,0,this.AnchoGrafico,this.Alto,0,0,this.AnchoGrafico,this.Alto);this.Avance2-=this.Velocidad1;var x=Math.cos(this.Avance2)*this.DiametroCirculo;var y=Math.sin(this.Avance2)*this.DiametroCirculo;var x2=Math.cos(this.Avance2*this.Velocidad2)*this.DiametroCirculo;var y2=Math.sin(this.Avance2*this.Velocidad2)*this.DiametroCirculo;this.Context.strokeStyle=this.Color;this.Context.beginPath();this.Context.arc(this.PosCirculo,this.Alto/2,this.DiametroCirculo,0,2*Math.PI);this.Context.stroke();this.Context.beginPath();this.Context.arc(x+this.PosCirculo,y+(this.Alto/2),this.DiametroCirculo,0,2*Math.PI);this.Context.stroke();this.Context.beginPath();this.Context.moveTo(x+x2+this.PosCirculo,y+y2+(this.Alto/2));this.Context.lineTo(this.AnchoGrafico,y+y2+(this.Alto/2));this.Context.stroke();this.Context.fillStyle=this.ColorPuntos;this.Context.strokeStyle=this.Color;this.Context.beginPath();this.Context.arc(this.PosCirculo,this.Alto/2,1,0,2*Math.PI);this.Context.fill();this.Context.beginPath();this.Context.arc(x+this.PosCirculo,y+(this.Alto/2),2,0,2*Math.PI);this.Context.fill();this.Context.beginPath();this.Context.arc(x+x2+this.PosCirculo,y+y2+(this.Alto/2),2.5,0,2*Math.PI);this.Context.fill();this.Context.beginPath();this.Context.arc(this.AnchoGrafico,y+y2+(this.Alto/2),2.5,0,2*Math.PI);this.Context.fill();this.Context.fillStyle=this.DegradadoTranslucido;this.Context.fillRect(0,0,this.DegradadoTranslucido_Ancho,this.Alto);}});

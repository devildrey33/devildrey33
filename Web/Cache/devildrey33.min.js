...
$("#ErroresPHP_Info").html(Datos["ErroresPHP"]);}).fail(function(jqXHR,textStatus,tError){console.log("Base.VotarWeb Error ajax",jqXHR,textStatus,tError);$Base.MostrarErrorAjax(jqXHR.status,false,tError);});}
...
$("body").attr({"modificado":"false"});$Base.ComprobarScrollVotacion();$Lab.ActualizarResultado();$("#ErroresPHP_Info").html(Datos["ErroresPHP"]);}

...
this._PasoOrig=this._Pasos[this._PosPasos-1];this._PasoDest=this._Pasos[this._PosPasos];this._Retraso=this._PasoDest.Retraso;for(var Indice in this._PasoOrig.Paso){this[Indice]=this._PasoOrig.Paso[Indice];}
...
if(AniCreada===false){this._Padre.Animaciones.push(this);this._PosPasos=1;this._PasoOrig=this._Pasos[this._PosPasos-1];this._PasoDest=this._Pasos[this._PosPasos];this._Retraso=this._PasoDest.Retraso;this._UltimoTick=0;this._Avance=0;for(var i=0;i<this._PasosIniciales.length;i++){for(var Valor in this._PasosIniciales[i].Paso){if(this._PasosIniciales[i].Paso[Valor]instanceof ObjetoAnimacion_Rand){this._Pasos[i].Paso[Valor]=this._PasosIniciales[i].Paso[Valor].Iniciar();}}}
...
this._Terminado=false;};this.Cancelar=function(){this._Opciones.FuncionIniciado();this._Opciones.FuncionTerminado();this._Terminado=true;};this.Terminar=function(){for(var i=0;i<this._Pasos.length;i++){this._Pasos.forEach(function(Valor,Indice,Array){if(Valor instanceof ObjetoAnimacion_Rand){this._Pasos[Indice]=Valor.Max;}});}
this._Opciones.FuncionIniciado();this._Opciones.FuncionTerminado();this._Terminado=true;for(var Indice in this._Pasos[this._Pasos.length-1].Paso){this[Indice]=this._Pasos[this._Pasos.length-1].Paso[Indice];}

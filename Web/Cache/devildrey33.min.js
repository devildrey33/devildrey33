...
var Banner_Lista=[Banner_Espacio2D,Banner_AdiestramientoCubos3D,Banner_WormHole,Banner_Sinusoidal,Banner_GeometriaBasica,Banner_ReunionDeCirculos,Banner_HexTunnel,Banner_MultiCubo,Banner_EsferaVShader];var fPos=0;if(typeof(Pos==="undefined")){fPos=RandInt(Banner_Lista.length-1);}
else{fPos=Pos}
...
console.log("Base.Banner(Pos = "+Pos+")",fPos);this.PosBanner=fPos;$Banner=new Banner_Lista[fPos];$Banner.OpcionesCanvas.MostrarFPS=(typeof(document.getElementById("CH_MostrarFPS"))!=='undefined')?((document.getElementById("CH_MostrarFPS").value==="true")?true:false):false;document.getElementById("Cabecera_Stats").style.display=($Banner.OpcionesCanvas.MostrarFPS)?"block":"none";};this.MostrarErroresPHP=function(){console.log("Base.MostrarErroresPHP");$EFP=$("#ErroresFinPlantilla").html();if($EFP!==""){$("#ErroresFinPlantilla").html("");$("#ErroresPHP_Info").html($EFP);}

...
if(URL==="/")nURL="/index.php";else nURL=URL;console.log("Base.CargarURL "+nURL);this.URL=URL;this.nURL=nURL;this.PeticionAjax=$.post(nURL,{"Regenerar":"todo","Categoria":"Todo","SinPlantilla":"true"}).done(function(data){if(data.indexOf("<script>$Base.MostrarErrorAjax(404, false);</script>")===0){$Base.MostrarErrorAjax(404,false,'No se ha encontrado');}
...
$Lab=new function(){this.Lab_Temporizador=0;this.Editor=new Object;this.Archivo="";this.Original="";this.ForzarVista="-1";this.Modo="text/html";this.Iniciar=function(){console.log("Lab.Iniciar",this.Archivo);this.EnlazarEventosExplorador();this.Editor=CodeMirror.fromTextArea(document.getElementById('Lab_Codigo'),{mode:this.Modo,indentUnit:4,fixedGutter:false,lineNumbers:true,autoCloseTags:true,autoCloseBrackets:true,matchTags:{bothTags:true},extraKeys:{"Ctrl-S":function(instance){if(typeof $Admin!=="undefined"){$Admin.Lab_Guardar();}

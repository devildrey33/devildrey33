...
else{this._Avance+=(TiempoFrame/this._PasoDest.Tiempo);var FuncionTiempo=this._PasoDest.FuncionTiempo(this._Avance);if(this._Avance<1&&this._Avance>0){for(var Indice in this._PasoDest.Paso){this[Indice]=this._PasoOrig.Paso[Indice]-(this._PasoOrig.Paso[Indice]-this._PasoDest.Paso[Indice])*FuncionTiempo;}
...
var ObjetoTest=function(Opciones){this.AutoActualizar_Iniciar=function(){this.AutoActualizar_Cancelar();this.Timer_AutoActualizar=setTimeout(this.ActualizarValores.bind(this),1000/60);};this.AutoActualizar_Cancelar=function(){if(this.Timer_AutoActualizar!==0){clearInterval(this.Timer_AutoActualizar);this.Timer_AutoActualizar=0;}};this.Iniciar=function(Opciones){this.Variables=[];this.MousePresionado=null;this.AutoActualizar=false;this.ControlLista=document.createElement('div');this.ControlLista.className="ObjetoTest";if(typeof Opciones!=='undefined'){if(typeof Opciones.css!=='undefined'){for(var Indice in Opciones.css){this.ControlLista.style[Indice]=Opciones.css[Indice];}}
...
this.Lista=new ObjetoTest_Lista(this.ControlLista,this,false);this.Agregar=function(Opciones){return this.Lista.Agregar(Opciones);};this.AgregarLista=function(Nombre){return this.Lista.AgregarLista(Nombre);};this.ActualizarValores=function(){for(var i=0;i<this.Variables.length;i++){this.Variables[i].Actualizar();}};if(this.AutoActualizar===true){this.AutoActualizar_Iniciar();}};this.Iniciar(Opciones);};var ObjetoTest_Lista=function(ControlPadre,ObjetoTestPadre,Visible){this.Padre=ObjetoTestPadre;this.ControlLista=document.createElement('div');this.ControlLista.className="ObjetoTest_Lista";ControlPadre.appendChild(this.ControlLista);this.Visible=Visible||false;this.Agregar=function(Opciones){if(typeof Opciones.Actualizar==="undefined"){Opciones.Actualizar=function(NuevoValor){};}

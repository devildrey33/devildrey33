...
$Base.PeticionAjax=$.post("/cmd/LabAbrirEjemplo",{"Archivo":Archivo,"ID":ID},function(data){Datos=JSON.parse(data);if(Datos["Ret"]===404){$Base.MostrarErrorAjax(404,false);}

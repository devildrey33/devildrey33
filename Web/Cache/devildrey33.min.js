...
var Banner_Lista=[Banner_Espacio2D,Banner_AdiestramientoCubos3D,Banner_WormHole,Banner_Sinusoidal,Banner_GeometriaBasica,Banner_EsferaVShader,Banner_ReunionDeCirculos];var fPos=0;if(typeof(Pos==="undefined")){fPos=RandInt(Banner_Lista.length);}
else{fPos=Pos}
...
if(cURL.indexOf("web/")>-1||cURL.indexOf("sobre-el-autor")>-1||cURL.indexOf("faqbarba")>-1||document.getElementById('Error404')!==null){Ret["TipoPagina"]="Simple";nURL="";}
...
ObjetoCanvas=function(Opciones){this.OpcionesCanvas={'Tipo':'2d','Ancho':'Auto','Alto':'Auto','Entorno':'Normal','MostrarFPS':true,'ElementoRaiz':document.body,'Pausar':true};if(typeof Opciones==='object'){for(var Indice in Opciones){this.OpcionesCanvas[Indice]=Opciones[Indice];}}
...
if(typeof(this.Redimensionar)!=="undefined"){this.Redimensionar.apply(this);}};ObjetoCanvas.prototype.Pausa=function(){if(this.RAFID!==0&&this.OpcionesCanvas.Pausar===true){document.getElementById("Cabecera").setAttribute("animar",false);console.log("ObjetoCanvas.Pausa");window.cancelAnimationFrame(this.RAFID);this.RAFID=0;}};ObjetoCanvas.prototype.Reanudar=function(){if(this.RAFID===0&&this.FocoWeb===true){document.getElementById("Cabecera").setAttribute("animar",true);this.RAFID=window.requestAnimationFrame(this.Actualizar.bind(this));console.log("ObjetoCanvas.Reanudar RAFID = "+this.RAFID);}};ObjetoCanvas.prototype.EventoScroll=function(){if(this.OpcionesCanvas.Entorno==="Banner"){var PS=$(window).scrollTop();var Altura=this.Cabecera.offsetHeight;if(PS>Altura){this.Pausa();}
else if(PS<Altura){this.Reanudar();}}
...
var FuncionesTiempo={Linear:function(Tiempo){return Tiempo;},SinIn:function(Tiempo){return 1-Math.cos(Tiempo*Math.PI/2);},SinOut:function(Tiempo){return Math.sin(Tiempo*Math.PI/2);},SinInOut:function(Tiempo){return-0.5*(Math.cos(Math.PI*Tiempo)-1);}};var ObjetoAnimacion=new function(){this.Animaciones=[];this.Actualizar=function(nTick){var Tick;if(typeof(nTick)==='undefined'){Tick=Date.now();}
else{Tick=nTick;}
for(var i=this.Animaciones.length-1;i>-1;i--){if(this.Animaciones[i].Actualizar(Tick)===true){this.Animaciones.splice(i,1);}}};this.Crear=function(Pasos,Opciones){var Ani=new this.Animacion(Pasos,Opciones);this.Animaciones.push(Ani);return Ani;};this.Animacion=function(ArrayPasos,Opciones){this._UltimoTick=0;this._Pasos=ArrayPasos;this._PosPasos=1;this._PasoOrig=this._Pasos[this._PosPasos-1];this._PasoDest=this._Pasos[this._PosPasos];this._Avance=0;this._Opciones={Repetir:0,FuncionActualizar:function(){},FuncionTerminado:function(){}};if(typeof(Opciones)!=='undefined'){if(typeof Opciones.Repetir!=="undefined"){this._Opciones.Repetir=Opciones.Repetir;}
...
for(var Indice in this._PasoOrig.Paso){this[Indice]=this._PasoOrig.Paso[Indice];this._Opciones.FuncionActualizar(Indice,this[Indice]);}
this.Cancelar=function(){console.log("ObjetoAnimacion.Cancelar");this._Opciones.FuncionTerminado();this.Terminado=true;};this.Terminar=function(){console.log("ObjetoAnimacion.Terminar");this._Opciones.FuncionTerminado();this.Terminado=true;for(var Indice in this._Pasos[this._Pasos.length-1].Paso){this[Indice]=this._Pasos[this._Pasos.length-1].Paso[Indice];this._Opciones.FuncionActualizar(Indice,this[Indice]);}};this.Actualizar=function(t){if(this.Terminado===true){return true;}
...
else{this._Avance+=(TiempoFrame/this._PasoDest.Tiempo);var FuncionTiempo=this._PasoDest.FuncionTiempo(this._Avance);if(this._Avance<1&&this._Avance>0){for(var Indice in this._PasoDest.Paso){this[Indice]=this._PasoOrig.Paso[Indice]-(this._PasoOrig.Paso[Indice]-this._PasoDest.Paso[Indice])*FuncionTiempo;this._Opciones.FuncionActualizar(Indice,this[Indice]);}}
else{for(var Indice in this._PasoDest.Paso){this[Indice]=this._PasoDest.Paso[Indice];this._Opciones.FuncionActualizar(Indice,this[Indice]);}
this._PosPasos++;if(this._PosPasos<this._Pasos.length){this._PasoOrig=this._Pasos[this._PosPasos-1];this._PasoDest=this._Pasos[this._PosPasos];this._Avance=0;}
...
var Color='hsla('+this.ColorH+", 70%, 50%, "+this.ColorA+")";console.log(Color);this.Padre.Context.beginPath();this.Padre.Context.strokeStyle=Color;this.Padre.Context.arc(this.X,this.Y,this.Radio,0,2*Math.PI,false);this.Padre.Context.stroke();};this.Explotar=function(){this.RadioExplosion=this.Radio*Rand(15,5);this.Explotado=true;};this.Iniciar();},Pintar:function(){if(this.Circulos.length<this.TotalCirculos){for(var i=0;i<10;i++){this.Circulos.push(new this.Circulo(this));}}
...
var ObjetoTest=function(Opciones){this.Variables=[];this.MousePresionado=null;this.ControlLista=document.createElement('div');this.ControlLista.className="ObjetoTest";if(typeof Opciones!=='undefined'){if(typeof Opciones["top"]!=='undefined'){this.ControlLista.style.top=Opciones['top'];}
...
this.Lista=new ObjetoTest_Lista(this.ControlLista,this,false);this.Agregar=function(Opciones){return this.Lista.Agregar(Opciones);};this.AgregarLista=function(Nombre){return this.Lista.AgregarLista(Nombre);};this.ActualizarValores=function(){for(var i=0;i<this.Variables.length;i++){this.Variables[i].Actualizar();}};};var ObjetoTest_Lista=function(ControlPadre,ObjetoTestPadre,Visible){this.Padre=ObjetoTestPadre;this.ControlLista=document.createElement('div');this.ControlLista.className="ObjetoTest_Lista";ControlPadre.appendChild(this.ControlLista);this.Visible=Visible||false;this.Agregar=function(Opciones){if(typeof Opciones.Actualizar==="undefined"){Opciones.Actualizar=function(NuevoValor){};}
if(typeof Opciones.Nombre==="undefined"){Opciones.Nombre=Opciones.Variable;}
var Control;switch(typeof Opciones.Padre[Opciones.Variable]){case"string":this.Padre.Variables.push(new this.ControlStr(this,Opciones));break;case"number":this.Padre.Variables.push(new this.ControlNum(this,Opciones));break;case"boolean":this.Padre.Variables.push(new this.ControlBool(this,Opciones));break;case"function":this.Padre.Variables.push(new this.ControlFunc(this,Opciones));break;default:console.log("ObjetoTest.Agregar : Tipo "+typeof(Opciones.Padre[Opciones.Variable])+" no está soportado");break;};return this.Padre.Variables[this.Padre.Variables.lenght-1];};this.AgregarLista=function(Nombre){var fLista=function(ControlPadre,Nombre,ObjetoTestPadre){this.ControlPadre=ControlPadre;this.Padre=ObjetoTestPadre;this.Lista_MouseUp=function(e){this.Lista.Visible=!this.Lista.Visible;this.Lista.ControlLista.setAttribute("abierto",this.Lista.Visible);this.ControlContenedor.setAttribute("lista",true);this.ControlContenedor.setAttribute("abierto",this.Lista.Visible);var AlturaInicial=parseInt(this.ControlContenedor.style.height)||22;var Alto=22;if(this.Lista.Visible===true){var Altos=this.ControlContenedor.querySelectorAll(".ObjetoTest_Lista[abierto=true]");for(var i=0;i<Altos.length;i++){if(Altos[i].parentNode===this.ControlContenedor){Alto+=Altos[i].offsetHeight;}}}
...
Nodo=Nodo.parentNode;}};this.ControlContenedor=this.ControlPadre.CrearControlContenedor();this.ControlTexto=this.ControlPadre.CrearControlTexto(this.ControlContenedor,Nombre,true);this.ControlTexto.style.cursor="pointer";this.ControlTexto.addEventListener('mouseup',this.Lista_MouseUp.bind(this));this.Lista=new ObjetoTest_Lista(this.ControlContenedor,this.Padre,false);this.Lista.ControlLista.setAttribute("abierto",false);};var l=new fLista(this,Nombre,this.Padre);return l.Lista;};this.CrearControlContenedor=function(){var ControlContenedor=document.createElement('div');ControlContenedor.className="ObjetoTest_Contenedor";this.ControlLista.appendChild(ControlContenedor);return ControlContenedor;};this.CrearControlTexto=function(Contenedor,Texto,Lista){var ControlTexto=document.createElement('div');ControlTexto.className=(typeof Lista==='undefined')?"ObjetoTest_Nombre":"ObjetoTest_NombreLista";ControlTexto.innerHTML=Texto;Contenedor.appendChild(ControlTexto);return ControlTexto;};this.CrearControlInputString=function(Contenedor,Valor){var ControlInput=document.createElement('input');ControlInput.className="ObjetoTest_InputString";ControlInput.setAttribute("type","text");ControlInput.setAttribute("value",Valor);Contenedor.appendChild(ControlInput);return ControlInput;};this.CrearControlInputNum=function(Contenedor,Valor,Min,Max){var ControlInput=document.createElement('input');ControlInput.className="ObjetoTest_InputNum";ControlInput.setAttribute("type","number");ControlInput.setAttribute("value",Valor);ControlInput.setAttribute("min",Min);ControlInput.setAttribute("max",Max);ControlInput.setAttribute("step",(Max-Min)/20);Contenedor.appendChild(ControlInput);return ControlInput;};this.CrearControlBarra=function(Contenedor,Valor,Min,Max){var ControlBarra=document.createElement('button');ControlBarra.className="ObjetoTest_Barra";ControlBarra.setAttribute("min",parseFloat(Min).toFixed(2));ControlBarra.setAttribute("max",parseFloat(Max).toFixed(2));ControlBarra.setAttribute("valor",Valor);ControlBarra.innerHTML="<div class='ObjetoTest_Barra_Valor' style='width:"+((Valor-Min)/(Max-Min))*100+"%'></div>";Contenedor.appendChild(ControlBarra);return ControlBarra;};this.CrearControlBoton=function(Contenedor){var ControlBoton=document.createElement('div');ControlBoton.className="ObjetoTest_Boton";ControlBoton.innerHTML="Ejecutar";Contenedor.appendChild(ControlBoton);return ControlBoton;};this.CrearControlBool=function(Contenedor,Valor,Texto){var ControlBool=document.createElement('div');ControlBool.className="ObjetoTest_Bool";ControlBool.setAttribute("marcado",Valor);ControlBool.innerHTML=Texto;Contenedor.appendChild(ControlBool);return ControlBool;};this.ControlStr=function(Padre,Opciones){this.Opciones=Opciones;this.Padre=Padre;this.Foco=false;this.Input_Change=function(e){Opciones.Padre[Opciones.Variable]=this.ControlInputString.value;this.Opciones.Actualizar(Opciones.Padre[Opciones.Variable]);};this.ControlContenedor=this.Padre.CrearControlContenedor();this.ControlTexto=this.Padre.CrearControlTexto(this.ControlContenedor,Opciones.Nombre);this.ControlInputString=this.Padre.CrearControlInputString(this.ControlContenedor,Opciones.Padre[Opciones.Variable]);this.ControlInputString.addEventListener('change',this.Input_Change.bind(this));this.ControlInputString.addEventListener('focus',function(){this.Foco=true;}.bind(this));this.ControlInputString.addEventListener('blur',function(){this.Foco=false;}.bind(this));this.Actualizar=function(){if(this.Foco===false){this.ControlInputString.setAttribute("value",Opciones.Padre[Opciones.Variable]);}};};this.ControlNum=function(Padre,Opciones){this.Opciones=Opciones;this.Padre=Padre;this.Foco=false;this.Foco2=false;if(typeof this.Opciones.Min==="undefined"){this.Opciones.Min=0.0;}
if(typeof this.Opciones.Max==="undefined"){this.Opciones.Max=1.0;}
this.Barra_MouseDown=function(e){this.Foco=true;this.Barra_MouseMove(e);};this.Barra_MouseUp=function(e){this.Foco=false;this.Barra_MouseMove(e);};this.Barra_MouseMove=function(e){if(this.Foco===true){var X=e.offsetX;if(X<0){X=0;}
if(X>this.ControlBarra.offsetWidth){X=this.ControlBarra.offsetWidth;}
this.ControlBarra.childNodes[0].style.width=((X/this.ControlBarra.offsetWidth)*100)+"%";Opciones.Padre[Opciones.Variable]=((this.Opciones.Max-this.Opciones.Min)*(X/this.ControlBarra.offsetWidth)+this.Opciones.Min);this.ControlInputNum.setAttribute("value",parseFloat(Opciones.Padre[Opciones.Variable]).toFixed(3));this.Opciones.Actualizar(Opciones.Padre[Opciones.Variable]);}};this.Input_Change=function(e){Opciones.Padre[Opciones.Variable]=parseFloat(this.ControlInputNum.value);this.ControlBarra.childNodes[0].style.width=((Opciones.Padre[Opciones.Variable]-this.Opciones.Min)/(this.Opciones.Max-this.Opciones.Min))*100+"%";this.Opciones.Actualizar(Opciones.Padre[Opciones.Variable]);};this.Input_MouseMove=function(e){if(this.Foco===true){Opciones.Padre[Opciones.Variable]=parseFloat(this.Opciones.Max);this.ControlInputNum.setAttribute("value",this.Opciones.Max);this.ControlBarra.childNodes[0].style.width="100%";this.Opciones.Actualizar(Opciones.Padre[Opciones.Variable]);}};this.Texto_MouseMove=function(e){if(this.Foco===true){Opciones.Padre[Opciones.Variable]=parseFloat(this.Opciones.Min);this.ControlInputNum.setAttribute("value",this.Opciones.Min);this.ControlBarra.childNodes[0].style.width="0%";this.Opciones.Actualizar(Opciones.Padre[Opciones.Variable]);}};this.ControlContenedor=this.Padre.CrearControlContenedor();this.ControlTexto=this.Padre.CrearControlTexto(this.ControlContenedor,this.Opciones.Nombre);this.ControlTexto.addEventListener('mousemove',this.Texto_MouseMove.bind(this));this.ControlTexto.addEventListener('mouseup',this.Barra_MouseUp.bind(this));this.ControlBarra=this.Padre.CrearControlBarra(this.ControlContenedor,this.Opciones.Padre[this.Opciones.Variable],this.Opciones.Min,this.Opciones.Max);this.ControlBarra.addEventListener('mousedown',this.Barra_MouseDown.bind(this));this.ControlBarra.addEventListener('mousemove',this.Barra_MouseMove.bind(this));this.ControlBarra.addEventListener('mouseup',this.Barra_MouseUp.bind(this));this.ControlInputNum=this.Padre.CrearControlInputNum(this.ControlContenedor,this.Opciones.Padre[this.Opciones.Variable],this.Opciones.Min,this.Opciones.Max);this.ControlInputNum.addEventListener('change',this.Input_Change.bind(this));this.ControlInputNum.addEventListener('mousemove',this.Input_MouseMove.bind(this));this.ControlInputNum.addEventListener('mouseup',this.Barra_MouseUp.bind(this));this.ControlInputNum.addEventListener('focus',function(){this.Foco2=true;}.bind(this));this.ControlInputNum.addEventListener('blur',function(){this.Foco2=false;}.bind(this));this.Actualizar=function(){if(this.Foco===false&&this.Foco2===false){this.ControlBarra.childNodes[0].style.width=((Opciones.Padre[Opciones.Variable]-this.Opciones.Min)/(this.Opciones.Max-this.Opciones.Min))*100+"%";this.ControlInputNum.setAttribute("value",parseFloat(Opciones.Padre[Opciones.Variable]).toFixed(3));}};};this.ControlBool=function(Padre,Opciones){this.Opciones=Opciones;this.Padre=Padre;if(typeof this.Opciones.True==="undefined"){this.Opciones.True="TRUE";}
if(typeof this.Opciones.False==="undefined"){this.Opciones.False="FALSE";}
this.TrueFalse_MouseUp=function(e){this.Opciones.Padre[this.Opciones.Variable]=!this.Opciones.Padre[this.Opciones.Variable];this.ControlBoolTrue.setAttribute("marcado",this.Opciones.Padre[this.Opciones.Variable]);this.ControlBoolFalse.setAttribute("marcado",!this.Opciones.Padre[this.Opciones.Variable]);this.Opciones.Actualizar(Opciones.Padre[Opciones.Variable]);};this.ControlContenedor=this.Padre.CrearControlContenedor();this.ControlTexto=this.Padre.CrearControlTexto(this.ControlContenedor,this.Opciones.Nombre);this.ControlBoolTrue=this.Padre.CrearControlBool(this.ControlContenedor,this.Opciones.Padre[this.Opciones.Variable],this.Opciones.True);this.ControlBoolTrue.addEventListener('mouseup',this.TrueFalse_MouseUp.bind(this));this.ControlBoolFalse=this.Padre.CrearControlBool(this.ControlContenedor,!this.Opciones.Padre[this.Opciones.Variable],this.Opciones.False);this.ControlBoolFalse.addEventListener('mouseup',this.TrueFalse_MouseUp.bind(this));this.Actualizar=function(){this.ControlBoolTrue.setAttribute("marcado",this.Opciones.Padre[this.Opciones.Variable]);this.ControlBoolFalse.setAttribute("marcado",!this.Opciones.Padre[this.Opciones.Variable]);};};this.ControlFunc=function(Padre,Opciones){this.Opciones=Opciones;this.Padre=Padre;this.Boton_MouseUp=function(){this.Opciones.Padre[this.Opciones.Variable]();};this.ControlContenedor=this.Padre.CrearControlContenedor();this.ControlTexto=this.Padre.CrearControlTexto(this.ControlContenedor,this.Opciones.Nombre);this.ControlBoton=this.Padre.CrearControlBoton(this.ControlContenedor);this.ControlBoton.addEventListener('mouseup',this.Boton_MouseUp.bind(this));this.Actualizar=function(){};};};

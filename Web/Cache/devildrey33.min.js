...
var Banner_Lista=[Banner_Espacio2D,Banner_AdiestramientoCubos3D,Banner_WormHole,Banner_Anillos,Banner_Sinusoidal];var fPos=0;if(typeof(Pos==="undefined")){fPos=RandInt(Banner_Lista.length);}
else{fPos=Pos}

...
/*	include("devildrey33.php");
    ...
    ?>
        ...
        <p>En definitiva todo son ventajas, excepto por una cosa... <b>no funciona ni funcionara en</b> ninguna versión de <b>Internet Explorer</b>. Por suerte he leído en alguna parte que desde hace poco funcionan las variables css en Edge (el nuevo navegador de windows 10), pero es algo que no he podido comprobar.</p>

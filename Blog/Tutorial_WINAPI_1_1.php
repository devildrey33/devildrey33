...
?>	
                ...
                <p>Con este bucle Main lo que estaríamos haciendo es : ejecutar NuestrasOperaciones(),  luego miramos si hay algún mensaje para nuestra aplicación, si es así lo procesamos. La API <a href="http://msdn.microsoft.com/en-us/library/ms644943(VS.85).aspx" target="_blank" cid='IDBucle2' l='6'>PeekMessage</a> <b>no espera</b>  a que windows nos pase un mensaje para nuestra aplicación, simplemente mira si existe algún mensaje, y en ese caso lo procesa.</p>
                <p>De la misma forma que antes en la API <a href="http://msdn.microsoft.com/en-us/library/ms644943(VS.85).aspx" target="_blank" cid='IDBucle2' l='6'>PeekMessage</a> se ha especificado NULL en la ventana, 0 en el lParam y 0 en el wParam, Así podemos obtener todos los mensajes de nuestra aplicación, no solo los de una ventana.</p>
                <p>En esencia las  API's <a href="http://msdn.microsoft.com/en-us/library/ms644936(VS.85).aspx" target="_blank">GetMessage</a> y <a href="http://msdn.microsoft.com/en-us/library/ms644943(VS.85).aspx" target="_blank"  cid='IDBucle2' l='6'>PeekMessage</a> hacen lo mismo con la diferencia de que <a href="http://msdn.microsoft.com/en-us/library/ms644936(VS.85).aspx" target="_blank">GetMessage</a> se espera hasta recibir un mensaje de forma que la aplicación queda suspendida, y <a href="http://msdn.microsoft.com/en-us/library/ms644943(VS.85).aspx" target="_blank"  cid='IDBucle2' l='6'>PeekMessage</a> mira si existe algún  mensaje en la cola, en ese caso no retorna 0 y podemos pasar a procesar el mensaje. Por último cabe a destacar que al usar <a href="http://msdn.microsoft.com/en-us/library/ms644943(VS.85).aspx" target="_blank">PeekMessage</a> tenemos que controlar cuando recibimos la notificación WM_QUIT, que es la encargada de decirnos que la aplicación debe terminar. </p>

<?php 
	...
	$HEAD2 = "<link rel='stylesheet' type='text/css' href='./css/PropiedadesCSS.css' />
	...
	<style type='text/css'>
		...
		#ID_EjemploLinealSimple, #ID_EjemploLineal2, #ID_EjemploLinealRepetitivoSimple, #ID_EjemploRadialSimple, #ID_EjemploRadial2, #ID_EjemploRadialRepetitivoSimple, #ID_EjemploRadialRepetitivo2 { float:left; }
		...
		.EjemploRadial2 { 
			background:-webkit-radial-gradient(10px 20px, farthest-side, #FFFFFF 15%, green 90%, rgb(0, 100, 0)); 
			background:radial-gradient(10px 20px, farthest-side, #FFFFFF 15%, green 90%, rgb(0, 100, 0)); 
		}
	...
	$Base = new devildrey33(devildrey33_TipoPlantilla::Articulo, basename(__FILE__));	
        ...
        $Base->InicioPlantilla("Referéncia CSS : Degradados", $HEAD, '<a href="/Doc/">Doc</a>/<a href="/Doc/CSS/">CSS</a>/Degradados');*/

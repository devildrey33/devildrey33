...
?>	
                ...
                <p>Una vez tenemos las variables inicializadas se utiliza la API <a cid='IDFiltroError' l='25' href="http://msdn.microsoft.com/en-us/library/windows/desktop/ms680360(v=vs.85).aspx" target="_new">MiniDumpWriteDump</a> para escribir el volcado de memoria dentro del archivo que creamos anteriormente.</p>
                ...
                <img src='../Web/Graficos/VS2010Debug.png' alt='Depuración con VisualStudio 2010' />
                <img src='../Web/Graficos/VS2010Debug2.png' alt='Depuración con VisualStudio 2010' style='float:right; margin-top:15px' />
                ...
                <img src='../Web/Graficos/VS2010Debug3.png' alt='Depuración con VisualStudio 2010' />

...
/*        echo "<pre>";
        ...
        <p>En resumen, hay que seguir 3 pasos : <linea cid="BaseDatos_Consulta" l="5">preparación</linea>, <linea cid="BaseDatos_Consulta" l="12,13,14">ejecución de cada paso (interno)</linea>, y <linea cid="BaseDatos_Consulta" l="15">finalización de la consulta</linea>. Visto así puede parecer algo incomodo, pero cuando una consulta tiene que devolver datos, hay que mirar en cada <a href="http://www.sqlite.org/c3ref/step.html" target="_blank">sqlite3_step</a> si nos ha devuelto datos de la tabla. (lo veremos mas adelante)</p>
        ...
        <div class='nota'>Durante una transacción la base de datos queda bloqueada para escritura, de forma que si intentamos hacer cualquier consulta que no sea un SELECT desde otro hilo/thread, al llamar a la función <code>sqlite3_step</code> nos devolvera SQLITE_BUSY.</div>

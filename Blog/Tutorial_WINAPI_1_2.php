...
?>	
                ...
                <p>En este esqueleto básico se está mirando cuando la ventana  recibe el mensaje <a href="http://msdn.microsoft.com/en-us/library/ms632617%28VS.85%29.aspx" target="_blank" cid="IDWndProc" l='4'>WM_CLOSE</a>. El mensaje <a href="http://msdn.microsoft.com/en-us/library/ms632617%28VS.85%29.aspx" target="_blank" cid="IDWndProc" l='4'>WM_CLOSE</a> nos dice que el usuario ha  cerrado la ventana, en este caso al recibir dicho mensaje usamos la API  <a href="http://msdn.microsoft.com/en-us/library/ms644945%28VS.85%29.aspx" target="_blank"  cid="IDWndProc" l='5'>PostQuitMessage</a> para indicar a la aplicación que debe terminar. Una vez sale  del switch, se debe retornar la API <a href="http://msdn.microsoft.com/en-us/library/ms633572(v=VS.85).aspx" target="_blank" cid="IDWndProc" l='8'>DefWindowProc</a>, la cual procesara los  mensajes por defecto.</p>
                ...
                <p><strong>3)</strong> Por último ya  podemos utilizar la API <a href="http://msdn.microsoft.com/en-us/library/ms632680%28VS.85%29.aspx" target="_blank" cid='IDCreateWindow' l='7,8'>CreateWindowEx</a> para crear nuestra ventana.</p>

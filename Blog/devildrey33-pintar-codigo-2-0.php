<?php 
    ...
    $META = '<meta name="description" content="Resaltar sintáxis de código (C/C++, PHP, HTML, JavaScript, CSS) para PHP">
    <meta name="keywords" content="Resaltador de código, Dar formato código, Pintar código, Resaltar código, Marcar código, Resaltar sintáxis, Resaltar código, C, C++, PHP, HTML, JavaScript, CSS">';

    $Titulo = "Resaltar código para mostrar en una web";
...
?>	
    ...
    <img class="ImagenPortada" src="/Web/Graficos/250x200_webs-dinamicas.png" alt="Resaltar código para mostrar en una web" />

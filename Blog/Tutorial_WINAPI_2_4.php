...
?>	
                ...
                <p>Despues creamos un bucle que recorra todos los records para pintarlos de uno en uno. Dentro del bucle utilizamos <a href="http://msdn.microsoft.com/en-us/library/ce3zzk1k(VS.80).aspx" target="_blank" cid='IDPintar_Terminado' l='73,76,79'>swprintf_s</a> para formatear cada valor y los pintamos con <a href="http://msdn.microsoft.com/en-us/library/dd145133(VS.85).aspx" target="_blank" cid='IDPintar_Terminado' l='74,77,80,82,88,90,94,97'>TextOut</a>. Ademas comprobamos si el record actual es el que se está pintando, para determinar si tenemos que pintar el cursor o no. Para pintar el cursor utilizamos <a href="http://msdn.microsoft.com/en-us/library/dd162719(VS.85).aspx" target="_blank" cid='IDPintar_Terminado' l='67'>FillRect</a> y la brocha la obtenemos del stock de brochas de Windows con <a href="http://msdn.microsoft.com/en-us/library/dd144925(VS.85).aspx" target="_blank" cid='IDPintar_Terminado' l='67'>GetStockObject</a>.</p>

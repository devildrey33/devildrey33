...
/*	include("devildrey33.php");
	...
	$META = '<meta name="description" content="NetBeans y MinGW Windows">
        ...
        ?>	
                ...
                <img src="../Web/Graficos/DescargaNetBeans.png" alt="Descargar NetBeans" />
                ...
                <img src="../Web/Graficos/InstalarJava.png" alt="Instalar Java SE" />
                ...
                <img src="../Web/Graficos/DownloadJDK.png" alt="Download JDK" />
                ...
                <img src="../Web/Graficos/InstalarNetBeans1.png" alt="Instalar NetBeans" />
                <p>Luego nos aparecerá un contrato de licencia que tenemos que aceptar, para luego pulsar el botón 'Siguiente'.</p>
                <img src="../Web/Graficos/InstalarNetBeans2.png" alt="Instalar NetBeans" />
                ...
                <img src="../Web/Graficos/InstalarNetBeans3.png" alt="Instalar NetBeans" />
                ...
                <img src="../Web/Graficos/InstalarNetBeans4.png" alt="Instalar NetBeans" />
                ...
                <img src="../Web/Graficos/InstalarNetBeans5.png" alt="Instalar NetBeans" />
                ...
                <img src="../Web/Graficos/DescargarMinGW.png" alt="Descargar MinGW" />
                ...
                <img src="../Web/Graficos/InstalarMinGW1.png" alt="Instalar MinGW" />
                ...
                <img src="../Web/Graficos/InstalarMinGW2.png" alt="Instalar MinGW" />
                ...
                <img src="../Web/Graficos/InstalarMinGW3.png" alt="Instalar MinGW" />
                ...
                <img src="../Web/Graficos/InstalarMinGW4.png" alt="Instalar MinGW" />
                ...
                <img src="../Web/Graficos/InstalarMinGW5.png" alt="Instalar MinGW" />
                ...
                <img src="../Web/Graficos/InstalarMinGW6.png" alt="Instalar MinGW" />
                ...
                <img src="../Web/Graficos/InstalarMinGW7.png" alt="Instalar MinGW" />
                ...
                <img src="../Web/Graficos/InstalarMinGW8.png" alt="Instalar MinGW" /><br /><br />
                ...
                <img src="../Web/Graficos/ConfigurarNetBeans1.png" alt="Configurar NetBeans" />
                ...
                <img src="../Web/Graficos/ConfigurarNetBeans2.png" alt="Configurar NetBeans" />
                <p>Al crear el proyecto NetBeans nos comunicara que no encuentra un compilador C/C++ y nos aparecerá la siguiente ventana.</p>
                <img src="../Web/Graficos/ConfigurarNetBeans3.png" alt="Configurar NetBeans" />
                ...
                <img src="../Web/Graficos/ConfigurarNetBeans4.png" alt="Configurar NetBeans" />
                ...
                <img src="../Web/Graficos/ConfigurarNetBeans5.png" alt="Configurar NetBeans" />
                <p>Luego en el código fuente creamos una aplicación sencilla, por ejemplo un "Hola mundo" y probamos a compilarla.</p>
                <img src="../Web/Graficos/ConfigurarNetBeans6.png" alt="Configurar NetBeans" />

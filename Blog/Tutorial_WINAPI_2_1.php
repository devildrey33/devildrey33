...
?>	
                ...
                <p>La mejor solución que se me ocurrió fue utilizar la API <a href="http://msdn.microsoft.com/en-us/library/dd145141(VS.85).aspx" target="_blank" cid='IDPintar' l='145,146'>TransparentBlt</a> en vez de usar la API <a href="http://msdn.microsoft.com/en-us/library/dd183370(VS.85).aspx" target="_blank">BitBlt</a>. La API <a href="http://msdn.microsoft.com/en-us/library/dd145141(VS.85).aspx" target="_blank" cid='IDPintar' l='145,146'>TransparentBlt</a> en esencia actúa como BitBlt, pero le podemos indicar un color como de la imagen para que lo trate como si fuera totalmente transparente.</p>
                <p>Pero con esto no solucionamos el problema aun. Al usar la API <a href="http://msdn.microsoft.com/en-us/library/dd183351(VS.85).aspx" target="_blank"cid='IDPintar' L='63'>AlphaBlend</a> los colores de las imágenes originales no tienen porque seguir siendo los mismos, por ejemplo queremos que el color transparente sea el negro, y tenemos una imagen con fondo negro, pero le sobreponemos otra imagen con <a href="http://msdn.microsoft.com/en-us/library/dd183351(VS.85).aspx" target="_blank" cid='IDPintar' L='63'>AlphaBlend</a> que tenia el fondo gris, el resultado de nuestro fondo sera un gris mas oscuro que no será negro. </p>
                <p>Lo que habrá que hacer es editar los pixeles que queremos que sean transparentes para asignarles el color que le indicaremos a la API <a href="http://msdn.microsoft.com/en-us/library/dd145141(VS.85).aspx" target="_blank" cid='IDPintar' l='145,146'>TransparentBlt</a> para usar como transparente. En este caso usaremos una tonalidad de color negro RGB(10,10,10) como en la foto de la derecha para lo que sobre de los bordes. </p>
                <img src="../Web/Graficos/BordesVentanaTranslucida.jpg" style="float:right" />

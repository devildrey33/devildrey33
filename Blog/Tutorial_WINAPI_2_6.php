...
/*	include("devildrey33.php");
	...
	$META = '<meta name="description" content="Tutorial WINAPI">
        ...
        $Base->InicioBlog(basename(__FILE__), "Tutorial WINAPI C++ 2.6 (Terminando el Snake)", FALSE);
...
<style type='text/css'>
    ...
    table.TablaSnake1 {
        ...
        box-shadow: rgba(0, 0, 0, 0.15) 5px 5px 5px;
                ...
                <p>Para determinar si una tecla se ha presionado, en el juego se  usa la API <a href="http://msdn.microsoft.com/en-us/library/ms646293(VS.85).aspx" target="_blank" cid='IDTeclado' l='6,11,16,21,25,32,42'>GetAsyncKeyState</a> a la cual debemos especificar la tecla virtual que  queremos mirar.</p>
                ...
                <p> <strong>3</strong> Repintamos la escena, obtenemos el DC de la ventana con la  API <a href="http://msdn.microsoft.com/en-us/library/dd144871%28VS.85%29.aspx" target="_blank" cid='IDWinMain' l='52'>GetDC</a>, utilizamos Ventana.Escena_Pintar para pintar la escena y utilizamos  la API <a href="http://msdn.microsoft.com/en-us/library/dd162920(v=VS.85).aspx" target="_blank" cid='IDWinMain' l='54'>ReleaseDC</a> para liberar el DC de la ventana.</p>
                <p> <strong>4</strong> Miramos posibles eventos que se puedan haber mandado. Para  ello utilizamos la API <a href="http://msdn.microsoft.com/en-us/library/ms644943(VS.85).aspx" target="_blank" cid='IDWinMain' l='57'>PeekMessage</a> que mira si hay algún evento, y en el caso  de retornar TRUE utilizamos las API's <a href="http://msdn.microsoft.com/en-us/library/ms644955(VS.85).aspx" target="_blank" cid='IDWinMain' l='60'>TranslateMessage</a> y <a href="http://msdn.microsoft.com/en-us/library/ms644934(VS.85).aspx" target="_blank" cid='IDWinMain' l='61'>DispatchMessage</a> para  obtener dicho evento. Hay que remarcar que si el mensaje es <a href="http://msdn.microsoft.com/en-us/library/ms632641(VS.85).aspx" target="_blank">WM_QUIT</a> asignaremos  FinApp a false con lo que terminara la aplicación.</p>

...
vec4 drawAudio(vec2 pos) {\r
    ...
    if (pSin < (uFrequencySin * uThicknessSin)) {        \r
        return vec4(1.0, 1.0, 1.0, (1.0 - pos.y));\r
        
    }\r
    
     if (p < (uFrequency * uThickness)) {        \r
        return vec4(hsl2rgb(vec3(uTime * -0.25, 1, (1.0 - pos.y) * 0.75 )), 1.0);\r
    }

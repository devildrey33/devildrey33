...
`;for(const v of s.matchAll(/(?:varying\s+\w+\s+([\S\s]*?);)/g))for(const S of v[1].split(/\s*,\s*/))t.varyings.add(S),_.add(S),g.add(S);for(const v of s.matchAll(o))g.add(v[1])}for(const y of n.matchAll(o))g.add(y[1]);for(const y of e.defines.keys())g.add(y.replace(/\([\w\s,]*\)/g,""));for(const y of e.uniforms.keys())g.add(y);g.delete("while"),g.delete("for"),g.delete("if"),e.uniforms.forEach((y,v)=>t.uniforms.set(i+v.charAt(0).toUpperCase()+v.slice(1),y)),e.defines.forEach((y,v)=>t.defines.set(i+v.charAt(0).toUpperCase()+v.slice(1),y));const m=new Map([["fragment",n],["vertex",s]]);vh(i,g,t.defines),vh(i,g,m),n=m.get("fragment"),s=m.get("vertex");const f=e.blendMode;if(t.blendModes.set(f.blendFunction,f),r){e.inputColorSpace!==null&&e.inputColorSpace!==t.colorSpace&&(h+=e.inputColorSpace===ht?`color0 = LinearTosRGB(color0);
	...
	`),e.outputColorSpace!==Nd?t.colorSpace=e.outputColorSpace:e.inputColorSpace!==null&&(t.colorSpace=e.inputColorSpace);const y=/MainImage *\([\w\s,]*?depth[\w\s,]*?\)/;h+=`${i}MainImage(color0, UV, `,t.attributes&Di.DEPTH&&y.test(n)&&(h+="depth, ",t.readDepth=!0),h+=`color1);
...
`}if(c+=n+`
`,s!==null&&(d+=s+`
`),l.set(Ye.FRAGMENT_HEAD,c),l.set(Ye.FRAGMENT_MAIN_UV,u),l.set(Ye.FRAGMENT_MAIN_IMAGE,h),l.set(Ye.VERTEX_HEAD,d),l.set(Ye.VERTEX_MAIN_SUPPORT,p),e.extensions!==null)for(const y of e.extensions)t.extensions.add(y)}}var Tr=class extends An{constructor(i,...e){super("EffectPass"),this.fullscreenMaterial=new Sy(null,null,null,i),this.listener=t=>this.handleEvent(t),this.effects=[],this.setEffects(e),this.skipRendering=!1,this.minTime=1,this.maxTime=Number.POSITIVE_INFINITY,this.timeScale=1}set mainScene(i){for(const e of this.effects)e.mainScene=i}set mainCamera(i){this.fullscreenMaterial.copyCameraSettings(i);for(const e of this.effects)e.mainCamera=i}get encodeOutput(){return this.fullscreenMaterial.encodeOutput}set encodeOutput(i){this.fullscreenMaterial.encodeOutput=i}get dithering(){return this.fullscreenMaterial.dithering}set dithering(i){const e=this.fullscreenMaterial;e.dithering=i,e.needsUpdate=!0}setEffects(i){for(const e of this.effects)e.removeEventListener("change",this.listener);this.effects=i.sort((e,t)=>t.attributes-e.attributes);for(const e of this.effects)e.addEventListener("change",this.listener)}updateMaterial(){const i=new zy;let e=0;for(const a of this.effects)if(a.blendMode.blendFunction===Oe.DST)i.attributes|=a.getAttributes()&Di.DEPTH;else{if(i.attributes&a.getAttributes()&Di.CONVOLUTION)throw new Error(`Convolution effects cannot be merged (${a.name})`);Iy("e"+e++,a,i)}let t=i.shaderParts.get(Ye.FRAGMENT_HEAD),n=i.shaderParts.get(Ye.FRAGMENT_MAIN_IMAGE),s=i.shaderParts.get(Ye.FRAGMENT_MAIN_UV);const r=/\bblend\b/g;for(const a of i.blendModes.values())t+=a.getShaderCode().replace(r,`blend${a.blendFunction}`)+`
...
void mainImage(const in vec4 inputColor, const in vec2 uv, out vec4 outputColor) {
    ...
    if (uTime > uStartTime && uTime < uEndTime) {\r
        ...
        float displacement = (curPosIn - curPosOut) * 0.125;\r
 ...
 * Club GreenSock members, the agreement issued with that membership.
 * @author: Jack Doyle, jack@greensock.com
*/var Ch,Ci,Ys,mc,ss,Ph,gc,kM=function(){return typeof window<"u"},di={},ts=180/Math.PI,js=Math.PI/180,zs=Math.atan2,Lh=1e8,_c=/([A-Z])/g,HM=/(left|right|width|margin|padding|x)/i,VM=/[\s,\(]\S/,zn={autoAlpha:"opacity,visibility",scale:"scaleX,scaleY",alpha:"opacity"},Ll=function(e,t){return t.set(t.t,t.p,Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},GM=function(e,t){return t.set(t.t,t.p,e===1?t.e:Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},WM=function(e,t){return t.set(t.t,t.p,e?Math.round((t.s+t.c*e)*1e4)/1e4+t.u:t.b,t)},XM=function(e,t){var n=t.s+t.c*e;t.set(t.t,t.p,~~(n+(n<0?-.5:.5))+t.u,t)},Uf=function(e,t){return t.set(t.t,t.p,e?t.e:t.b,t)},Of=function(e,t){return t.set(t.t,t.p,e!==1?t.b:t.e,t)},qM=function(e,t,n){return e.style[t]=n},YM=function(e,t,n){return e.style.setProperty(t,n)},jM=function(e,t,n){return e._gsap[t]=n},$M=function(e,t,n){return e._gsap.scaleX=e._gsap.scaleY=n},KM=function(e,t,n,s,r){var a=e._gsap;a.scaleX=a.scaleY=n,a.renderTransform(r,a)},ZM=function(e,t,n,s,r){var a=e._gsap;a[t]=n,a.renderTransform(r,a)},rt="transform",In=rt+"Origin",JM=function i(e,t){var n=this,s=this.target,r=s.style;if(e in di&&r){if(this.tfm=this.tfm||{},e!=="transform")e=zn[e]||e,~e.indexOf(",")?e.split(",").forEach(function(a){return n.tfm[a]=ri(s,a)}):this.tfm[e]=s._gsap.x?s._gsap[e]:ri(s,e);else return zn.transform.split(",").forEach(function(a){return i.call(n,a,t)});if(this.props.indexOf(rt)>=0)return;s._gsap.svg&&(this.svgo=s.getAttribute("data-svg-origin"),this.props.push(In,t,"")),e=rt}(r||t)&&this.props.push(e,t,r[e])},Nf=function(e){e.translate&&(e.removeProperty("translate"),e.removeProperty("scale"),e.removeProperty("rotate"))},QM=function(){var e=this.props,t=this.target,n=t.style,s=t._gsap,r,a;for(r=0;r<e.length;r+=3)e[r+1]?t[e[r]]=e[r+2]:e[r+2]?n[e[r]]=e[r+2]:n.removeProperty(e[r].substr(0,2)==="--"?e[r]:e[r].replace(_c,"-$1").toLowerCase());if(this.tfm){for(a in this.tfm)s[a]=this.tfm[a];s.svg&&(s.renderTransform(),t.setAttribute("data-svg-origin",this.svgo||"")),r=gc(),(!r||!r.isStart)&&!n[rt]&&(Nf(n),s.uncache=1)}},Ff=function(e,t){var n={target:e,props:[],revert:QM,save:JM};return e._gsap||tn.core.getCache(e),t&&t.split(",").forEach(function(s){return n.save(s)}),n},Bf,Dl=function(e,t){var n=Ci.createElementNS?Ci.createElementNS((t||"http://www.w3.org/1999/xhtml").replace(/^https/,"http"),e):Ci.createElement(e);return n.style?n:Ci.createElement(e)},kn=function i(e,t,n){var s=getComputedStyle(e);return s[t]||s.getPropertyValue(t.replace(_c,"-$1").toLowerCase())||s.getPropertyValue(t)||!n&&i(e,ur(t)||t,1)||""},Dh="O,Moz,ms,Ms,Webkit".split(","),ur=function(e,t,n){var s=t||ss,r=s.style,a=5;if(e in r&&!n)return e;for(e=e.charAt(0).toUpperCase()+e.substr(1);a--&&!(Dh[a]+e in r););return a<0?null:(a===3?"ms":a>=0?Dh[a]:"")+e},Il=function(){kM()&&window.document&&(Ch=window,Ci=Ch.document,Ys=Ci.documentElement,ss=Dl("div")||{style:{}},Dl("div"),rt=ur(rt),In=rt+"Origin",ss.style.cssText="border-width:0;line-height:0;position:absolute;padding:0",Bf=!!ur("perspective"),gc=tn.core.reverting,mc=1)},nl=function i(e){var t=Dl("svg",this.ownerSVGElement&&this.ownerSVGElement.getAttribute("xmlns")||"http://www.w3.org/2000/svg"),n=this.parentNode,s=this.nextSibling,r=this.style.cssText,a;if(Ys.appendChild(t),t.appendChild(this),this.style.display="block",e)try{a=this.getBBox(),this._gsapBBox=this.getBBox,this.getBBox=i}catch{}else this._gsapBBox&&(a=this._gsapBBox());return n&&(s?n.insertBefore(this,s):n.appendChild(this)),Ys.removeChild(t),this.style.cssText=r,a},Ih=function(e,t){for(var n=t.length;n--;)if(e.hasAttribute(t[n]))return e.getAttribute(t[n])},zf=function(e){var t;try{t=e.getBBox()}catch{t=nl.call(e,!0)}return t&&(t.width||t.height)||e.getBBox===nl||(t=nl.call(e,!0)),t&&!t.width&&!t.x&&!t.y?{x:+Ih(e,["x","cx","x1"])||0,y:+Ih(e,["y","cy","y1"])||0,width:0,height:0}:t},kf=function(e){return!!(e.getCTM&&(!e.parentNode||e.ownerSVGElement)&&zf(e))},Gr=function(e,t){if(t){var n=e.style;t in di&&t!==In&&(t=rt),n.removeProperty?((t.substr(0,2)==="ms"||t.substr(0,6)==="webkit")&&(t="-"+t),n.removeProperty(t.replace(_c,"-$1").toLowerCase())):n.removeAttribute(t)}},Pi=function(e,t,n,s,r,a){var o=new en(e._pt,t,n,0,1,a?Of:Uf);return e._pt=o,o.b=s,o.e=r,e._props.push(n),o},Uh={deg:1,rad:1,turn:1},eE={grid:1,flex:1},Bi=function i(e,t,n,s){var r=parseFloat(n)||0,a=(n+"").trim().substr((r+"").length)||"px",o=ss.style,l=HM.test(t),c=e.tagName.toLowerCase()==="svg",u=(c?"client":"offset")+(l?"Width":"Height"),h=100,d=s==="px",p=s==="%",_,g,m,f;return s===a||!r||Uh[s]||Uh[a]?r:(a!=="px"&&!d&&(r=i(e,t,n,"px")),f=e.getCTM&&kf(e),(p||a==="%")&&(di[t]||~t.indexOf("adius"))?(_=f?e.getBBox()[l?"width":"height"]:e[u],mt(p?r/_*h:r/100*_)):(o[l?"width":"height"]=h+(d?a:s),g=~t.indexOf("adius")||s==="em"&&e.appendChild&&!c?e:e.parentNode,f&&(g=(e.ownerSVGElement||{}).parentNode),(!g||g===Ci||!g.appendChild)&&(g=Ci.body),m=g._gsap,m&&p&&m.width&&l&&m.time===on.time&&!m.uncache?mt(r/m.width*h):((p||a==="%")&&!eE[kn(g,"display")]&&(o.position=kn(e,"position")),g===e&&(o.position="static"),g.appendChild(ss),_=ss[u],g.removeChild(ss),o.position="absolute",l&&p&&(m=os(g),m.time=on.time,m.width=g[u]),mt(d?_*r/h:_&&r?h/_*r:0))))},ri=function(e,t,n,s){var r;return mc||Il(),t in zn&&t!=="transform"&&(t=zn[t],~t.indexOf(",")&&(t=t.split(",")[0])),di[t]&&t!=="transform"?(r=Xr(e,s),r=t!=="transformOrigin"?r[t]:r.svg?r.origin:$a(kn(e,In))+" "+r.zOrigin+"px"):(r=e.style[t],(!r||r==="auto"||s||~(r+"").indexOf("calc("))&&(r=ja[t]&&ja[t](e,t,n)||kn(e,t)||tf(e,t)||(t==="opacity"?1:0))),n&&!~(r+"").trim().indexOf(" ")?Bi(e,t,r,n)+n:r},tE=function(e,t,n,s){if(!n||n==="none"){var r=ur(t,e,1),a=r&&kn(e,r,1);a&&a!==n?(t=r,n=a):t==="borderColor"&&(n=kn(e,"borderTopColor"))}var o=new en(this._pt,e.style,t,0,1,Lf),l=0,c=0,u,h,d,p,_,g,m,f,y,v,S,M;if(o.b=n,o.e=s,n+="",s+="",s==="auto"&&(e.style[t]=s,s=kn(e,t)||s,e.style[t]=n),u=[n,s],Sf(u),n=u[0],s=u[1],d=n.match(Vs)||[],M=s.match(Vs)||[],M.length){for(;h=Vs.exec(s);)m=h[0],y=s.substring(l,h.index),_?_=(_+1)%5:(y.substr(-5)==="rgba("||y.substr(-5)==="hsla(")&&(_=1),m!==(g=d[c++]||"")&&(p=parseFloat(g)||0,S=g.substr((p+"").length),m.charAt(1)==="="&&(m=qs(p,m)+S),f=parseFloat(m),v=m.substr((f+"").length),l=Vs.lastIndex-v.length,v||(v=v||cn.units[t]||S,l===s.length&&(s+=v,o.e+=v)),S!==v&&(p=Bi(e,t,g,v)||0),o._pt={_next:o._pt,p:y||c===1?y:",",s:p,c:f-p,m:_&&_<4||t==="zIndex"?Math.round:0});o.c=l<s.length?s.substring(l,s.length):""}else o.r=t==="display"&&s==="none"?Of:Uf;return $d.test(s)&&(o.e=0),this._pt=o,o},Oh={top:"0%",bottom:"100%",left:"0%",right:"100%",center:"50%"},nE=function(e){var t=e.split(" "),n=t[0],s=t[1]||"50%";return(n==="top"||n==="bottom"||s==="left"||s==="right")&&(e=n,n=s,s=e),t[0]=Oh[n]||n,t[1]=Oh[s]||s,t.join(" ")},iE=function(e,t){if(t.tween&&t.tween._time===t.tween._dur){var n=t.t,s=n.style,r=t.u,a=n._gsap,o,l,c;if(r==="all"||r===!0)s.cssText="",l=1;else for(r=r.split(","),c=r.length;--c>-1;)o=r[c],di[o]&&(l=1,o=o==="transformOrigin"?In:rt),Gr(n,o);l&&(Gr(n,rt),a&&(a.svg&&n.removeAttribute("transform"),Xr(n,1),a.uncache=1,Nf(s)))}},ja={clearProps:function(e,t,n,s,r){if(r.data!=="isFromStart"){var a=e._pt=new en(e._pt,t,n,0,0,iE);return a.u=s,a.pr=-10,a.tween=r,e._props.push(n),1}}},Wr=[1,0,0,1,0,0],Hf={},Vf=function(e){return e==="matrix(1, 0, 0, 1, 0, 0)"||e==="none"||!e},Nh=function(e){var t=kn(e,rt);return Vf(t)?Wr:t.substr(7).match(jd).map(mt)},vc=function(e,t){var n=e._gsap||os(e),s=e.style,r=Nh(e),a,o,l,c;return n.svg&&e.getAttribute("transform")?(l=e.transform.baseVal.consolidate().matrix,r=[l.a,l.b,l.c,l.d,l.e,l.f],r.join(",")==="1,0,0,1,0,0"?Wr:r):(r===Wr&&!e.offsetParent&&e!==Ys&&!n.svg&&(l=s.display,s.display="block",a=e.parentNode,(!a||!e.offsetParent)&&(c=1,o=e.nextElementSibling,Ys.appendChild(e)),r=Nh(e),l?s.display=l:Gr(e,"display"),c&&(o?a.insertBefore(e,o):a?a.appendChild(e):Ys.removeChild(e))),t&&r.length>6?[r[0],r[1],r[4],r[5],r[12],r[13]]:r)},Ul=function(e,t,n,s,r,a){var o=e._gsap,l=r||vc(e,!0),c=o.xOrigin||0,u=o.yOrigin||0,h=o.xOffset||0,d=o.yOffset||0,p=l[0],_=l[1],g=l[2],m=l[3],f=l[4],y=l[5],v=t.split(" "),S=parseFloat(v[0])||0,M=parseFloat(v[1])||0,w,T,C,x;n?l!==Wr&&(T=p*m-_*g)&&(C=S*(m/T)+M*(-g/T)+(g*y-m*f)/T,x=S*(-_/T)+M*(p/T)-(p*y-_*f)/T,S=C,M=x):(w=zf(e),S=w.x+(~v[0].indexOf("%")?S/100*w.width:S),M=w.y+(~(v[1]||v[0]).indexOf("%")?M/100*w.height:M)),s||s!==!1&&o.smooth?(f=S-c,y=M-u,o.xOffset=h+(f*p+y*g)-f,o.yOffset=d+(f*_+y*m)-y):o.xOffset=o.yOffset=0,o.xOrigin=S,o.yOrigin=M,o.smooth=!!s,o.origin=t,o.originIsAbsolute=!!n,e.style[In]="0px 0px",a&&(Pi(a,o,"xOrigin",c,S),Pi(a,o,"yOrigin",u,M),Pi(a,o,"xOffset",h,o.xOffset),Pi(a,o,"yOffset",d,o.yOffset)),e.setAttribute("data-svg-origin",S+" "+M)},Xr=function(e,t){var n=e._gsap||new Af(e);if("x"in n&&!t&&!n.uncache)return n;var s=e.style,r=n.scaleX<0,a="px",o="deg",l=getComputedStyle(e),c=kn(e,In)||"0",u,h,d,p,_,g,m,f,y,v,S,M,w,T,C,x,A,W,q,I,O,N,K,V,Y,Q,Z,z,X,he,re,le;return u=h=d=g=m=f=y=v=S=0,p=_=1,n.svg=!!(e.getCTM&&kf(e)),l.translate&&((l.translate!=="none"||l.scale!=="none"||l.rotate!=="none")&&(s[rt]=(l.translate!=="none"?"translate3d("+(l.translate+" 0 0").split(" ").slice(0,3).join(", ")+") ":"")+(l.rotate!=="none"?"rotate("+l.rotate+") ":"")+(l.scale!=="none"?"scale("+l.scale.split(" ").join(",")+") ":"")+(l[rt]!=="none"?l[rt]:"")),s.scale=s.rotate=s.translate="none"),T=vc(e,n.svg),n.svg&&(n.uncache?(Y=e.getBBox(),c=n.xOrigin-Y.x+"px "+(n.yOrigin-Y.y)+"px",V=""):V=!t&&e.getAttribute("data-svg-origin"),Ul(e,V||c,!!V||n.originIsAbsolute,n.smooth!==!1,T)),M=n.xOrigin||0,w=n.yOrigin||0,T!==Wr&&(W=T[0],q=T[1],I=T[2],O=T[3],u=N=T[4],h=K=T[5],T.length===6?(p=Math.sqrt(W*W+q*q),_=Math.sqrt(O*O+I*I),g=W||q?zs(q,W)*ts:0,y=I||O?zs(I,O)*ts+g:0,y&&(_*=Math.abs(Math.cos(y*js))),n.svg&&(u-=M-(M*W+w*I),h-=w-(M*q+w*O))):(le=T[6],he=T[7],Z=T[8],z=T[9],X=T[10],re=T[11],u=T[12],h=T[13],d=T[14],C=zs(le,X),m=C*ts,C&&(x=Math.cos(-C),A=Math.sin(-C),V=N*x+Z*A,Y=K*x+z*A,Q=le*x+X*A,Z=N*-A+Z*x,z=K*-A+z*x,X=le*-A+X*x,re=he*-A+re*x,N=V,K=Y,le=Q),C=zs(-I,X),f=C*ts,C&&(x=Math.cos(-C),A=Math.sin(-C),V=W*x-Z*A,Y=q*x-z*A,Q=I*x-X*A,re=O*A+re*x,W=V,q=Y,I=Q),C=zs(q,W),g=C*ts,C&&(x=Math.cos(C),A=Math.sin(C),V=W*x+q*A,Y=N*x+K*A,q=q*x-W*A,K=K*x-N*A,W=V,N=Y),m&&Math.abs(m)+Math.abs(g)>359.9&&(m=g=0,f=180-f),p=mt(Math.sqrt(W*W+q*q+I*I)),_=mt(Math.sqrt(K*K+le*le)),C=zs(N,K),y=Math.abs(C)>2e-4?C*ts:0,S=re?1/(re<0?-re:re):0),n.svg&&(V=e.getAttribute("transform"),n.forceCSS=e.setAttribute("transform","")||!Vf(kn(e,rt)),V&&e.setAttribute("transform",V))),Math.abs(y)>90&&Math.abs(y)<270&&(r?(p*=-1,y+=g<=0?180:-180,g+=g<=0?180:-180):(_*=-1,y+=y<=0?180:-180)),t=t||n.uncache,n.x=u-((n.xPercent=u&&(!t&&n.xPercent||(Math.round(e.offsetWidth/2)===Math.round(-u)?-50:0)))?e.offsetWidth*n.xPercent/100:0)+a,n.y=h-((n.yPercent=h&&(!t&&n.yPercent||(Math.round(e.offsetHeight/2)===Math.round(-h)?-50:0)))?e.offsetHeight*n.yPercent/100:0)+a,n.z=d+a,n.scaleX=mt(p),n.scaleY=mt(_),n.rotation=mt(g)+o,n.rotationX=mt(m)+o,n.rotationY=mt(f)+o,n.skewX=y+o,n.skewY=v+o,n.transformPerspective=S+a,(n.zOrigin=parseFloat(c.split(" ")[2])||0)&&(s[In]=$a(c)),n.xOffset=n.yOffset=0,n.force3D=cn.force3D,n.renderTransform=n.svg?rE:Bf?Gf:sE,n.uncache=0,n},$a=function(e){return(e=e.split(" "))[0]+" "+e[1]},il=function(e,t,n){var s=Vt(t);return mt(parseFloat(t)+parseFloat(Bi(e,"x",n+"px",s)))+s},sE=function(e,t){t.z="0px",t.rotationY=t.rotationX="0deg",t.force3D=0,Gf(e,t)},ji="0deg",Ar="0px",$i=") ",Gf=function(e,t){var n=t||this,s=n.xPercent,r=n.yPercent,a=n.x,o=n.y,l=n.z,c=n.rotation,u=n.rotationY,h=n.rotationX,d=n.skewX,p=n.skewY,_=n.scaleX,g=n.scaleY,m=n.transformPerspective,f=n.force3D,y=n.target,v=n.zOrigin,S="",M=f==="auto"&&e&&e!==1||f===!0;if(v&&(h!==ji||u!==ji)){var w=parseFloat(u)*js,T=Math.sin(w),C=Math.cos(w),x;w=parseFloat(h)*js,x=Math.cos(w),a=il(y,a,T*x*-v),o=il(y,o,-Math.sin(w)*-v),l=il(y,l,C*x*-v+v)}m!==Ar&&(S+="perspective("+m+$i),(s||r)&&(S+="translate("+s+"%, "+r+"%) "),(M||a!==Ar||o!==Ar||l!==Ar)&&(S+=l!==Ar||M?"translate3d("+a+", "+o+", "+l+") ":"translate("+a+", "+o+$i),c!==ji&&(S+="rotate("+c+$i),u!==ji&&(S+="rotateY("+u+$i),h!==ji&&(S+="rotateX("+h+$i),(d!==ji||p!==ji)&&(S+="skew("+d+", "+p+$i),(_!==1||g!==1)&&(S+="scale("+_+", "+g+$i),y.style[rt]=S||"translate(0, 0)"},rE=function(e,t){var n=t||this,s=n.xPercent,r=n.yPercent,a=n.x,o=n.y,l=n.rotation,c=n.skewX,u=n.skewY,h=n.scaleX,d=n.scaleY,p=n.target,_=n.xOrigin,g=n.yOrigin,m=n.xOffset,f=n.yOffset,y=n.forceCSS,v=parseFloat(a),S=parseFloat(o),M,w,T,C,x;l=parseFloat(l),c=parseFloat(c),u=parseFloat(u),u&&(u=parseFloat(u),c+=u,l+=u),l||c?(l*=js,c*=js,M=Math.cos(l)*h,w=Math.sin(l)*h,T=Math.sin(l-c)*-d,C=Math.cos(l-c)*d,c&&(u*=js,x=Math.tan(c-u),x=Math.sqrt(1+x*x),T*=x,C*=x,u&&(x=Math.tan(u),x=Math.sqrt(1+x*x),M*=x,w*=x)),M=mt(M),w=mt(w),T=mt(T),C=mt(C)):(M=h,C=d,w=T=0),(v&&!~(a+"").indexOf("px")||S&&!~(o+"").indexOf("px"))&&(v=Bi(p,"x",a,"px"),S=Bi(p,"y",o,"px")),(_||g||m||f)&&(v=mt(v+_-(_*M+g*T)+m),S=mt(S+g-(_*w+g*C)+f)),(s||r)&&(x=p.getBBox(),v=mt(v+s/100*x.width),S=mt(S+r/100*x.height)),x="matrix("+M+","+w+","+T+","+C+","+v+","+S+")",p.setAttribute("transform",x),y&&(p.style[rt]=x)},aE=function(e,t,n,s,r){var a=360,o=Ut(r),l=parseFloat(r)*(o&&~r.indexOf("rad")?ts:1),c=l-s,u=s+c+"deg",h,d;return o&&(h=r.split("_")[1],h==="short"&&(c%=a,c!==c%(a/2)&&(c+=c<0?a:-a)),h==="cw"&&c<0?c=(c+a*Lh)%a-~~(c/a)*a:h==="ccw"&&c>0&&(c=(c-a*Lh)%a-~~(c/a)*a)),e._pt=d=new en(e._pt,t,n,s,c,GM),d.e=u,d.u="deg",e._props.push(n),d},Fh=function(e,t){for(var n in t)e[n]=t[n];return e},oE=function(e,t,n){var s=Fh({},n._gsap),r="perspective,force3D,transformOrigin,svgOrigin",a=n.style,o,l,c,u,h,d,p,_;s.svg?(c=n.getAttribute("transform"),n.setAttribute("transform",""),a[rt]=t,o=Xr(n,1),Gr(n,rt),n.setAttribute("transform",c)):(c=getComputedStyle(n)[rt],a[rt]=t,o=Xr(n,1),a[rt]=c);for(l in di)c=s[l],u=o[l],c!==u&&r.indexOf(l)<0&&(p=Vt(c),_=Vt(u),h=p!==_?Bi(n,l,c,_):parseFloat(c),d=parseFloat(u),e._pt=new en(e._pt,o,l,h,d-h,Ll),e._pt.u=_||0,e._props.push(l));Fh(o,s)};Qt("padding,margin,Width,Radius",function(i,e){var t="Top",n="Right",s="Bottom",r="Left",a=(e<3?[t,n,s,r]:[t+r,t+n,s+n,s+r]).map(function(o){return e<2?i+o:"border"+o+i});ja[e>1?"border"+i:i]=function(o,l,c,u,h){var d,p;if(arguments.length<4)return d=a.map(function(_){return ri(o,_,c)}),p=d.join(" "),p.split(d[0]).length===5?d[0]:p;d=(u+"").split(" "),p={},a.forEach(function(_,g){return p[_]=d[g]=d[g]||d[(g-1)/2|0]}),o.init(l,p,h)}});var Wf={name:"css",register:Il,targetTest:function(e){return e.style&&e.nodeType},init:function(e,t,n,s,r){var a=this._props,o=e.style,l=n.vars.startAt,c,u,h,d,p,_,g,m,f,y,v,S,M,w,T,C;mc||Il(),this.styles=this.styles||Ff(e),C=this.styles.props,this.tween=n;for(g in t)if(g!=="autoRound"&&(u=t[g],!(an[g]&&bf(g,t,n,s,e,r)))){if(p=typeof u,_=ja[g],p==="function"&&(u=u.call(n,s,e,r),p=typeof u),p==="string"&&~u.indexOf("random(")&&(u=kr(u)),_)_(this,e,g,u,n)&&(T=1);else if(g.substr(0,2)==="--")c=(getComputedStyle(e).getPropertyValue(g)+"").trim(),u+="",Ui.lastIndex=0,Ui.test(c)||(m=Vt(c),f=Vt(u)),f?m!==f&&(c=Bi(e,g,c,f)+f):m&&(u+=m),this.add(o,"setProperty",c,u,s,r,0,0,g),a.push(g),C.push(g,0,o[g]);else if(p!=="undefined"){if(l&&g in l?(c=typeof l[g]=="function"?l[g].call(n,s,e,r):l[g],Ut(c)&&~c.indexOf("random(")&&(c=kr(c)),Vt(c+"")||(c+=cn.units[g]||Vt(ri(e,g))||""),(c+"").charAt(1)==="="&&(c=ri(e,g))):c=ri(e,g),d=parseFloat(c),y=p==="string"&&u.charAt(1)==="="&&u.substr(0,2),y&&(u=u.substr(2)),h=parseFloat(u),g in zn&&(g==="autoAlpha"&&(d===1&&ri(e,"visibility")==="hidden"&&h&&(d=0),C.push("visibility",0,o.visibility),Pi(this,o,"visibility",d?"inherit":"hidden",h?"inherit":"hidden",!h)),g!=="scale"&&g!=="transform"&&(g=zn[g],~g.indexOf(",")&&(g=g.split(",")[0]))),v=g in di,v){if(this.styles.save(g),S||(M=e._gsap,M.renderTransform&&!t.parseTransform||Xr(e,t.parseTransform),w=t.smoothOrigin!==!1&&M.smooth,S=this._pt=new en(this._pt,o,rt,0,1,M.renderTransform,M,0,-1),S.dep=1),g==="scale")this._pt=new en(this._pt,M,"scaleY",M.scaleY,(y?qs(M.scaleY,y+h):h)-M.scaleY||0,Ll),this._pt.u=0,a.push("scaleY",g),g+="X";else if(g==="transformOrigin"){C.push(In,0,o[In]),u=nE(u),M.svg?Ul(e,u,0,w,0,this):(f=parseFloat(u.split(" ")[2])||0,f!==M.zOrigin&&Pi(this,M,"zOrigin",M.zOrigin,f),Pi(this,o,g,$a(c),$a(u)));continue}else if(g==="svgOrigin"){Ul(e,u,1,w,0,this);continue}else if(g in Hf){aE(this,M,g,d,y?qs(d,y+u):u);continue}else if(g==="smoothOrigin"){Pi(this,M,"smooth",M.smooth,u);continue}else if(g==="force3D"){M[g]=u;continue}else if(g==="transform"){oE(this,u,e);continue}}else g in o||(g=ur(g)||g);if(v||(h||h===0)&&(d||d===0)&&!VM.test(u)&&g in o)m=(c+"").substr((d+"").length),h||(h=0),f=Vt(u)||(g in cn.units?cn.units[g]:m),m!==f&&(d=Bi(e,g,c,f)),this._pt=new en(this._pt,v?M:o,g,d,(y?qs(d,y+h):h)-d,!v&&(f==="px"||g==="zIndex")&&t.autoRound!==!1?XM:Ll),this._pt.u=f||0,m!==f&&f!=="%"&&(this._pt.b=c,this._pt.r=WM);else if(g in o)tE.call(this,e,g,c,y?y+u:u);else if(g in e)this.add(e,g,c||e[g],y?y+u:u,s,r);else if(g!=="parseTransform"){ac(g,u);continue}v||(g in o?C.push(g,0,o[g]):C.push(g,1,c||e[g])),a.push(g)}}T&&Df(this)},render:function(e,t){if(t.tween._time||!gc())for(var n=t._pt;n;)n.r(e,n.d),n=n._next;else t.styles.revert()},get:ri,aliases:zn,getSetter:function(e,t,n){var s=zn[t];return s&&s.indexOf(",")<0&&(t=s),t in di&&t!==In&&(e._gsap.x||ri(e,"x"))?n&&Ph===n?t==="scale"?$M:jM:(Ph=n||{})&&(t==="scale"?KM:ZM):e.style&&!ic(e.style[t])?qM:~t.indexOf("-")?YM:fc(e,t)},core:{_removeProperty:Gr,_getMatrix:vc}};tn.utils.checkPrefix=ur;tn.core.getStyleSaver=Ff;(function(i,e,t,n){var s=Qt(i+","+e+","+t,function(r){di[r]=1});Qt(e,function(r){cn.units[r]="deg",Hf[r]=1}),zn[s[13]]=i+","+e,Qt(n,function(r){var a=r.split(":");zn[a[1]]=s[a[0]]})})("x,y,z,scale,scaleX,scaleY,xPercent,yPercent","rotation,rotationX,rotationY,skewX,skewY","transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective","0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY");Qt("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective",function(i){cn.units[i]="px"});tn.registerPlugin(Wf);var Pr=tn.registerPlugin(Wf)||tn;Pr.core.Tween;class Ki extends ms{constructor({originPow:e=[3,3,3],originMul:t=[2,2,2],originAdd:n=[.05,.05,.05],destPow:s=[3,3,3],destMul:r=[2,2,2],destAdd:a=[.05,.05,.05],ease:o="none",yoyo:l=!1}){super(),this.ease=o,this.yoyo=l,this.name="ColorCorrection",this.params="(...)",this.dest=[s[0],s[1],s[2],r[0],r[1],r[2],a[0],a[1],a[2]],this.origin=[e[0],e[1],e[2],t[0],t[1],t[2],n[0],n[1],n[2]]}setupAnimation(e,t,n){this.start=t,this.duration=n,this.colorCorrectionEffect=this.experience.renderer.colorCorrectionEffect,this.powOrigin=this.colorCorrectionEffect.uniforms.get("powRGB").value,this.mulOrigin=this.colorCorrectionEffect.uniforms.get("mulRGB").value,this.addOrigin=this.colorCorrectionEffect.uniforms.get("addRGB").value,e.to(this.origin,{id:this.id,ease:this.ease,repeat:this.yoyo===!0?1:0,yoyo:this.yoyo,duration:this.duration,endArray:this.dest,onUpdate:this.onUpdate,onUpdateParams:[this],onStart:this.onStart,onStartParams:[this],onComplete:this.onComplete,onCompleteParams:[this]},this.start)}onUpdate(e){e.colorCorrectionEffect.uniforms.get("powRGB").value.x=this.targets()[0][0],e.colorCorrectionEffect.uniforms.get("powRGB").value.y=this.targets()[0][1],e.colorCorrectionEffect.uniforms.get("powRGB").value.z=this.targets()[0][2],e.colorCorrectionEffect.uniforms.get("mulRGB").value.x=this.targets()[0][3],e.colorCorrectionEffect.uniforms.get("mulRGB").value.y=this.targets()[0][4],e.colorCorrectionEffect.uniforms.get("mulRGB").value.z=this.targets()[0][5],e.colorCorrectionEffect.uniforms.get("addRGB").value.x=this.targets()[0][6],e.colorCorrectionEffect.uniforms.get("addRGB").value.y=this.targets()[0][7],e.colorCorrectionEffect.uniforms.get("addRGB").value.z=this.targets()[0][8],e.onUpdateProgress(this._tTime,this._tDur)}}class Zi extends ms{constructor({animationIn:e=.5,animationOut:t=.5,ease:n="none",yoyo:s=!1}){super(),this.dest=[1],this.animationIn=e,this.animationOut=t,this.name="MirrorMode",this.params=`(${t})`,this.ease=n,this.yoyo=s}setupAnimation(e,t,n){this.start=t,this.duration=n,this.mirrorEffect=this.experience.renderer.mirrorModeEffect,this.origin=[0],e.to(this.origin,{id:this.id,ease:this.ease,repeat:this.yoyo===!0?1:0,yoyo:this.yoyo,duration:this.duration,endArray:this.dest,onUpdate:this.onUpdate,onUpdateParams:[this],onStart:this.onStart,onStartParams:[this],onComplete:this.onComplete,onCompleteParams:[this]},this.start)}onUpdate(e){this.targets()[0][0]>0&&e.mirrorEffect.init(e.start,e.start+e.duration,e.experience.sizes.width,e.experience.sizes.height,e.animationIn,e.animationOut),e.onUpdateProgress(this._tTime,this._tDur)}}class lE{constructor(e){Ct(this,"effects",[{start:1,end:30,effect:new Ki({destPow:[3,3,8],destMul:[2,2,15],destAdd:[.05,.05,.5]})},{start:8.5,end:9,effect:new it({scaleX:2,scaleZ:.65,ease:"bounce"})},{start:9,end:9.5,effect:new it({scaleZ:3,scaleX:.75,scaleY:.63,ease:"bounce"})},{start:12,end:12.5,effect:new Mi({position:50,ease:"bounce"})},{start:24.75,end:25.25,effect:new it({scaleX:3.5,ease:"bounce"})},{start:33,end:41,effect:new Bs({audioStrength:1.75,thickness:.15,color:new ve(2,2,0)})},{start:49,end:51,effect:new Bs({audioStrength:1.5,thickness:.2,color:new ve(2,0,0)})},{start:73,end:81,effect:new Zi({animationIn:1,animationOut:2.5})},{start:89,end:98,effect:new Zi({animationIn:1,animationOut:2.5})},{start:89,end:93,effect:new $t({destIntensity:2.48,destRadius:1.15,yoyo:!0})},{start:113.5,end:115,effect:new Ki({originPow:[3,3,8],originMul:[2,2,15],originAdd:[.05,.05,.5],destPow:[8,3,8],destMul:[15,2,15],destAdd:[.6,.05,.5],yoyo:!0})},{start:114,end:114.5,effect:new Mi({position:50,ease:"bounce"})},{start:114,end:114.25,effect:new it({scaleX:2.3,scaleZ:.75,ease:"bounce-inOut"})},{start:144,end:146,effect:new $t({destIntensity:1.48,destRadius:1.15,yoyo:!0})},{start:144.5,end:145,effect:new Fs({destThickness:.15,destAudioStrength:.75,ease:"bounce"})},{start:144.5,end:145,effect:new Mi({position:50,ease:"bounce"})},{start:144.5,end:145,effect:new Fs({originMirrors:1,destMirrors:2,yoyo:!1})},{start:145.5,end:146,effect:new Fs({originMirrors:2,destMirrors:2,destThickness:.15,destAudioStrength:.75,ease:"bounce"})},{start:145.5,end:146,effect:new Mi({position:50,ease:"bounce"})},{start:161.5,end:162,effect:new it({scaleX:2.3,scaleY:1.3,scaleZ:.75,ease:"bounce-inOut"})},{start:175,end:182,effect:new Zi({animationIn:1,animationOut:2.5})},{start:182.5,end:184,effect:new $t({destIntensity:-1.1,destRadius:-1.85,yoyo:!0})},{start:184.5,end:185.5,effect:new $t({destIntensity:-3,destRadius:.85,yoyo:!0})},{start:192.5,end:194,effect:new $t({destIntensity:3,destRadius:1.35,yoyo:!0})},{start:202,end:211,effect:new Zi({animationIn:1,animationOut:2.5})},{start:211,end:211.5,effect:new Mi({position:50,ease:"bounce"})},{start:218,end:227.5,effect:new Zi({animationIn:1,animationOut:2.5})},{start:243.5,end:245,effect:new Ki({originPow:[3,3,8],originMul:[2,2,15],originAdd:[.05,.05,.5],destPow:[8,3,8],destMul:[15,2,15],destAdd:[.6,.05,.5],yoyo:!0})},{start:244,end:244.5,effect:new Mi({position:50,ease:"bounce"})},{start:244,end:244.25,effect:new it({scaleX:2.3,scaleZ:.75,ease:"bounce-inOut"})},{start:274,end:274.75,effect:new it({scaleX:3.5,ease:"bounce"})},{start:274.75,end:275.5,effect:new it({scaleZ:2.75,ease:"bounce"})},{start:291,end:291.5,effect:new $t({destIntensity:3,destRadius:1.35,yoyo:!0})},{start:291.25,end:291.75,effect:new Mi({position:25,ease:"bounce"})},{start:304,end:311.5,effect:new Zi({animationIn:1,animationOut:2.5})},{start:312.5,end:313.5,effect:new $t({destIntensity:-3,destRadius:.85,yoyo:!0})},{start:314.5,end:315.5,effect:new $t({destIntensity:-3,destRadius:.85,yoyo:!0})},{start:322.5,end:324,effect:new $t({destIntensity:3,destRadius:1.35,yoyo:!0})},{start:356,end:361,effect:new Bs({audioStrength:.75,thickness:.25,color:new ve(0,2,3)})},{start:390,end:394,effect:new Fs({destThickness:.25,originMirrors:2,destMirrors:24,destAudioStrength:.5,yoyo:!1})},{start:390,end:394,effect:new $t({destIntensity:-1.5,destRadius:.65,yoyo:!1})},{start:394,end:395,effect:new Mi({position:50,ease:"elastic"})},{start:394.5,end:395,effect:new it({scaleZ:2.75,ease:"bounce"})},{start:394,end:395,effect:new Ki({originPow:[3,3,8],originMul:[2,2,15],originAdd:[.05,.05,.5],destPow:[3,3,3],destMul:[2,2,2],destAdd:[.35,.27,.5]})},{start:398,end:398.5,effect:new it({scaleY:1.5,ease:"bounce"})},{start:399,end:402,effect:new Fs({originAudioStrength:.5,destAudioStrength:.5,originThickness:.25,originMirrors:24,destMirrors:24,destThickness:.15,yoyo:!1})},{start:404,end:408,effect:new $t({originIntensity:-1.5,originRadius:.65,destIntensity:2,destRadius:1.12,yoyo:!1})},{start:406,end:415,effect:new Fs({originAudioStrength:.5,originThickness:.15,originMirrors:24,destMirrors:3,yoyo:!1})},{start:413,end:423,effect:new Zi({animationIn:1,animationOut:2.5})},{start:406,end:406.5,effect:new it({scaleX:1.75,ease:"bounce"})},{start:410,end:410.5,effect:new it({scaleZ:2,ease:"bounce"})},{start:414,end:420,effect:new Ki({originPow:[3,3,3],originMul:[2,2,2],originAdd:[.35,.27,.5],destPow:[3,3,8],destMul:[2,2,15],destAdd:[.05,.05,.5]})},{start:414,end:414.5,effect:new it({scaleY:2.25,ease:"bounce"})},{start:419,end:423,effect:new $t({originIntensity:2,originRadius:1.12,yoyo:!1})},{start:430,end:430.5,effect:new it({scaleX:2,scaleZ:.65,ease:"bounce"})},{start:430.5,end:431,effect:new it({scaleZ:3,scaleX:.75,scaleY:.63,ease:"bounce"})},{start:434,end:434.5,effect:new it({scaleX:.375,ease:"bounce"})},{start:445,end:449,effect:new Ki({originPow:[3,3,8],originMul:[2,2,15],originAdd:[.05,.05,.5],destPow:[3,8,8],destMul:[2,15,15],destAdd:[.05,.5,.5],yoyo:!0})},{start:446.75,end:447.25,effect:new it({scaleX:3.5,ease:"bounce"})},{start:454,end:460,effect:new Bs({audioStrength:.75,thickness:.15,color:new ve(2,0,0)})},{start:475,end:476,effect:new $t({destIntensity:-3,destRadius:.85,yoyo:!0})},{start:477.5,end:478.5,effect:new $t({destIntensity:-3,destRadius:.85,yoyo:!0})},{start:485.5,end:487,effect:new $t({destIntensity:3,destRadius:1.35,yoyo:!0})},{start:520,end:521,effect:new Bs({audioStrength:1.5,thickness:.15,color:new ve(2,0,0)})},{start:535,end:540,effect:new Bs({audioStrength:1.75,thickness:.2,color:new ve(0,0,2)})},{start:560,end:561,effect:new Ki({originPow:[3,3,8],originMul:[2,2,15],originAdd:[.05,.05,.5],destPow:[3,3,3],destMul:[2,2,2],destAdd:[.05,.05,.05]})}]);this.channels={LateralBars1:e.channelOther,LateralBars2:e.channelBass,LateralOsciloscope:e.channelDrum,Sun:e.channelVocal,SunRays:e.channelVocal,SpiralBars:e.channelSong,SpiralOsciloscope:e.channelVocal}}}class cE{constructor(e){Ct(this,"effects",[]);this.channels={LateralBars1:e.channelOther,LateralBars2:e.channelPiano,LateralOsciloscope:e.channelDrum,Sun:e.channelVocal,SunRays:e.channelVocal,SpiralBars:e.channelSong,SpiralOsciloscope:e.channelVocal}}}class uE{constructor(e){Ct(this,"effects",[]);this.channels={LateralBars1:e.channelOther,LateralBars2:e.channelBass,LateralOsciloscope:e.channelDrum,Sun:e.channelVocal,SunRays:e.channelVocal,SpiralBars:e.channelSong,SpiralOsciloscope:e.channelVocal}}}class hE{constructor(e){Ct(this,"effects",[]);this.channels={LateralBars1:e.channelOther,LateralBars2:e.channelBass,LateralOsciloscope:e.channelDrum,Sun:e.channelVocal,SunRays:e.channelVocal,SpiralBars:e.channelSong,SpiralOsciloscope:e.channelVocal}}}class dE{constructor(e){Ct(this,"effects",[]);this.channels={LateralBars1:e.channelOther,LateralBars2:e.channelBass,LateralOsciloscope:e.channelDrum,Sun:e.channelVocal,SunRays:e.channelVocal,SpiralBars:e.channelSong,SpiralOsciloscope:e.channelVocal}}}class fE{constructor(e){Ct(this,"effects",[]);this.channels={LateralBars1:e.channelOther,LateralBars2:e.channelBass,LateralOsciloscope:e.channelDrum,Sun:e.channelVocal,SunRays:e.channelVocal,SpiralBars:e.channelSong,SpiralOsciloscope:e.channelVocal}}}class pE{constructor(e){Ct(this,"effects",[]);this.channels={LateralBars1:e.channelOther,LateralBars2:e.channelBass,LateralOsciloscope:e.channelDrum,Sun:e.channelVocal,SunRays:e.channelVocal,SpiralBars:e.channelSong,SpiralOsciloscope:e.channelVocal}}}class mE{constructor(e){Ct(this,"effects",[{start:1.5,end:2,effect:new it({scaleX:2,scaleZ:.5,ease:"bounce"})},{start:9,end:9.5,effect:new it({scaleX:.125,scaleZ:2,ease:"bounce"})},{start:17,end:17.5,effect:new it({scaleX:2,scaleZ:.25,ease:"bounce"})},{start:24.5,end:25,effect:new it({scaleX:.125,scaleZ:2,ease:"bounce"})},{start:32.5,end:33,effect:new it({scaleX:2,scaleZ:.25,ease:"bounce"})},{start:40,end:40.5,effect:new it({scaleX:.25,scaleZ:2,ease:"bounce"})},{start:48,end:48.5,effect:new it({scaleX:2,scaleZ:.25,ease:"bounce"})},{start:56,end:56.5,effect:new it({scaleX:.25,scaleZ:2,ease:"bounce"})}]);this.channels={LateralBars1:e.channelOther,LateralBars2:e.channelBass,LateralOsciloscope:e.channelDrum,Sun:e.channelVocal,SunRays:e.channelVocal,SpiralBars:e.channelSong,SpiralOsciloscope:e.channelVocal}}}class gE{constructor(){this.experience=new gt,this.audioAnalizer=this.experience.audioAnalizer,this.killCityKills=new lE(this.audioAnalizer),this.nothingsOver=new cE(this.audioAnalizer),this.oneChance=new uE(this.audioAnalizer),this.quantumOcean=new hE(this.audioAnalizer),this.sixFeetUnder=new dE(this.audioAnalizer),this.theDeep=new fE(this.audioAnalizer),this.alone=new pE(this.audioAnalizer),this.lost=new mE(this.audioAnalizer),this.songChannels=[this.killCityKills.channels,this.nothingsOver.channels,this.oneChance.channels,this.quantumOcean.channels,this.sixFeetUnder.channels,this.theDeep.channels,this.alone.channels,this.lost.channels],this.songsEffects=[this.killCityKills.effects,this.nothingsOver.effects,this.oneChance.effects,this.quantumOcean.effects,this.sixFeetUnder.effects,this.theDeep.effects,this.alone.effects,this.lost.effects]}RecalculateAnimations(e){console.log("recalculate animations");const t=this.experience.currentSong,n=this.experience.song.bpmMS;this.songsEffects[t].forEach(s=>{let r=s.start*n/1e3,a=s.end*n/1e3-r;s.effect.setupAnimation(e,r,a)})}}var _E=`varying vec2 vUv;

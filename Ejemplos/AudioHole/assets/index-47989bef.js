...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:kt,depthTest:!1,depthWrite:!1})}function Cu(){return new ot({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Vl(),fragmentShader:`
		...
		`,blending:kt,depthTest:!1,depthWrite:!1})}function Pu(){return new ot({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Vl(),fragmentShader:`
...
#include <colorspace_fragment>
}`,hy="uniform vec4 texelSize;uniform float kernel;uniform float scale;varying vec2 vUv0;varying vec2 vUv1;varying vec2 vUv2;varying vec2 vUv3;void main(){vec2 uv=position.xy*0.5+0.5;vec2 dUv=(texelSize.xy*vec2(kernel)+texelSize.zw)*scale;vUv0=vec2(uv.x-dUv.x,uv.y+dUv.y);vUv1=vec2(uv.x+dUv.x,uv.y+dUv.y);vUv2=vec2(uv.x+dUv.x,uv.y-dUv.y);vUv3=vec2(uv.x-dUv.x,uv.y-dUv.y);gl_Position=vec4(position.xy,1.0,1.0);}",dy=[new Float32Array([0,0]),new Float32Array([0,1,1]),new Float32Array([0,1,1,2]),new Float32Array([0,1,2,2,3]),new Float32Array([0,1,2,3,4,4,5]),new Float32Array([0,1,2,3,4,5,7,8,9,10])],fy=class extends ot{constructor(i=new je){super({name:"KawaseBlurMaterial",uniforms:{inputBuffer:new ge(null),texelSize:new ge(new je),scale:new ge(1),kernel:new ge(0)},blending:kt,toneMapped:!1,depthWrite:!1,depthTest:!1,fragmentShader:uy,vertexShader:hy}),this.fragmentShader=$r(this.fragmentShader),this.setTexelSize(i.x,i.y),this.kernelSize=to.MEDIUM}set inputBuffer(i){this.uniforms.inputBuffer.value=i}setInputBuffer(i){this.inputBuffer=i}get kernelSequence(){return dy[this.kernelSize]}get scale(){return this.uniforms.scale.value}set scale(i){this.uniforms.scale.value=i}getScale(){return this.uniforms.scale.value}setScale(i){this.uniforms.scale.value=i}getKernel(){return null}get kernel(){return this.uniforms.kernel.value}set kernel(i){this.uniforms.kernel.value=i}setKernel(i){this.kernel=i}setTexelSize(i,e){this.uniforms.texelSize.value.set(i,e,i*.5,e*.5)}setSize(i,e){const t=1/i,n=1/e;this.uniforms.texelSize.value.set(t,n,t*.5,n*.5)}},py=`#include <common>
#include <dithering_pars_fragment>
...
#include <colorspace_fragment>
#include <dithering_fragment>
}`,zd=class extends ot{constructor(){super({name:"CopyMaterial",uniforms:{inputBuffer:new ge(null),opacity:new ge(1)},blending:kt,toneMapped:!1,depthWrite:!1,depthTest:!1,fragmentShader:py,vertexShader:Kr}),this.fragmentShader=$r(this.fragmentShader)}set inputBuffer(i){this.uniforms.inputBuffer.value=i}setInputBuffer(i){this.uniforms.inputBuffer.value=i}getOpacity(i){return this.uniforms.opacity.value}setOpacity(i){this.uniforms.opacity.value=i}},my=`#include <common>
#include <packing>
...
#include <colorspace_fragment>
}`,vy="uniform vec2 texelSize;varying vec2 vUv;varying vec2 vUv00;varying vec2 vUv01;varying vec2 vUv02;varying vec2 vUv03;varying vec2 vUv04;varying vec2 vUv05;varying vec2 vUv06;varying vec2 vUv07;varying vec2 vUv08;varying vec2 vUv09;varying vec2 vUv10;varying vec2 vUv11;void main(){vUv=position.xy*0.5+0.5;vUv00=vUv+texelSize*vec2(-1.0,1.0);vUv01=vUv+texelSize*vec2(1.0,1.0);vUv02=vUv+texelSize*vec2(-1.0,-1.0);vUv03=vUv+texelSize*vec2(1.0,-1.0);vUv04=vUv+texelSize*vec2(-2.0,2.0);vUv05=vUv+texelSize*vec2(0.0,2.0);vUv06=vUv+texelSize*vec2(2.0,2.0);vUv07=vUv+texelSize*vec2(-2.0,0.0);vUv08=vUv+texelSize*vec2(2.0,0.0);vUv09=vUv+texelSize*vec2(-2.0,-2.0);vUv10=vUv+texelSize*vec2(0.0,-2.0);vUv11=vUv+texelSize*vec2(2.0,-2.0);gl_Position=vec4(position.xy,1.0,1.0);}",xy=class extends ot{constructor(){super({name:"DownsamplingMaterial",uniforms:{inputBuffer:new ge(null),texelSize:new ge(new pe)},blending:kt,toneMapped:!1,depthWrite:!1,depthTest:!1,fragmentShader:_y,vertexShader:vy}),this.fragmentShader=$r(this.fragmentShader)}set inputBuffer(i){this.uniforms.inputBuffer.value=i}setSize(i,e){this.uniforms.texelSize.value.set(1/i,1/e)}},yy=`#include <common>
#include <packing>
#include <dithering_pars_fragment>
#define packFloatToRGBA(v) packDepthToRGBA(v)
#define unpackRGBAToFloat(v) unpackRGBAToDepth(v)
...
#endif
#include <dithering_fragment>
}`,Sy="uniform vec2 resolution;uniform vec2 texelSize;uniform float cameraNear;uniform float cameraFar;uniform float aspect;uniform float time;varying vec2 vUv;VERTEX_HEAD void main(){vUv=position.xy*0.5+0.5;VERTEX_MAIN_SUPPORT gl_Position=vec4(position.xy,1.0,1.0);}",My=class extends ot{constructor(i,e,t,n,s=!1){super({name:"EffectMaterial",defines:{THREE_REVISION:cr.replace(/\D+/g,""),DEPTH_PACKING:"0",ENCODE_OUTPUT:"1"},uniforms:{inputBuffer:new ge(null),depthBuffer:new ge(null),resolution:new ge(new pe),texelSize:new ge(new pe),cameraNear:new ge(.3),cameraFar:new ge(1e3),aspect:new ge(1),time:new ge(0)},blending:kt,toneMapped:!1,depthWrite:!1,depthTest:!1,dithering:s}),i&&this.setShaderParts(i),e&&this.setDefines(e),t&&this.setUniforms(t),this.copyCameraSettings(n)}set inputBuffer(i){this.uniforms.inputBuffer.value=i}setInputBuffer(i){this.uniforms.inputBuffer.value=i}get depthBuffer(){return this.uniforms.depthBuffer.value}set depthBuffer(i){this.uniforms.depthBuffer.value=i}get depthPacking(){return Number(this.defines.DEPTH_PACKING)}set depthPacking(i){this.defines.DEPTH_PACKING=i.toFixed(0),this.needsUpdate=!0}setDepthBuffer(i,e=Fi){this.depthBuffer=i,this.depthPacking=e}setShaderData(i){this.setShaderParts(i.shaderParts),this.setDefines(i.defines),this.setUniforms(i.uniforms),this.setExtensions(i.extensions)}setShaderParts(i){return this.fragmentShader=yy.replace(Ye.FRAGMENT_HEAD,i.get(Ye.FRAGMENT_HEAD)||"").replace(Ye.FRAGMENT_MAIN_UV,i.get(Ye.FRAGMENT_MAIN_UV)||"").replace(Ye.FRAGMENT_MAIN_IMAGE,i.get(Ye.FRAGMENT_MAIN_IMAGE)||""),this.vertexShader=Sy.replace(Ye.VERTEX_HEAD,i.get(Ye.VERTEX_HEAD)||"").replace(Ye.VERTEX_MAIN_SUPPORT,i.get(Ye.VERTEX_MAIN_SUPPORT)||""),this.fragmentShader=$r(this.fragmentShader),this.needsUpdate=!0,this}setDefines(i){for(const e of i.entries())this.defines[e[0]]=e[1];return this.needsUpdate=!0,this}setUniforms(i){for(const e of i.entries())this.uniforms[e[0]]=e[1];return this}setExtensions(i){this.extensions={};for(const e of i)this.extensions[e]=!0;return this}get encodeOutput(){return this.defines.ENCODE_OUTPUT!==void 0}set encodeOutput(i){this.encodeOutput!==i&&(i?this.defines.ENCODE_OUTPUT="1":delete this.defines.ENCODE_OUTPUT,this.needsUpdate=!0)}isOutputEncodingEnabled(i){return this.encodeOutput}setOutputEncodingEnabled(i){this.encodeOutput=i}get time(){return this.uniforms.time.value}set time(i){this.uniforms.time.value=i}setDeltaTime(i){this.uniforms.time.value+=i}adoptCameraSettings(i){this.copyCameraSettings(i)}copyCameraSettings(i){i&&(this.uniforms.cameraNear.value=i.near,this.uniforms.cameraFar.value=i.far,i instanceof Bt?this.defines.PERSPECTIVE_CAMERA="1":delete this.defines.PERSPECTIVE_CAMERA,this.needsUpdate=!0)}setSize(i,e){const t=this.uniforms;t.resolution.value.set(i,e),t.texelSize.value.set(1/i,1/e),t.aspect.value=i/e}static get Section(){return Ye}},Ey=`#include <common>
#include <dithering_pars_fragment>
#ifdef FRAMEBUFFER_PRECISION_HIGH
uniform mediump sampler2D inputBuffer;
#else
...
gl_FragColor=vec4(l);
#endif
}`,by=class extends ot{constructor(i=!1,e=null){super({name:"LuminanceMaterial",defines:{THREE_REVISION:cr.replace(/\D+/g,"")},uniforms:{inputBuffer:new ge(null),threshold:new ge(0),smoothing:new ge(1),range:new ge(null)},blending:kt,toneMapped:!1,depthWrite:!1,depthTest:!1,fragmentShader:Ay,vertexShader:Kr}),this.colorOutput=i,this.luminanceRange=e}set inputBuffer(i){this.uniforms.inputBuffer.value=i}setInputBuffer(i){this.uniforms.inputBuffer.value=i}get threshold(){return this.uniforms.threshold.value}set threshold(i){this.smoothing>0||i>0?this.defines.THRESHOLD="1":delete this.defines.THRESHOLD,this.uniforms.threshold.value=i}getThreshold(){return this.threshold}setThreshold(i){this.threshold=i}get smoothing(){return this.uniforms.smoothing.value}set smoothing(i){this.threshold>0||i>0?this.defines.THRESHOLD="1":delete this.defines.THRESHOLD,this.uniforms.smoothing.value=i}getSmoothingFactor(){return this.smoothing}setSmoothingFactor(i){this.smoothing=i}get useThreshold(){return this.threshold>0||this.smoothing>0}set useThreshold(i){}get colorOutput(){return this.defines.COLOR!==void 0}set colorOutput(i){i?this.defines.COLOR="1":delete this.defines.COLOR,this.needsUpdate=!0}isColorOutputEnabled(i){return this.colorOutput}setColorOutputEnabled(i){this.colorOutput=i}get useRange(){return this.luminanceRange!==null}set useRange(i){this.luminanceRange=null}get luminanceRange(){return this.uniforms.range.value}set luminanceRange(i){i!==null?this.defines.RANGE="1":delete this.defines.RANGE,this.uniforms.range.value=i,this.needsUpdate=!0}getLuminanceRange(){return this.luminanceRange}setLuminanceRange(i){this.luminanceRange=i}},wy=`#ifdef FRAMEBUFFER_PRECISION_HIGH
...
#include <colorspace_fragment>
}`,Ry="uniform vec2 texelSize;varying vec2 vUv;varying vec2 vUv0;varying vec2 vUv1;varying vec2 vUv2;varying vec2 vUv3;varying vec2 vUv4;varying vec2 vUv5;varying vec2 vUv6;varying vec2 vUv7;void main(){vUv=position.xy*0.5+0.5;vUv0=vUv+texelSize*vec2(-1.0,1.0);vUv1=vUv+texelSize*vec2(0.0,1.0);vUv2=vUv+texelSize*vec2(1.0,1.0);vUv3=vUv+texelSize*vec2(-1.0,0.0);vUv4=vUv+texelSize*vec2(1.0,0.0);vUv5=vUv+texelSize*vec2(-1.0,-1.0);vUv6=vUv+texelSize*vec2(0.0,-1.0);vUv7=vUv+texelSize*vec2(1.0,-1.0);gl_Position=vec4(position.xy,1.0,1.0);}",Cy=class extends ot{constructor(){super({name:"UpsamplingMaterial",uniforms:{inputBuffer:new ge(null),supportBuffer:new ge(null),texelSize:new ge(new pe),radius:new ge(.85)},blending:kt,toneMapped:!1,depthWrite:!1,depthTest:!1,fragmentShader:wy,vertexShader:Ry}),this.fragmentShader=$r(this.fragmentShader)}set inputBuffer(i){this.uniforms.inputBuffer.value=i}set supportBuffer(i){this.uniforms.supportBuffer.value=i}get radius(){return this.uniforms.radius.value}set radius(i){this.uniforms.radius.value=i}setSize(i,e){this.uniforms.texelSize.value.set(1/i,1/e)}},Py=new zl,Mi=null;function Ly(){if(Mi===null){const i=new Float32Array([-1,-1,0,3,-1,0,-1,3,0]),e=new Float32Array([0,0,2,0,0,2]);Mi=new An,Mi.setAttribute!==void 0?(Mi.setAttribute("position",new Tt(i,3)),Mi.setAttribute("uv",new Tt(e,2))):(Mi.addAttribute("position",new Tt(i,3)),Mi.addAttribute("uv",new Tt(e,2)))}return Mi}var bn=class kd{constructor(e="Pass",t=new ka,n=Py){this.name=e,this.renderer=null,this.scene=t,this.camera=n,this.screen=null,this.rtt=!0,this.needsSwap=!0,this.needsDepthTexture=!1,this.enabled=!0}get renderToScreen(){return!this.rtt}set renderToScreen(e){if(this.rtt===e){const t=this.fullscreenMaterial;t!==null&&(t.needsUpdate=!0),this.rtt=!e}}set mainScene(e){}set mainCamera(e){}setRenderer(e){this.renderer=e}isEnabled(){return this.enabled}setEnabled(e){this.enabled=e}get fullscreenMaterial(){return this.screen!==null?this.screen.material:null}set fullscreenMaterial(e){let t=this.screen;t!==null?t.material=e:(t=new dt(Ly(),e),t.frustumCulled=!1,this.scene===null&&(this.scene=new ka),this.scene.add(t),this.screen=t)}getFullscreenMaterial(){return this.fullscreenMaterial}setFullscreenMaterial(e){this.fullscreenMaterial=e}getDepthTexture(){return null}setDepthTexture(e,t=Fi){}render(e,t,n,s,r){throw new Error("Render method not implemented!")}setSize(e,t){}initialize(e,t,n){}dispose(){for(const e of Object.keys(this)){const t=this[e];(t instanceof At||t instanceof Mn||t instanceof St||t instanceof kd)&&this[e].dispose()}}},Hd=class extends bn{constructor(i,e=!0){super("CopyPass"),this.fullscreenMaterial=new zd,this.needsSwap=!1,this.renderTarget=i,i===void 0&&(this.renderTarget=new At(1,1,{minFilter:Lt,magFilter:Lt,stencilBuffer:!1,depthBuffer:!1}),this.renderTarget.texture.name="CopyPass.Target"),this.autoResize=e}get resize(){return this.autoResize}set resize(i){this.autoResize=i}get texture(){return this.renderTarget.texture}getTexture(){return this.renderTarget.texture}setAutoResizeEnabled(i){this.autoResize=i}render(i,e,t,n,s){this.fullscreenMaterial.inputBuffer=e.texture,i.setRenderTarget(this.renderToScreen?null:this.renderTarget),i.render(this.scene,this.camera)}setSize(i,e){this.autoResize&&this.renderTarget.setSize(i,e)}initialize(i,e,t){t!==void 0&&(this.renderTarget.texture.type=t,t!==Wt?this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH="1":fs(i)===ht&&In(this.renderTarget.texture,ht))}},Dy=class extends bn{constructor(i,{minLuminance:e=.01,adaptationRate:t=1}={}){super("AdaptiveLuminancePass"),this.fullscreenMaterial=new oy,this.needsSwap=!1,this.renderTargetPrevious=new At(1,1,{minFilter:ct,magFilter:ct,depthBuffer:!1}),this.renderTargetPrevious.texture.name="Luminance.Previous";const n=this.fullscreenMaterial;n.luminanceBuffer0=this.renderTargetPrevious.texture,n.luminanceBuffer1=i,n.minLuminance=e,n.adaptationRate=t,this.renderTargetAdapted=this.renderTargetPrevious.clone(),this.renderTargetAdapted.texture.name="Luminance.Adapted",this.copyPass=new Hd(this.renderTargetPrevious,!1)}get texture(){return this.renderTargetAdapted.texture}getTexture(){return this.renderTargetAdapted.texture}set mipLevel1x1(i){this.fullscreenMaterial.mipLevel1x1=i}get adaptationRate(){return this.fullscreenMaterial.adaptationRate}set adaptationRate(i){this.fullscreenMaterial.adaptationRate=i}render(i,e,t,n,s){this.fullscreenMaterial.deltaTime=n,i.setRenderTarget(this.renderToScreen?null:this.renderTargetAdapted),i.render(this.scene,this.camera),this.copyPass.render(i,this.renderTargetAdapted)}},Iy=class extends bn{constructor(){super("ClearMaskPass",null,null),this.needsSwap=!1}render(i,e,t,n,s){const r=i.state.buffers.stencil;r.setLocked(!1),r.setTest(!1)}},gh=new ve,ec=class extends bn{constructor(i=!0,e=!0,t=!1){super("ClearPass",null,null),this.needsSwap=!1,this.color=i,this.depth=e,this.stencil=t,this.overrideClearColor=null,this.overrideClearAlpha=-1}setClearFlags(i,e,t){this.color=i,this.depth=e,this.stencil=t}getOverrideClearColor(){return this.overrideClearColor}setOverrideClearColor(i){this.overrideClearColor=i}getOverrideClearAlpha(){return this.overrideClearAlpha}setOverrideClearAlpha(i){this.overrideClearAlpha=i}render(i,e,t,n,s){const r=this.overrideClearColor,a=this.overrideClearAlpha,o=i.getClearAlpha(),l=r!==null,c=a>=0;l?(i.getClearColor(gh),i.setClearColor(r,c?a:o)):c&&i.setClearAlpha(a),i.setRenderTarget(this.renderToScreen?null:e),i.clear(this.color,this.depth,this.stencil),l?i.setClearColor(gh,o):c&&i.setClearAlpha(o)}},Vd=class extends bn{constructor(i,e,t=null){super("RenderPass",i,e),this.needsSwap=!1,this.clearPass=new ec,this.overrideMaterialManager=t===null?null:new xh(t),this.ignoreBackground=!1,this.skipShadowMapUpdate=!1,this.selection=null}set mainScene(i){this.scene=i}set mainCamera(i){this.camera=i}get renderToScreen(){return super.renderToScreen}set renderToScreen(i){super.renderToScreen=i,this.clearPass.renderToScreen=i}get overrideMaterial(){const i=this.overrideMaterialManager;return i!==null?i.material:null}set overrideMaterial(i){const e=this.overrideMaterialManager;i!==null?e!==null?e.setMaterial(i):this.overrideMaterialManager=new xh(i):e!==null&&(e.dispose(),this.overrideMaterialManager=null)}getOverrideMaterial(){return this.overrideMaterial}setOverrideMaterial(i){this.overrideMaterial=i}get clear(){return this.clearPass.enabled}set clear(i){this.clearPass.enabled=i}getSelection(){return this.selection}setSelection(i){this.selection=i}isBackgroundDisabled(){return this.ignoreBackground}setBackgroundDisabled(i){this.ignoreBackground=i}isShadowMapDisabled(){return this.skipShadowMapUpdate}setShadowMapDisabled(i){this.skipShadowMapUpdate=i}getClearPass(){return this.clearPass}render(i,e,t,n,s){const r=this.scene,a=this.camera,o=this.selection,l=a.layers.mask,c=r.background,u=i.shadowMap.autoUpdate,h=this.renderToScreen?null:e;o!==null&&a.layers.set(o.getLayer()),this.skipShadowMapUpdate&&(i.shadowMap.autoUpdate=!1),(this.ignoreBackground||this.clearPass.overrideClearColor!==null)&&(r.background=null),this.clearPass.enabled&&this.clearPass.render(i,e),i.setRenderTarget(h),this.overrideMaterialManager!==null?this.overrideMaterialManager.render(i,r,a):i.render(r,a),a.layers.mask=l,r.background=c,i.shadowMap.autoUpdate=u}};function _h(i,e,t){for(const n of e){const s="$1"+i+n.charAt(0).toUpperCase()+n.slice(1),r=new RegExp("([^\\.])(\\b"+n+"\\b)","g");for(const a of t.entries())a[1]!==null&&t.set(a[0],a[1].replace(r,s))}}function Uy(i,e,t){let n=e.getFragmentShader(),s=e.getVertexShader();const r=n!==void 0&&/mainImage/.test(n),a=n!==void 0&&/mainUv/.test(n);if(t.attributes|=e.getAttributes(),n===void 0)throw new Error(`Missing fragment shader (${e.name})`);if(a&&t.attributes&Ii.CONVOLUTION)throw new Error(`Effects that transform UVs are incompatible with convolution effects (${e.name})`);if(!r&&!a)throw new Error(`Could not find mainImage or mainUv function (${e.name})`);{const o=/\w+\s+(\w+)\([\w\s,]*\)\s*{/g,l=t.shaderParts;let c=l.get(Ye.FRAGMENT_HEAD)||"",u=l.get(Ye.FRAGMENT_MAIN_UV)||"",h=l.get(Ye.FRAGMENT_MAIN_IMAGE)||"",d=l.get(Ye.VERTEX_HEAD)||"",p=l.get(Ye.VERTEX_MAIN_SUPPORT)||"";const _=new Set,g=new Set;if(a&&(u+=`	${i}MainUv(UV);
`,t.uvTransformation=!0),s!==null&&/mainSupport/.test(s)){const y=/mainSupport *\([\w\s]*?uv\s*?\)/.test(s);p+=`	${i}MainSupport(`,p+=y?`vUv);
`:`);
`;for(const v of s.matchAll(/(?:varying\s+\w+\s+([\S\s]*?);)/g))for(const S of v[1].split(/\s*,\s*/))t.varyings.add(S),_.add(S),g.add(S);for(const v of s.matchAll(o))g.add(v[1])}for(const y of n.matchAll(o))g.add(y[1]);for(const y of e.defines.keys())g.add(y.replace(/\([\w\s,]*\)/g,""));for(const y of e.uniforms.keys())g.add(y);g.delete("while"),g.delete("for"),g.delete("if"),e.uniforms.forEach((y,v)=>t.uniforms.set(i+v.charAt(0).toUpperCase()+v.slice(1),y)),e.defines.forEach((y,v)=>t.defines.set(i+v.charAt(0).toUpperCase()+v.slice(1),y));const m=new Map([["fragment",n],["vertex",s]]);_h(i,g,t.defines),_h(i,g,m),n=m.get("fragment"),s=m.get("vertex");const f=e.blendMode;if(t.blendModes.set(f.blendFunction,f),r){e.inputColorSpace!==null&&e.inputColorSpace!==t.colorSpace&&(h+=e.inputColorSpace===ht?`color0 = LinearTosRGB(color0);
...
`}if(c+=n+`
`,s!==null&&(d+=s+`
`),l.set(Ye.FRAGMENT_HEAD,c),l.set(Ye.FRAGMENT_MAIN_UV,u),l.set(Ye.FRAGMENT_MAIN_IMAGE,h),l.set(Ye.VERTEX_HEAD,d),l.set(Ye.VERTEX_MAIN_SUPPORT,p),e.extensions!==null)for(const y of e.extensions)t.extensions.add(y)}}var Mr=class extends bn{constructor(i,...e){super("EffectPass"),this.fullscreenMaterial=new My(null,null,null,i),this.listener=t=>this.handleEvent(t),this.effects=[],this.setEffects(e),this.skipRendering=!1,this.minTime=1,this.maxTime=Number.POSITIVE_INFINITY,this.timeScale=1}set mainScene(i){for(const e of this.effects)e.mainScene=i}set mainCamera(i){this.fullscreenMaterial.copyCameraSettings(i);for(const e of this.effects)e.mainCamera=i}get encodeOutput(){return this.fullscreenMaterial.encodeOutput}set encodeOutput(i){this.fullscreenMaterial.encodeOutput=i}get dithering(){return this.fullscreenMaterial.dithering}set dithering(i){const e=this.fullscreenMaterial;e.dithering=i,e.needsUpdate=!0}setEffects(i){for(const e of this.effects)e.removeEventListener("change",this.listener);this.effects=i.sort((e,t)=>t.attributes-e.attributes);for(const e of this.effects)e.addEventListener("change",this.listener)}updateMaterial(){const i=new ky;let e=0;for(const a of this.effects)if(a.blendMode.blendFunction===Oe.DST)i.attributes|=a.getAttributes()&Ii.DEPTH;else{if(i.attributes&a.getAttributes()&Ii.CONVOLUTION)throw new Error(`Convolution effects cannot be merged (${a.name})`);Uy("e"+e++,a,i)}let t=i.shaderParts.get(Ye.FRAGMENT_HEAD),n=i.shaderParts.get(Ye.FRAGMENT_MAIN_IMAGE),s=i.shaderParts.get(Ye.FRAGMENT_MAIN_UV);const r=/\bblend\b/g;for(const a of i.blendModes.values())t+=a.getShaderCode().replace(r,`blend${a.blendFunction}`)+`
...
}`;class RS extends Zr{constructor(){super("ColorCorrectionEffect",wS,{blendFunction:Oe.ADD,uniforms:new Map([["powRGB",new ge(new L(3,3,4))],["mulRGB",new ge(new L(2,2,5))],["addRGB",new ge(new L(.05,.05,.25))]])})}}var CS=`uniform float uTime;                
...
/*    else if (uEnabled == 0.3) { 
        ...
        vec4 color = texture2D(inputBuffer, vec2(x, y));\r
        outputColor = vec4(color.rgb * (1.0 - curPos), 1.0);\r
    }*/`;class PS extends Zr{constructor(){super("MirrorModeEffect",CS,{blendFunction:Oe.ALPHA,uniforms:new Map([["uStartTime",new ge(0)],["uEndTime",new ge(0)],["uTime",new ge(0)],["uTimeAnimationIn",new ge(0)],["uTimeAnimationOut",new ge(0)],["uDisplacement",new ge(0)],["uSize",new ge(new pe(0,0))]])})}init(e,t,n,s,r,a,o){this.uniforms.get("uStartTime").value=e,this.uniforms.get("uEndTime").value=t,this.uniforms.get("uTimeAnimationIn").value=r,this.uniforms.get("uTimeAnimationOut").value=a,this.uniforms.get("uDisplacement").value=o,this.uniforms.get("uSize").value=new pe(n,s)}}class LS{constructor(){this.experience=new gt,this.canvas=this.experience.canvas,this.sizes=this.experience.sizes,this.scene=this.experience.scene,this.camera=this.experience.camera,this.time=this.experience.time,this.world=this.experience.world,this.setInstance()}setInstance(){this.instance=new wd({canvas:this.canvas,powerPreference:"high-performance",antialias:!1,stencil:!1,depth:!1}),this.instance.outputColorSpace=Te,this.instance.toneMapping=hi,this.instance.setSize(this.sizes.width,this.sizes.height),this.instance.setPixelRatio(this.sizes.pixelRatio),this.effectComposer=new zy(this.instance,{frameBufferType:Zs}),this.effectComposer.addPass(new Vd(this.scene,this.camera.instance)),this.mirrorModeEffect=new PS,this.mirrorModePass=new Mr(this.camera.instance,this.mirrorModeEffect),this.effectComposer.addPass(this.mirrorModePass),this.bloomEffect=new MS({mipmapBlur:!0,levels:5}),this.bloomEffect.intensity=this.experience.options.bloomPmndrsIntensity,this.bloomEffect.luminanceMaterial.uniforms.threshold.value=this.experience.options.bloomPmndrsThreshold,this.bloomEffect.luminanceMaterial.uniforms.smoothing.value=this.experience.options.bloomPmndrsSmoothing,this.bloomEffect.mipmapBlurPass.radius=this.experience.options.bloomPmndrsRadius,this.bloomPass=new Mr(this.camera.instance,this.bloomEffect),this.effectComposer.addPass(this.bloomPass),this.colorCorrectionEffect=new RS,this.colorCorrectionEffect.uniforms.get("powRGB").value=this.experience.options.colorCorrectionPowRGB,this.colorCorrectionEffect.uniforms.get("mulRGB").value=this.experience.options.colorCorrectionMulRGB,this.colorCorrectionEffect.uniforms.get("addRGB").value=this.experience.options.colorCorrectionAddRGB,this.colorCorrectionPass=new Mr(this.camera.instance,this.colorCorrectionEffect),this.effectComposer.addPass(this.colorCorrectionPass),this.toneMappingEffect=new bS,this.toneMappingEffect.mode=Nn.OPTIMIZED_CINEON,this.toneMappingEffect.exposure=1.75,this.toneMappingPass=new Mr(this.camera.instance,this.toneMappingEffect),this.effectComposer.addPass(this.toneMappingPass),this.experience.options.audioMultiChannel===!1&&(this.updateGodRays=()=>{})}setGodRays(e){this.godRaysEffect=new TS(this.camera.instance,e),this.godRaysPass=new Mr(this.camera.instance,this.godRaysEffect),this.effectComposer.addPass(this.godRaysPass,1),this.godRaysEffect.godRaysMaterial.density=this.experience.options.godRaysDensity,this.godRaysEffect.godRaysMaterial.decay=this.experience.options.godRaysDecay,this.godRaysEffect.godRaysMaterial.weight=this.experience.options.godRaysWeigth,this.godRaysEffect.godRaysMaterial.exposure=this.experience.options.godRaysExposure,this.godRaysEffect.godRaysMaterial.clampMax=this.experience.options.godRaysClampMax,this.godRaysEffect.godRaysMaterial.samples=this.experience.options.godRaysSamples,this.updateGodRays=this.experience.options.audioMultiChannel?this.updateGodRaysMC:this.updateGodRaysSC,this.update=this.updateQuality}resize(){this.instance.setSize(this.sizes.width,this.sizes.height),this.instance.setPixelRatio(this.sizes.pixelRatio),this.effectComposer.setSize(this.sizes.width,this.sizes.height)}update(){this.effectComposer.render()}updateQuality(){this.mirrorModeEffect.uniforms.get("uTime").value=this.experience.audioAnalizer.channelSong.song.currentTime,this.effectComposer.render(),this.updateGodRays()}updateGodRaysMC(){const e=this.world.songChannels.SunRays.averageFrequency[1]*.75;this.godRaysEffect.godRaysMaterial.weight=.3+e,this.godRaysEffect.godRaysMaterial.density=.96+e}updateGodRaysSC(){const e=this.world.songChannels.SunRays.averageFrequency[1]*.35;this.godRaysEffect.godRaysMaterial.weight=.3+e,this.godRaysEffect.godRaysMaterial.density=.96+e}}function Sh(i,e){if(e===Up)return console.warn("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Geometry already defined as triangles."),i;if(e===dl||e===ld){let t=i.getIndex();if(t===null){const a=[],o=i.getAttribute("position");if(o!==void 0){for(let l=0;l<o.count;l++)a.push(l);i.setIndex(a),t=i.getIndex()}else return console.error("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Undefined position attribute. Processing not possible."),i}const n=t.count-2,s=[];if(e===dl)for(let a=1;a<=n;a++)s.push(t.getX(0)),s.push(t.getX(a)),s.push(t.getX(a+1));else for(let a=0;a<n;a++)a%2===0?(s.push(t.getX(a)),s.push(t.getX(a+1)),s.push(t.getX(a+2))):(s.push(t.getX(a+2)),s.push(t.getX(a+1)),s.push(t.getX(a)));s.length/3!==n&&console.error("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unable to generate correct amount of triangles.");const r=i.clone();return r.setIndex(s),r.clearGroups(),r}else return console.error("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unknown draw mode:",e),i}class DS extends fr{constructor(e){super(e),this.dracoLoader=null,this.ktx2Loader=null,this.meshoptDecoder=null,this.pluginCallbacks=[],this.register(function(t){return new FS(t)}),this.register(function(t){return new XS(t)}),this.register(function(t){return new qS(t)}),this.register(function(t){return new YS(t)}),this.register(function(t){return new zS(t)}),this.register(function(t){return new kS(t)}),this.register(function(t){return new HS(t)}),this.register(function(t){return new VS(t)}),this.register(function(t){return new NS(t)}),this.register(function(t){return new GS(t)}),this.register(function(t){return new BS(t)}),this.register(function(t){return new WS(t)}),this.register(function(t){return new US(t)}),this.register(function(t){return new jS(t)}),this.register(function(t){return new KS(t)})}load(e,t,n,s){const r=this;let a;this.resourcePath!==""?a=this.resourcePath:this.path!==""?a=this.path:a=vl.extractUrlBase(e),this.manager.itemStart(e);const o=function(c){s?s(c):console.error(c),r.manager.itemError(e),r.manager.itemEnd(e)},l=new Ud(this.manager);l.setPath(this.path),l.setResponseType("arraybuffer"),l.setRequestHeader(this.requestHeader),l.setWithCredentials(this.withCredentials),l.load(e,function(c){try{r.parse(c,a,function(u){t(u),r.manager.itemEnd(e)},o)}catch(u){o(u)}},n,o)}setDRACOLoader(e){return this.dracoLoader=e,this}setDDSLoader(){throw new Error('THREE.GLTFLoader: "MSFT_texture_dds" no longer supported. Please update to "KHR_texture_basisu".')}setKTX2Loader(e){return this.ktx2Loader=e,this}setMeshoptDecoder(e){return this.meshoptDecoder=e,this}register(e){return this.pluginCallbacks.indexOf(e)===-1&&this.pluginCallbacks.push(e),this}unregister(e){return this.pluginCallbacks.indexOf(e)!==-1&&this.pluginCallbacks.splice(this.pluginCallbacks.indexOf(e),1),this}parse(e,t,n,s){let r;const a={},o={},l=new TextDecoder;if(typeof e=="string")r=JSON.parse(e);else if(e instanceof ArrayBuffer)if(l.decode(new Uint8Array(e,0,4))===Xd){try{a[Ge.KHR_BINARY_GLTF]=new $S(e)}catch(h){s&&s(h);return}r=JSON.parse(a[Ge.KHR_BINARY_GLTF].content)}else r=JSON.parse(l.decode(e));else r=e;if(r.asset===void 0||r.asset.version[0]<2){s&&s(new Error("THREE.GLTFLoader: Unsupported asset. glTF versions >=2.0 are supported."));return}const c=new cM(r,{path:t||this.resourcePath||"",crossOrigin:this.crossOrigin,requestHeader:this.requestHeader,manager:this.manager,ktx2Loader:this.ktx2Loader,meshoptDecoder:this.meshoptDecoder});c.fileLoader.setRequestHeader(this.requestHeader);for(let u=0;u<this.pluginCallbacks.length;u++){const h=this.pluginCallbacks[u](c);o[h.name]=h,a[h.name]=!0}if(r.extensionsUsed)for(let u=0;u<r.extensionsUsed.length;++u){const h=r.extensionsUsed[u],d=r.extensionsRequired||[];switch(h){case Ge.KHR_MATERIALS_UNLIT:a[h]=new OS;break;case Ge.KHR_DRACO_MESH_COMPRESSION:a[h]=new ZS(r,this.dracoLoader);break;case Ge.KHR_TEXTURE_TRANSFORM:a[h]=new JS;break;case Ge.KHR_MESH_QUANTIZATION:a[h]=new QS;break;default:d.indexOf(h)>=0&&o[h]===void 0&&console.warn('THREE.GLTFLoader: Unknown extension "'+h+'".')}}c.setExtensions(a),c.setPlugins(o),c.parse(n,s)}parseAsync(e,t){const n=this;return new Promise(function(s,r){n.parse(e,t,s,r)})}}function IS(){let i={};return{get:function(e){return i[e]},add:function(e,t){i[e]=t},remove:function(e){delete i[e]},removeAll:function(){i={}}}}const Ge={KHR_BINARY_GLTF:"KHR_binary_glTF",KHR_DRACO_MESH_COMPRESSION:"KHR_draco_mesh_compression",KHR_LIGHTS_PUNCTUAL:"KHR_lights_punctual",KHR_MATERIALS_CLEARCOAT:"KHR_materials_clearcoat",KHR_MATERIALS_IOR:"KHR_materials_ior",KHR_MATERIALS_SHEEN:"KHR_materials_sheen",KHR_MATERIALS_SPECULAR:"KHR_materials_specular",KHR_MATERIALS_TRANSMISSION:"KHR_materials_transmission",KHR_MATERIALS_IRIDESCENCE:"KHR_materials_iridescence",KHR_MATERIALS_ANISOTROPY:"KHR_materials_anisotropy",KHR_MATERIALS_UNLIT:"KHR_materials_unlit",KHR_MATERIALS_VOLUME:"KHR_materials_volume",KHR_TEXTURE_BASISU:"KHR_texture_basisu",KHR_TEXTURE_TRANSFORM:"KHR_texture_transform",KHR_MESH_QUANTIZATION:"KHR_mesh_quantization",KHR_MATERIALS_EMISSIVE_STRENGTH:"KHR_materials_emissive_strength",EXT_TEXTURE_WEBP:"EXT_texture_webp",EXT_TEXTURE_AVIF:"EXT_texture_avif",EXT_MESHOPT_COMPRESSION:"EXT_meshopt_compression",EXT_MESH_GPU_INSTANCING:"EXT_mesh_gpu_instancing"};class US{constructor(e){this.parser=e,this.name=Ge.KHR_LIGHTS_PUNCTUAL,this.cache={refs:{},uses:{}}}_markDefs(){const e=this.parser,t=this.parser.json.nodes||[];for(let n=0,s=t.length;n<s;n++){const r=t[n];r.extensions&&r.extensions[this.name]&&r.extensions[this.name].light!==void 0&&e._addNodeRef(this.cache,r.extensions[this.name].light)}}_loadLight(e){const t=this.parser,n="light:"+e;let s=t.cache.get(n);if(s)return s;const r=t.json,l=((r.extensions&&r.extensions[this.name]||{}).lights||[])[e];let c;const u=new ve(16777215);l.color!==void 0&&u.fromArray(l.color);const h=l.range!==void 0?l.range:0;switch(l.type){case"directional":c=new zx(u),c.target.position.set(0,0,-1),c.add(c.target);break;case"point":c=new Fx(u),c.distance=h;break;case"spot":c=new Ox(u),c.distance=h,l.spot=l.spot||{},l.spot.innerConeAngle=l.spot.innerConeAngle!==void 0?l.spot.innerConeAngle:0,l.spot.outerConeAngle=l.spot.outerConeAngle!==void 0?l.spot.outerConeAngle:Math.PI/4,c.angle=l.spot.outerConeAngle,c.penumbra=1-l.spot.innerConeAngle/l.spot.outerConeAngle,c.target.position.set(0,0,-1),c.add(c.target);break;default:throw new Error("THREE.GLTFLoader: Unexpected light type: "+l.type)}return c.position.set(0,0,0),c.decay=2,wi(c,l),l.intensity!==void 0&&(c.intensity=l.intensity),c.name=t.createUniqueName(l.name||"light_"+e),s=Promise.resolve(c),t.cache.add(n,s),s}getDependency(e,t){if(e==="light")return this._loadLight(t)}createNodeAttachment(e){const t=this,n=this.parser,r=n.json.nodes[e],o=(r.extensions&&r.extensions[this.name]||{}).light;return o===void 0?null:this._loadLight(o).then(function(l){return n._getNodeRef(t.cache,o,l)})}}class OS{constructor(){this.name=Ge.KHR_MATERIALS_UNLIT}getMaterialType(){return is}extendParams(e,t,n){const s=[];e.color=new ve(1,1,1),e.opacity=1;const r=t.pbrMetallicRoughness;if(r){if(Array.isArray(r.baseColorFactor)){const a=r.baseColorFactor;e.color.fromArray(a),e.opacity=a[3]}r.baseColorTexture!==void 0&&s.push(n.assignTexture(e,"map",r.baseColorTexture,Te))}return Promise.all(s)}}class NS{constructor(e){this.parser=e,this.name=Ge.KHR_MATERIALS_EMISSIVE_STRENGTH}extendMaterialParams(e,t){const s=this.parser.json.materials[e];if(!s.extensions||!s.extensions[this.name])return Promise.resolve();const r=s.extensions[this.name].emissiveStrength;return r!==void 0&&(t.emissiveIntensity=r),Promise.resolve()}}class FS{constructor(e){this.parser=e,this.name=Ge.KHR_MATERIALS_CLEARCOAT}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Hi}extendMaterialParams(e,t){const n=this.parser,s=n.json.materials[e];if(!s.extensions||!s.extensions[this.name])return Promise.resolve();const r=[],a=s.extensions[this.name];if(a.clearcoatFactor!==void 0&&(t.clearcoat=a.clearcoatFactor),a.clearcoatTexture!==void 0&&r.push(n.assignTexture(t,"clearcoatMap",a.clearcoatTexture)),a.clearcoatRoughnessFactor!==void 0&&(t.clearcoatRoughness=a.clearcoatRoughnessFactor),a.clearcoatRoughnessTexture!==void 0&&r.push(n.assignTexture(t,"clearcoatRoughnessMap",a.clearcoatRoughnessTexture)),a.clearcoatNormalTexture!==void 0&&(r.push(n.assignTexture(t,"clearcoatNormalMap",a.clearcoatNormalTexture)),a.clearcoatNormalTexture.scale!==void 0)){const o=a.clearcoatNormalTexture.scale;t.clearcoatNormalScale=new pe(o,o)}return Promise.all(r)}}class BS{constructor(e){this.parser=e,this.name=Ge.KHR_MATERIALS_IRIDESCENCE}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Hi}extendMaterialParams(e,t){const n=this.parser,s=n.json.materials[e];if(!s.extensions||!s.extensions[this.name])return Promise.resolve();const r=[],a=s.extensions[this.name];return a.iridescenceFactor!==void 0&&(t.iridescence=a.iridescenceFactor),a.iridescenceTexture!==void 0&&r.push(n.assignTexture(t,"iridescenceMap",a.iridescenceTexture)),a.iridescenceIor!==void 0&&(t.iridescenceIOR=a.iridescenceIor),t.iridescenceThicknessRange===void 0&&(t.iridescenceThicknessRange=[100,400]),a.iridescenceThicknessMinimum!==void 0&&(t.iridescenceThicknessRange[0]=a.iridescenceThicknessMinimum),a.iridescenceThicknessMaximum!==void 0&&(t.iridescenceThicknessRange[1]=a.iridescenceThicknessMaximum),a.iridescenceThicknessTexture!==void 0&&r.push(n.assignTexture(t,"iridescenceThicknessMap",a.iridescenceThicknessTexture)),Promise.all(r)}}class zS{constructor(e){this.parser=e,this.name=Ge.KHR_MATERIALS_SHEEN}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Hi}extendMaterialParams(e,t){const n=this.parser,s=n.json.materials[e];if(!s.extensions||!s.extensions[this.name])return Promise.resolve();const r=[];t.sheenColor=new ve(0,0,0),t.sheenRoughness=0,t.sheen=1;const a=s.extensions[this.name];return a.sheenColorFactor!==void 0&&t.sheenColor.fromArray(a.sheenColorFactor),a.sheenRoughnessFactor!==void 0&&(t.sheenRoughness=a.sheenRoughnessFactor),a.sheenColorTexture!==void 0&&r.push(n.assignTexture(t,"sheenColorMap",a.sheenColorTexture,Te)),a.sheenRoughnessTexture!==void 0&&r.push(n.assignTexture(t,"sheenRoughnessMap",a.sheenRoughnessTexture)),Promise.all(r)}}class kS{constructor(e){this.parser=e,this.name=Ge.KHR_MATERIALS_TRANSMISSION}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Hi}extendMaterialParams(e,t){const n=this.parser,s=n.json.materials[e];if(!s.extensions||!s.extensions[this.name])return Promise.resolve();const r=[],a=s.extensions[this.name];return a.transmissionFactor!==void 0&&(t.transmission=a.transmissionFactor),a.transmissionTexture!==void 0&&r.push(n.assignTexture(t,"transmissionMap",a.transmissionTexture)),Promise.all(r)}}class HS{constructor(e){this.parser=e,this.name=Ge.KHR_MATERIALS_VOLUME}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Hi}extendMaterialParams(e,t){const n=this.parser,s=n.json.materials[e];if(!s.extensions||!s.extensions[this.name])return Promise.resolve();const r=[],a=s.extensions[this.name];t.thickness=a.thicknessFactor!==void 0?a.thicknessFactor:0,a.thicknessTexture!==void 0&&r.push(n.assignTexture(t,"thicknessMap",a.thicknessTexture)),t.attenuationDistance=a.attenuationDistance||1/0;const o=a.attenuationColor||[1,1,1];return t.attenuationColor=new ve(o[0],o[1],o[2]),Promise.all(r)}}class VS{constructor(e){this.parser=e,this.name=Ge.KHR_MATERIALS_IOR}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Hi}extendMaterialParams(e,t){const s=this.parser.json.materials[e];if(!s.extensions||!s.extensions[this.name])return Promise.resolve();const r=s.extensions[this.name];return t.ior=r.ior!==void 0?r.ior:1.5,Promise.resolve()}}class GS{constructor(e){this.parser=e,this.name=Ge.KHR_MATERIALS_SPECULAR}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Hi}extendMaterialParams(e,t){const n=this.parser,s=n.json.materials[e];if(!s.extensions||!s.extensions[this.name])return Promise.resolve();const r=[],a=s.extensions[this.name];t.specularIntensity=a.specularFactor!==void 0?a.specularFactor:1,a.specularTexture!==void 0&&r.push(n.assignTexture(t,"specularIntensityMap",a.specularTexture));const o=a.specularColorFactor||[1,1,1];return t.specularColor=new ve(o[0],o[1],o[2]),a.specularColorTexture!==void 0&&r.push(n.assignTexture(t,"specularColorMap",a.specularColorTexture,Te)),Promise.all(r)}}class WS{constructor(e){this.parser=e,this.name=Ge.KHR_MATERIALS_ANISOTROPY}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Hi}extendMaterialParams(e,t){const n=this.parser,s=n.json.materials[e];if(!s.extensions||!s.extensions[this.name])return Promise.resolve();const r=[],a=s.extensions[this.name];return a.anisotropyStrength!==void 0&&(t.anisotropy=a.anisotropyStrength),a.anisotropyRotation!==void 0&&(t.anisotropyRotation=a.anisotropyRotation),a.anisotropyTexture!==void 0&&r.push(n.assignTexture(t,"anisotropyMap",a.anisotropyTexture)),Promise.all(r)}}class XS{constructor(e){this.parser=e,this.name=Ge.KHR_TEXTURE_BASISU}loadTexture(e){const t=this.parser,n=t.json,s=n.textures[e];if(!s.extensions||!s.extensions[this.name])return null;const r=s.extensions[this.name],a=t.options.ktx2Loader;if(!a){if(n.extensionsRequired&&n.extensionsRequired.indexOf(this.name)>=0)throw new Error("THREE.GLTFLoader: setKTX2Loader must be called before loading KTX2 textures");return null}return t.loadTextureImage(e,r.source,a)}}class qS{constructor(e){this.parser=e,this.name=Ge.EXT_TEXTURE_WEBP,this.isSupported=null}loadTexture(e){const t=this.name,n=this.parser,s=n.json,r=s.textures[e];if(!r.extensions||!r.extensions[t])return null;const a=r.extensions[t],o=s.images[a.source];let l=n.textureLoader;if(o.uri){const c=n.options.manager.getHandler(o.uri);c!==null&&(l=c)}return this.detectSupport().then(function(c){if(c)return n.loadTextureImage(e,a.source,l);if(s.extensionsRequired&&s.extensionsRequired.indexOf(t)>=0)throw new Error("THREE.GLTFLoader: WebP required by asset but unsupported.");return n.loadTexture(e)})}detectSupport(){return this.isSupported||(this.isSupported=new Promise(function(e){const t=new Image;t.src="data:image/webp;base64,UklGRiIAAABXRUJQVlA4IBYAAAAwAQCdASoBAAEADsD+JaQAA3AAAAAA",t.onload=t.onerror=function(){e(t.height===1)}})),this.isSupported}}class YS{constructor(e){this.parser=e,this.name=Ge.EXT_TEXTURE_AVIF,this.isSupported=null}loadTexture(e){const t=this.name,n=this.parser,s=n.json,r=s.textures[e];if(!r.extensions||!r.extensions[t])return null;const a=r.extensions[t],o=s.images[a.source];let l=n.textureLoader;if(o.uri){const c=n.options.manager.getHandler(o.uri);c!==null&&(l=c)}return this.detectSupport().then(function(c){if(c)return n.loadTextureImage(e,a.source,l);if(s.extensionsRequired&&s.extensionsRequired.indexOf(t)>=0)throw new Error("THREE.GLTFLoader: AVIF required by asset but unsupported.");return n.loadTexture(e)})}detectSupport(){return this.isSupported||(this.isSupported=new Promise(function(e){const t=new Image;t.src="data:image/avif;base64,",t.onload=t.onerror=function(){e(t.height===1)}})),this.isSupported}}class jS{constructor(e){this.name=Ge.EXT_MESHOPT_COMPRESSION,this.parser=e}loadBufferView(e){const t=this.parser.json,n=t.bufferViews[e];if(n.extensions&&n.extensions[this.name]){const s=n.extensions[this.name],r=this.parser.getDependency("buffer",s.buffer),a=this.parser.options.meshoptDecoder;if(!a||!a.supported){if(t.extensionsRequired&&t.extensionsRequired.indexOf(this.name)>=0)throw new Error("THREE.GLTFLoader: setMeshoptDecoder must be called before loading compressed files");return null}return r.then(function(o){const l=s.byteOffset||0,c=s.byteLength||0,u=s.count,h=s.byteStride,d=new Uint8Array(o,l,c);return a.decodeGltfBufferAsync?a.decodeGltfBufferAsync(u,h,d,s.mode,s.filter).then(function(p){return p.buffer}):a.ready.then(function(){const p=new ArrayBuffer(u*h);return a.decodeGltfBuffer(new Uint8Array(p),u,h,d,s.mode,s.filter),p})})}else return null}}class KS{constructor(e){this.name=Ge.EXT_MESH_GPU_INSTANCING,this.parser=e}createNodeMesh(e){const t=this.parser.json,n=t.nodes[e];if(!n.extensions||!n.extensions[this.name]||n.mesh===void 0)return null;const s=t.meshes[n.mesh];for(const c of s.primitives)if(c.mode!==mn.TRIANGLES&&c.mode!==mn.TRIANGLE_STRIP&&c.mode!==mn.TRIANGLE_FAN&&c.mode!==void 0)return null;const a=n.extensions[this.name].attributes,o=[],l={};for(const c in a)o.push(this.parser.getDependency("accessor",a[c]).then(u=>(l[c]=u,l[c])));return o.length<1?null:(o.push(this.parser.createNodeMesh(e)),Promise.all(o).then(c=>{const u=c.pop(),h=u.isGroup?u.children:[u],d=c[0].count,p=[];for(const _ of h){const g=new Ne,m=new L,f=new Xn,y=new L(1,1,1),v=new _x(_.geometry,_.material,d);for(let S=0;S<d;S++)l.TRANSLATION&&m.fromBufferAttribute(l.TRANSLATION,S),l.ROTATION&&f.fromBufferAttribute(l.ROTATION,S),l.SCALE&&y.fromBufferAttribute(l.SCALE,S),v.setMatrixAt(S,g.compose(m,f,y));for(const S in l)S!=="TRANSLATION"&&S!=="ROTATION"&&S!=="SCALE"&&_.geometry.setAttribute(S,l[S]);at.prototype.copy.call(v,_),this.parser.assignFinalMaterial(v),p.push(v)}return u.isGroup?(u.clear(),u.add(...p),u):p[0]}))}}const Xd="glTF",Er=12,Mh={JSON:1313821514,BIN:5130562};class $S{constructor(e){this.name=Ge.KHR_BINARY_GLTF,this.content=null,this.body=null;const t=new DataView(e,0,Er),n=new TextDecoder;if(this.header={magic:n.decode(new Uint8Array(e.slice(0,4))),version:t.getUint32(4,!0),length:t.getUint32(8,!0)},this.header.magic!==Xd)throw new Error("THREE.GLTFLoader: Unsupported glTF-Binary header.");if(this.header.version<2)throw new Error("THREE.GLTFLoader: Legacy binary file detected.");const s=this.header.length-Er,r=new DataView(e,Er);let a=0;for(;a<s;){const o=r.getUint32(a,!0);a+=4;const l=r.getUint32(a,!0);if(a+=4,l===Mh.JSON){const c=new Uint8Array(e,Er+a,o);this.content=n.decode(c)}else if(l===Mh.BIN){const c=Er+a;this.body=e.slice(c,c+o)}a+=o}if(this.content===null)throw new Error("THREE.GLTFLoader: JSON content not found.")}}class ZS{constructor(e,t){if(!t)throw new Error("THREE.GLTFLoader: No DRACOLoader instance provided.");this.name=Ge.KHR_DRACO_MESH_COMPRESSION,this.json=e,this.dracoLoader=t,this.dracoLoader.preload()}decodePrimitive(e,t){const n=this.json,s=this.dracoLoader,r=e.extensions[this.name].bufferView,a=e.extensions[this.name].attributes,o={},l={},c={};for(const u in a){const h=xl[u]||u.toLowerCase();o[h]=a[u]}for(const u in e.attributes){const h=xl[u]||u.toLowerCase();if(a[u]!==void 0){const d=n.accessors[e.attributes[u]],p=Ws[d.componentType];c[h]=p.name,l[h]=d.normalized===!0}}return t.getDependency("bufferView",r).then(function(u){return new Promise(function(h){s.decodeDracoFile(u,function(d){for(const p in d.attributes){const _=d.attributes[p],g=l[p];g!==void 0&&(_.normalized=g)}h(d)},o,c)})})}}class JS{constructor(){this.name=Ge.KHR_TEXTURE_TRANSFORM}extendTexture(e,t){return(t.texCoord===void 0||t.texCoord===e.channel)&&t.offset===void 0&&t.rotation===void 0&&t.scale===void 0||(e=e.clone(),t.texCoord!==void 0&&(e.channel=t.texCoord),t.offset!==void 0&&e.offset.fromArray(t.offset),t.rotation!==void 0&&(e.rotation=t.rotation),t.scale!==void 0&&e.repeat.fromArray(t.scale),e.needsUpdate=!0),e}}class QS{constructor(){this.name=Ge.KHR_MESH_QUANTIZATION}}class qd extends jr{constructor(e,t,n,s){super(e,t,n,s)}copySampleValue_(e){const t=this.resultBuffer,n=this.sampleValues,s=this.valueSize,r=e*s*3+s;for(let a=0;a!==s;a++)t[a]=n[r+a];return t}interpolate_(e,t,n,s){const r=this.resultBuffer,a=this.sampleValues,o=this.valueSize,l=o*2,c=o*3,u=s-t,h=(n-t)/u,d=h*h,p=d*h,_=e*c,g=_-c,m=-2*p+3*d,f=p-d,y=1-m,v=f-d+h;for(let S=0;S!==o;S++){const M=a[g+S+o],w=a[g+S+l]*u,T=a[_+S+o],C=a[_+S]*u;r[S]=y*M+v*w+m*T+f*C}return r}}const eM=new Xn;class tM extends qd{interpolate_(e,t,n,s){const r=super.interpolate_(e,t,n,s);return eM.fromArray(r).normalize().toArray(r),r}}const mn={FLOAT:5126,FLOAT_MAT3:35675,FLOAT_MAT4:35676,FLOAT_VEC2:35664,FLOAT_VEC3:35665,FLOAT_VEC4:35666,LINEAR:9729,REPEAT:10497,SAMPLER_2D:35678,POINTS:0,LINES:1,LINE_LOOP:2,LINE_STRIP:3,TRIANGLES:4,TRIANGLE_STRIP:5,TRIANGLE_FAN:6,UNSIGNED_BYTE:5121,UNSIGNED_SHORT:5123},Ws={5120:Int8Array,5121:Uint8Array,5122:Int16Array,5123:Uint16Array,5125:Uint32Array,5126:Float32Array},Eh={9728:ct,9729:Lt,9984:hl,9985:td,9986:Ca,9987:Ni},Th={33071:_n,33648:Na,10497:$s},jo={SCALAR:1,VEC2:2,VEC3:3,VEC4:4,MAT2:4,MAT3:9,MAT4:16},xl={POSITION:"position",NORMAL:"normal",TANGENT:"tangent",TEXCOORD_0:"uv",TEXCOORD_1:"uv1",TEXCOORD_2:"uv2",TEXCOORD_3:"uv3",COLOR_0:"color",WEIGHTS_0:"skinWeight",JOINTS_0:"skinIndex"},Ti={scale:"scale",translation:"position",rotation:"quaternion",weights:"morphTargetInfluences"},nM={CUBICSPLINE:void 0,LINEAR:Js,STEP:Nr},Ko={OPAQUE:"OPAQUE",MASK:"MASK",BLEND:"BLEND"};function iM(i){return i.DefaultMaterial===void 0&&(i.DefaultMaterial=new jl({color:16777215,emissive:0,metalness:1,roughness:1,transparent:!1,depthTest:!0,side:Gn})),i.DefaultMaterial}function Ki(i,e,t){for(const n in t.extensions)i[n]===void 0&&(e.userData.gltfExtensions=e.userData.gltfExtensions||{},e.userData.gltfExtensions[n]=t.extensions[n])}function wi(i,e){e.extras!==void 0&&(typeof e.extras=="object"?Object.assign(i.userData,e.extras):console.warn("THREE.GLTFLoader: Ignoring primitive type .extras, "+e.extras))}function sM(i,e,t){let n=!1,s=!1,r=!1;for(let c=0,u=e.length;c<u;c++){const h=e[c];if(h.POSITION!==void 0&&(n=!0),h.NORMAL!==void 0&&(s=!0),h.COLOR_0!==void 0&&(r=!0),n&&s&&r)break}if(!n&&!s&&!r)return Promise.resolve(i);const a=[],o=[],l=[];for(let c=0,u=e.length;c<u;c++){const h=e[c];if(n){const d=h.POSITION!==void 0?t.getDependency("accessor",h.POSITION):i.attributes.position;a.push(d)}if(s){const d=h.NORMAL!==void 0?t.getDependency("accessor",h.NORMAL):i.attributes.normal;o.push(d)}if(r){const d=h.COLOR_0!==void 0?t.getDependency("accessor",h.COLOR_0):i.attributes.color;l.push(d)}}return Promise.all([Promise.all(a),Promise.all(o),Promise.all(l)]).then(function(c){const u=c[0],h=c[1],d=c[2];return n&&(i.morphAttributes.position=u),s&&(i.morphAttributes.normal=h),r&&(i.morphAttributes.color=d),i.morphTargetsRelative=!0,i})}function rM(i,e){if(i.updateMorphTargets(),e.weights!==void 0)for(let t=0,n=e.weights.length;t<n;t++)i.morphTargetInfluences[t]=e.weights[t];if(e.extras&&Array.isArray(e.extras.targetNames)){const t=e.extras.targetNames;if(i.morphTargetInfluences.length===t.length){i.morphTargetDictionary={};for(let n=0,s=t.length;n<s;n++)i.morphTargetDictionary[t[n]]=n}else console.warn("THREE.GLTFLoader: Invalid extras.targetNames length. Ignoring names.")}}function aM(i){let e;const t=i.extensions&&i.extensions[Ge.KHR_DRACO_MESH_COMPRESSION];if(t?e="draco:"+t.bufferView+":"+t.indices+":"+$o(t.attributes):e=i.indices+":"+$o(i.attributes)+":"+i.mode,i.targets!==void 0)for(let n=0,s=i.targets.length;n<s;n++)e+=":"+$o(i.targets[n]);return e}function $o(i){let e="";const t=Object.keys(i).sort();for(let n=0,s=t.length;n<s;n++)e+=t[n]+":"+i[t[n]]+";";return e}function yl(i){switch(i){case Int8Array:return 1/127;case Uint8Array:return 1/255;case Int16Array:return 1/32767;case Uint16Array:return 1/65535;default:throw new Error("THREE.GLTFLoader: Unsupported normalized accessor component type.")}}function oM(i){return i.search(/\.jpe?g($|\?)/i)>0||i.search(/^data\:image\/jpeg/)===0?"image/jpeg":i.search(/\.webp($|\?)/i)>0||i.search(/^data\:image\/webp/)===0?"image/webp":"image/png"}const lM=new Ne;class cM{constructor(e={},t={}){this.json=e,this.extensions={},this.plugins={},this.options=t,this.cache=new IS,this.associations=new Map,this.primitiveCache={},this.nodeCache={},this.meshCache={refs:{},uses:{}},this.cameraCache={refs:{},uses:{}},this.lightCache={refs:{},uses:{}},this.sourceCache={},this.textureCache={},this.nodeNamesUsed={};let n=!1,s=!1,r=-1;typeof navigator<"u"&&(n=/^((?!chrome|android).)*safari/i.test(navigator.userAgent)===!0,s=navigator.userAgent.indexOf("Firefox")>-1,r=s?navigator.userAgent.match(/Firefox\/([0-9]+)\./)[1]:-1),typeof createImageBitmap>"u"||n||s&&r<98?this.textureLoader=new Od(this.options.manager):this.textureLoader=new kx(this.options.manager),this.textureLoader.setCrossOrigin(this.options.crossOrigin),this.textureLoader.setRequestHeader(this.options.requestHeader),this.fileLoader=new Ud(this.options.manager),this.fileLoader.setResponseType("arraybuffer"),this.options.crossOrigin==="use-credentials"&&this.fileLoader.setWithCredentials(!0)}setExtensions(e){this.extensions=e}setPlugins(e){this.plugins=e}parse(e,t){const n=this,s=this.json,r=this.extensions;this.cache.removeAll(),this.nodeCache={},this._invokeAll(function(a){return a._markDefs&&a._markDefs()}),Promise.all(this._invokeAll(function(a){return a.beforeRoot&&a.beforeRoot()})).then(function(){return Promise.all([n.getDependencies("scene"),n.getDependencies("animation"),n.getDependencies("camera")])}).then(function(a){const o={scene:a[0][s.scene||0],scenes:a[0],animations:a[1],cameras:a[2],asset:s.asset,parser:n,userData:{}};Ki(r,o,s),wi(o,s),Promise.all(n._invokeAll(function(l){return l.afterRoot&&l.afterRoot(o)})).then(function(){e(o)})}).catch(t)}_markDefs(){const e=this.json.nodes||[],t=this.json.skins||[],n=this.json.meshes||[];for(let s=0,r=t.length;s<r;s++){const a=t[s].joints;for(let o=0,l=a.length;o<l;o++)e[a[o]].isBone=!0}for(let s=0,r=e.length;s<r;s++){const a=e[s];a.mesh!==void 0&&(this._addNodeRef(this.meshCache,a.mesh),a.skin!==void 0&&(n[a.mesh].isSkinnedMesh=!0)),a.camera!==void 0&&this._addNodeRef(this.cameraCache,a.camera)}}_addNodeRef(e,t){t!==void 0&&(e.refs[t]===void 0&&(e.refs[t]=e.uses[t]=0),e.refs[t]++)}_getNodeRef(e,t,n){if(e.refs[t]<=1)return n;const s=n.clone(),r=(a,o)=>{const l=this.associations.get(a);l!=null&&this.associations.set(o,l);for(const[c,u]of a.children.entries())r(u,o.children[c])};return r(n,s),s.name+="_instance_"+e.uses[t]++,s}_invokeOne(e){const t=Object.values(this.plugins);t.push(this);for(let n=0;n<t.length;n++){const s=e(t[n]);if(s)return s}return null}_invokeAll(e){const t=Object.values(this.plugins);t.unshift(this);const n=[];for(let s=0;s<t.length;s++){const r=e(t[s]);r&&n.push(r)}return n}getDependency(e,t){const n=e+":"+t;let s=this.cache.get(n);if(!s){switch(e){case"scene":s=this.loadScene(t);break;case"node":s=this._invokeOne(function(r){return r.loadNode&&r.loadNode(t)});break;case"mesh":s=this._invokeOne(function(r){return r.loadMesh&&r.loadMesh(t)});break;case"accessor":s=this.loadAccessor(t);break;case"bufferView":s=this._invokeOne(function(r){return r.loadBufferView&&r.loadBufferView(t)});break;case"buffer":s=this.loadBuffer(t);break;case"material":s=this._invokeOne(function(r){return r.loadMaterial&&r.loadMaterial(t)});break;case"texture":s=this._invokeOne(function(r){return r.loadTexture&&r.loadTexture(t)});break;case"skin":s=this.loadSkin(t);break;case"animation":s=this._invokeOne(function(r){return r.loadAnimation&&r.loadAnimation(t)});break;case"camera":s=this.loadCamera(t);break;default:if(s=this._invokeOne(function(r){return r!=this&&r.getDependency&&r.getDependency(e,t)}),!s)throw new Error("Unknown type: "+e);break}this.cache.add(n,s)}return s}getDependencies(e){let t=this.cache.get(e);if(!t){const n=this,s=this.json[e+(e==="mesh"?"es":"s")]||[];t=Promise.all(s.map(function(r,a){return n.getDependency(e,a)})),this.cache.add(e,t)}return t}loadBuffer(e){const t=this.json.buffers[e],n=this.fileLoader;if(t.type&&t.type!=="arraybuffer")throw new Error("THREE.GLTFLoader: "+t.type+" buffer type is not supported.");if(t.uri===void 0&&e===0)return Promise.resolve(this.extensions[Ge.KHR_BINARY_GLTF].body);const s=this.options;return new Promise(function(r,a){n.load(vl.resolveURL(t.uri,s.path),r,void 0,function(){a(new Error('THREE.GLTFLoader: Failed to load buffer "'+t.uri+'".'))})})}loadBufferView(e){const t=this.json.bufferViews[e];return this.getDependency("buffer",t.buffer).then(function(n){const s=t.byteLength||0,r=t.byteOffset||0;return n.slice(r,r+s)})}loadAccessor(e){const t=this,n=this.json,s=this.json.accessors[e];if(s.bufferView===void 0&&s.sparse===void 0){const a=jo[s.type],o=Ws[s.componentType],l=s.normalized===!0,c=new o(s.count*a);return Promise.resolve(new Tt(c,a,l))}const r=[];return s.bufferView!==void 0?r.push(this.getDependency("bufferView",s.bufferView)):r.push(null),s.sparse!==void 0&&(r.push(this.getDependency("bufferView",s.sparse.indices.bufferView)),r.push(this.getDependency("bufferView",s.sparse.values.bufferView))),Promise.all(r).then(function(a){const o=a[0],l=jo[s.type],c=Ws[s.componentType],u=c.BYTES_PER_ELEMENT,h=u*l,d=s.byteOffset||0,p=s.bufferView!==void 0?n.bufferViews[s.bufferView].byteStride:void 0,_=s.normalized===!0;let g,m;if(p&&p!==h){const f=Math.floor(d/p),y="InterleavedBuffer:"+s.bufferView+":"+s.componentType+":"+f+":"+s.count;let v=t.cache.get(y);v||(g=new c(o,f*p,s.count*p/u),v=new hx(g,p/u),t.cache.add(y,v)),m=new Wl(v,l,d%p/u,_)}else o===null?g=new c(s.count*l):g=new c(o,d,s.count*l),m=new Tt(g,l,_);if(s.sparse!==void 0){const f=jo.SCALAR,y=Ws[s.sparse.indices.componentType],v=s.sparse.indices.byteOffset||0,S=s.sparse.values.byteOffset||0,M=new y(a[1],v,s.sparse.count*f),w=new c(a[2],S,s.sparse.count*l);o!==null&&(m=new Tt(m.array.slice(),m.itemSize,m.normalized));for(let T=0,C=M.length;T<C;T++){const x=M[T];if(m.setX(x,w[T*l]),l>=2&&m.setY(x,w[T*l+1]),l>=3&&m.setZ(x,w[T*l+2]),l>=4&&m.setW(x,w[T*l+3]),l>=5)throw new Error("THREE.GLTFLoader: Unsupported itemSize in sparse BufferAttribute.")}}return m})}loadTexture(e){const t=this.json,n=this.options,r=t.textures[e].source,a=t.images[r];let o=this.textureLoader;if(a.uri){const l=n.manager.getHandler(a.uri);l!==null&&(o=l)}return this.loadTextureImage(e,r,o)}loadTextureImage(e,t,n){const s=this,r=this.json,a=r.textures[e],o=r.images[t],l=(o.uri||o.bufferView)+":"+a.sampler;if(this.textureCache[l])return this.textureCache[l];const c=this.loadImageSource(t,n).then(function(u){u.flipY=!1,u.name=a.name||o.name||"",u.name===""&&typeof o.uri=="string"&&o.uri.startsWith("data:image/")===!1&&(u.name=o.uri);const d=(r.samplers||{})[a.sampler]||{};return u.magFilter=Eh[d.magFilter]||Lt,u.minFilter=Eh[d.minFilter]||Ni,u.wrapS=Th[d.wrapS]||$s,u.wrapT=Th[d.wrapT]||$s,s.associations.set(u,{textures:e}),u}).catch(function(){return null});return this.textureCache[l]=c,c}loadImageSource(e,t){const n=this,s=this.json,r=this.options;if(this.sourceCache[e]!==void 0)return this.sourceCache[e].then(h=>h.clone());const a=s.images[e],o=self.URL||self.webkitURL;let l=a.uri||"",c=!1;if(a.bufferView!==void 0)l=n.getDependency("bufferView",a.bufferView).then(function(h){c=!0;const d=new Blob([h],{type:a.mimeType});return l=o.createObjectURL(d),l});else if(a.uri===void 0)throw new Error("THREE.GLTFLoader: Image "+e+" is missing URI and bufferView");const u=Promise.resolve(l).then(function(h){return new Promise(function(d,p){let _=d;t.isImageBitmapLoader===!0&&(_=function(g){const m=new St(g);m.needsUpdate=!0,d(m)}),t.load(vl.resolveURL(h,r.path),_,void 0,p)})}).then(function(h){return c===!0&&o.revokeObjectURL(l),h.userData.mimeType=a.mimeType||oM(a.uri),h}).catch(function(h){throw console.error("THREE.GLTFLoader: Couldn't load texture",l),h});return this.sourceCache[e]=u,u}assignTexture(e,t,n,s){const r=this;return this.getDependency("texture",n.index).then(function(a){if(!a)return null;if(n.texCoord!==void 0&&n.texCoord>0&&(a=a.clone(),a.channel=n.texCoord),r.extensions[Ge.KHR_TEXTURE_TRANSFORM]){const o=n.extensions!==void 0?n.extensions[Ge.KHR_TEXTURE_TRANSFORM]:void 0;if(o){const l=r.associations.get(a);a=r.extensions[Ge.KHR_TEXTURE_TRANSFORM].extendTexture(a,o),r.associations.set(a,l)}}return s!==void 0&&(a.colorSpace=s),e[t]=a,a})}assignFinalMaterial(e){const t=e.geometry;let n=e.material;const s=t.attributes.tangent===void 0,r=t.attributes.color!==void 0,a=t.attributes.normal===void 0;if(e.isPoints){const o="PointsMaterial:"+n.uuid;let l=this.cache.get(o);l||(l=new Pd,Mn.prototype.copy.call(l,n),l.color.copy(n.color),l.map=n.map,l.sizeAttenuation=!1,this.cache.add(o,l)),n=l}else if(e.isLine){const o="LineBasicMaterial:"+n.uuid;let l=this.cache.get(o);l||(l=new Cd,Mn.prototype.copy.call(l,n),l.color.copy(n.color),l.map=n.map,this.cache.add(o,l)),n=l}if(s||r||a){let o="ClonedMaterial:"+n.uuid+":";s&&(o+="derivative-tangents:"),r&&(o+="vertex-colors:"),a&&(o+="flat-shading:");let l=this.cache.get(o);l||(l=n.clone(),r&&(l.vertexColors=!0),a&&(l.flatShading=!0),s&&(l.normalScale&&(l.normalScale.y*=-1),l.clearcoatNormalScale&&(l.clearcoatNormalScale.y*=-1)),this.cache.add(o,l),this.associations.set(l,this.associations.get(n))),n=l}e.material=n}getMaterialType(){return jl}loadMaterial(e){const t=this,n=this.json,s=this.extensions,r=n.materials[e];let a;const o={},l=r.extensions||{},c=[];if(l[Ge.KHR_MATERIALS_UNLIT]){const h=s[Ge.KHR_MATERIALS_UNLIT];a=h.getMaterialType(),c.push(h.extendParams(o,r,t))}else{const h=r.pbrMetallicRoughness||{};if(o.color=new ve(1,1,1),o.opacity=1,Array.isArray(h.baseColorFactor)){const d=h.baseColorFactor;o.color.fromArray(d),o.opacity=d[3]}h.baseColorTexture!==void 0&&c.push(t.assignTexture(o,"map",h.baseColorTexture,Te)),o.metalness=h.metallicFactor!==void 0?h.metallicFactor:1,o.roughness=h.roughnessFactor!==void 0?h.roughnessFactor:1,h.metallicRoughnessTexture!==void 0&&(c.push(t.assignTexture(o,"metalnessMap",h.metallicRoughnessTexture)),c.push(t.assignTexture(o,"roughnessMap",h.metallicRoughnessTexture))),a=this._invokeOne(function(d){return d.getMaterialType&&d.getMaterialType(e)}),c.push(Promise.all(this._invokeAll(function(d){return d.extendMaterialParams&&d.extendMaterialParams(e,o)})))}r.doubleSided===!0&&(o.side=Dt);const u=r.alphaMode||Ko.OPAQUE;if(u===Ko.BLEND?(o.transparent=!0,o.depthWrite=!1):(o.transparent=!1,u===Ko.MASK&&(o.alphaTest=r.alphaCutoff!==void 0?r.alphaCutoff:.5)),r.normalTexture!==void 0&&a!==is&&(c.push(t.assignTexture(o,"normalMap",r.normalTexture)),o.normalScale=new pe(1,1),r.normalTexture.scale!==void 0)){const h=r.normalTexture.scale;o.normalScale.set(h,h)}return r.occlusionTexture!==void 0&&a!==is&&(c.push(t.assignTexture(o,"aoMap",r.occlusionTexture)),r.occlusionTexture.strength!==void 0&&(o.aoMapIntensity=r.occlusionTexture.strength)),r.emissiveFactor!==void 0&&a!==is&&(o.emissive=new ve().fromArray(r.emissiveFactor)),r.emissiveTexture!==void 0&&a!==is&&c.push(t.assignTexture(o,"emissiveMap",r.emissiveTexture,Te)),Promise.all(c).then(function(){const h=new a(o);return r.name&&(h.name=r.name),wi(h,r),t.associations.set(h,{materials:e}),r.extensions&&Ki(s,h,r),h})}createUniqueName(e){const t=$e.sanitizeNodeName(e||"");return t in this.nodeNamesUsed?t+"_"+ ++this.nodeNamesUsed[t]:(this.nodeNamesUsed[t]=0,t)}loadGeometries(e){const t=this,n=this.extensions,s=this.primitiveCache;function r(o){return n[Ge.KHR_DRACO_MESH_COMPRESSION].decodePrimitive(o,t).then(function(l){return Ah(l,o,t)})}const a=[];for(let o=0,l=e.length;o<l;o++){const c=e[o],u=aM(c),h=s[u];if(h)a.push(h.promise);else{let d;c.extensions&&c.extensions[Ge.KHR_DRACO_MESH_COMPRESSION]?d=r(c):d=Ah(new An,c,t),s[u]={primitive:c,promise:d},a.push(d)}}return Promise.all(a)}loadMesh(e){const t=this,n=this.json,s=this.extensions,r=n.meshes[e],a=r.primitives,o=[];for(let l=0,c=a.length;l<c;l++){const u=a[l].material===void 0?iM(this.cache):this.getDependency("material",a[l].material);o.push(u)}return o.push(t.loadGeometries(a)),Promise.all(o).then(function(l){const c=l.slice(0,l.length-1),u=l[l.length-1],h=[];for(let p=0,_=u.length;p<_;p++){const g=u[p],m=a[p];let f;const y=c[p];if(m.mode===mn.TRIANGLES||m.mode===mn.TRIANGLE_STRIP||m.mode===mn.TRIANGLE_FAN||m.mode===void 0)f=r.isSkinnedMesh===!0?new fx(g,y):new dt(g,y),f.isSkinnedMesh===!0&&f.normalizeSkinWeights(),m.mode===mn.TRIANGLE_STRIP?f.geometry=Sh(f.geometry,ld):m.mode===mn.TRIANGLE_FAN&&(f.geometry=Sh(f.geometry,dl));else if(m.mode===mn.LINES)f=new vx(g,y);else if(m.mode===mn.LINE_STRIP)f=new ql(g,y);else if(m.mode===mn.LINE_LOOP)f=new xx(g,y);else if(m.mode===mn.POINTS)f=new yx(g,y);else throw new Error("THREE.GLTFLoader: Primitive mode unsupported: "+m.mode);Object.keys(f.geometry.morphAttributes).length>0&&rM(f,r),f.name=t.createUniqueName(r.name||"mesh_"+e),wi(f,r),m.extensions&&Ki(s,f,m),t.assignFinalMaterial(f),h.push(f)}for(let p=0,_=h.length;p<_;p++)t.associations.set(h[p],{meshes:e,primitives:p});if(h.length===1)return r.extensions&&Ki(s,h[0],r),h[0];const d=new Ri;r.extensions&&Ki(s,d,r),t.associations.set(d,{meshes:e});for(let p=0,_=h.length;p<_;p++)d.add(h[p]);return d})}loadCamera(e){let t;const n=this.json.cameras[e],s=n[n.type];if(!s){console.warn("THREE.GLTFLoader: Missing camera parameters.");return}return n.type==="perspective"?t=new Bt(za.radToDeg(s.yfov),s.aspectRatio||1,s.znear||1,s.zfar||2e6):n.type==="orthographic"&&(t=new Hl(-s.xmag,s.xmag,s.ymag,-s.ymag,s.znear,s.zfar)),n.name&&(t.name=this.createUniqueName(n.name)),wi(t,n),Promise.resolve(t)}loadSkin(e){const t=this.json.skins[e],n=[];for(let s=0,r=t.joints.length;s<r;s++)n.push(this._loadNodeShallow(t.joints[s]));return t.inverseBindMatrices!==void 0?n.push(this.getDependency("accessor",t.inverseBindMatrices)):n.push(null),Promise.all(n).then(function(s){const r=s.pop(),a=s,o=[],l=[];for(let c=0,u=a.length;c<u;c++){const h=a[c];if(h){o.push(h);const d=new Ne;r!==null&&d.fromArray(r.array,c*16),l.push(d)}else console.warn('THREE.GLTFLoader: Joint "%s" could not be found.',t.joints[c])}return new Xl(o,l)})}loadAnimation(e){const t=this.json,n=this,s=t.animations[e],r=s.name?s.name:"animation_"+e,a=[],o=[],l=[],c=[],u=[];for(let h=0,d=s.channels.length;h<d;h++){const p=s.channels[h],_=s.samplers[p.sampler],g=p.target,m=g.node,f=s.parameters!==void 0?s.parameters[_.input]:_.input,y=s.parameters!==void 0?s.parameters[_.output]:_.output;g.node!==void 0&&(a.push(this.getDependency("node",m)),o.push(this.getDependency("accessor",f)),l.push(this.getDependency("accessor",y)),c.push(_),u.push(g))}return Promise.all([Promise.all(a),Promise.all(o),Promise.all(l),Promise.all(c),Promise.all(u)]).then(function(h){const d=h[0],p=h[1],_=h[2],g=h[3],m=h[4],f=[];for(let y=0,v=d.length;y<v;y++){const S=d[y],M=p[y],w=_[y],T=g[y],C=m[y];if(S===void 0)continue;S.updateMatrix&&S.updateMatrix();const x=n._createAnimationTracks(S,M,w,T,C);if(x)for(let A=0;A<x.length;A++)f.push(x[A])}return new wx(r,void 0,f)})}createNodeMesh(e){const t=this.json,n=this,s=t.nodes[e];return s.mesh===void 0?null:n.getDependency("mesh",s.mesh).then(function(r){const a=n._getNodeRef(n.meshCache,s.mesh,r);return s.weights!==void 0&&a.traverse(function(o){if(o.isMesh)for(let l=0,c=s.weights.length;l<c;l++)o.morphTargetInfluences[l]=s.weights[l]}),a})}loadNode(e){const t=this.json,n=this,s=t.nodes[e],r=n._loadNodeShallow(e),a=[],o=s.children||[];for(let c=0,u=o.length;c<u;c++)a.push(n.getDependency("node",o[c]));const l=s.skin===void 0?Promise.resolve(null):n.getDependency("skin",s.skin);return Promise.all([r,Promise.all(a),l]).then(function(c){const u=c[0],h=c[1],d=c[2];d!==null&&u.traverse(function(p){p.isSkinnedMesh&&p.bind(d,lM)});for(let p=0,_=h.length;p<_;p++)u.add(h[p]);return u})}_loadNodeShallow(e){const t=this.json,n=this.extensions,s=this;if(this.nodeCache[e]!==void 0)return this.nodeCache[e];const r=t.nodes[e],a=r.name?s.createUniqueName(r.name):"",o=[],l=s._invokeOne(function(c){return c.createNodeMesh&&c.createNodeMesh(e)});return l&&o.push(l),r.camera!==void 0&&o.push(s.getDependency("camera",r.camera).then(function(c){return s._getNodeRef(s.cameraCache,r.camera,c)})),s._invokeAll(function(c){return c.createNodeAttachment&&c.createNodeAttachment(e)}).forEach(function(c){o.push(c)}),this.nodeCache[e]=Promise.all(o).then(function(c){let u;if(r.isBone===!0?u=new Rd:c.length>1?u=new Ri:c.length===1?u=c[0]:u=new at,u!==c[0])for(let h=0,d=c.length;h<d;h++)u.add(c[h]);if(r.name&&(u.userData.name=r.name,u.name=a),wi(u,r),r.extensions&&Ki(n,u,r),r.matrix!==void 0){const h=new Ne;h.fromArray(r.matrix),u.applyMatrix4(h)}else r.translation!==void 0&&u.position.fromArray(r.translation),r.rotation!==void 0&&u.quaternion.fromArray(r.rotation),r.scale!==void 0&&u.scale.fromArray(r.scale);return s.associations.has(u)||s.associations.set(u,{}),s.associations.get(u).nodes=e,u}),this.nodeCache[e]}loadScene(e){const t=this.extensions,n=this.json.scenes[e],s=this,r=new Ri;n.name&&(r.name=s.createUniqueName(n.name)),wi(r,n),n.extensions&&Ki(t,r,n);const a=n.nodes||[],o=[];for(let l=0,c=a.length;l<c;l++)o.push(s.getDependency("node",a[l]));return Promise.all(o).then(function(l){for(let u=0,h=l.length;u<h;u++)r.add(l[u]);const c=u=>{const h=new Map;for(const[d,p]of s.associations)(d instanceof Mn||d instanceof St)&&h.set(d,p);return u.traverse(d=>{const p=s.associations.get(d);p!=null&&h.set(d,p)}),h};return s.associations=c(r),r})}_createAnimationTracks(e,t,n,s,r){const a=[],o=e.name?e.name:e.uuid,l=[];Ti[r.path]===Ti.weights?e.traverse(function(d){d.morphTargetInfluences&&l.push(d.name?d.name:d.uuid)}):l.push(o);let c;switch(Ti[r.path]){case Ti.weights:c=tr;break;case Ti.rotation:c=ds;break;case Ti.position:case Ti.scale:c=nr;break;default:switch(n.itemSize){case 1:c=tr;break;case 2:case 3:default:c=nr;break}break}const u=s.interpolation!==void 0?nM[s.interpolation]:Js,h=this._getArrayFromAccessor(n);for(let d=0,p=l.length;d<p;d++){const _=new c(l[d]+"."+Ti[r.path],t.array,h,u);s.interpolation==="CUBICSPLINE"&&this._createCubicSplineTrackInterpolant(_),a.push(_)}return a}_getArrayFromAccessor(e){let t=e.array;if(e.normalized){const n=yl(t.constructor),s=new Float32Array(t.length);for(let r=0,a=t.length;r<a;r++)s[r]=t[r]*n;t=s}return t}_createCubicSplineTrackInterpolant(e){e.createInterpolant=function(n){const s=this instanceof ds?tM:qd;return new s(this.times,this.values,this.getValueSize()/3,n)},e.createInterpolant.isInterpolantFactoryMethodGLTFCubicSpline=!0}}function uM(i,e,t){const n=e.attributes,s=new mi;if(n.POSITION!==void 0){const o=t.json.accessors[n.POSITION],l=o.min,c=o.max;if(l!==void 0&&c!==void 0){if(s.set(new L(l[0],l[1],l[2]),new L(c[0],c[1],c[2])),o.normalized){const u=yl(Ws[o.componentType]);s.min.multiplyScalar(u),s.max.multiplyScalar(u)}}else{console.warn("THREE.GLTFLoader: Missing min/max properties for accessor POSITION.");return}}else return;const r=e.targets;if(r!==void 0){const o=new L,l=new L;for(let c=0,u=r.length;c<u;c++){const h=r[c];if(h.POSITION!==void 0){const d=t.json.accessors[h.POSITION],p=d.min,_=d.max;if(p!==void 0&&_!==void 0){if(l.setX(Math.max(Math.abs(p[0]),Math.abs(_[0]))),l.setY(Math.max(Math.abs(p[1]),Math.abs(_[1]))),l.setZ(Math.max(Math.abs(p[2]),Math.abs(_[2]))),d.normalized){const g=yl(Ws[d.componentType]);l.multiplyScalar(g)}o.max(l)}else console.warn("THREE.GLTFLoader: Missing min/max properties for accessor POSITION.")}}s.expandByVector(o)}i.boundingBox=s;const a=new jn;s.getCenter(a.center),a.radius=s.min.distanceTo(s.max)/2,i.boundingSphere=a}function Ah(i,e,t){const n=e.attributes,s=[];function r(a,o){return t.getDependency("accessor",a).then(function(l){i.setAttribute(o,l)})}for(const a in n){const o=xl[a]||a.toLowerCase();o in i.attributes||s.push(r(n[a],o))}if(e.indices!==void 0&&!i.index){const a=t.getDependency("accessor",e.indices).then(function(o){i.setIndex(o)});s.push(a)}return wi(i,e),uM(i,e,t),Promise.all(s).then(function(){return e.targets!==void 0?sM(i,e.targets,t):i})}class hM extends Ql{constructor(e){super(),this.sources=e,this.items={},this.toLoad=this.sources.length,this.loaded=0,this.setLoaders(),this.startLoading()}setLoaders(){this.loaders={gltfLoader:new DS,textureLoader:new Od}}startLoading(){for(const e of this.sources)e.type==="gltfModel"?this.loaders.gltfLoader.load(e.path,t=>{this.sourceLoaded(e,t)}):e.type==="texture"&&this.loaders.textureLoader.load(e.path,t=>{this.sourceLoaded(e,t)})}sourceLoaded(e,t){this.items[e.name]=t,this.loaded++,this.loaded==this.toLoad&&this.trigger("ready")}get finished(){return this.loaded==this.toLoad}}var dM=`varying vec2 vUv;
...
void main() {
    ...
    vUv = uv;\r
}`,fM=`uniform sampler2D   uAudioTexture;  
...
void main() {
    ...
    vUv = uv;\r
}`,gM=`uniform sampler2D uAudioTexture;\r
...
void main() {\r
    ...
    gl_Position = projectionPosition;\r
    vUv = uv;\r
}`,EM=`uniform sampler2D uAudioTexture;    
uniform sampler2D uAudioTexture2;    
...
void main() {\r
    ...
    gl_Position = projectionPosition;\r
    vUv = uv;\r
}`,bM=`uniform sampler2D uAudioTexture;    
uniform float     uAudioStrength;   
...
void main() {
    ...
    vUv = uv;\r
}`,CM=`uniform sampler2D uTexture1;\r
...
void main() {\r
    ...
    \r
}`;class PM{constructor(e,t,n=22400,s=12600,r=0,a=0,o=-1e4){this.name=t,this.z=o,this.experience=new gt,this.scene=this.experience.scene,this.world=e,this.setup(n,s,r,a,o)}setup(e,t,n,s,r){const a=this.experience.sizes.width/this.experience.sizes.height;this.geometry=new ki(e,t),this.material=new ot({uniforms:{uTexture1:{value:this.experience.resources.items[this.name]},uAlpha:{value:.125},uActualTexture:{value:1},uTime:{value:0}},vertexShader:RM,fragmentShader:CM,transparent:!0}),this.mesh=new dt(this.geometry,this.material),this.mesh.position.set(n,s,r+a*1e3),this.mesh.name=this.name,this.scene.add(this.mesh)}resize(){const e=this.experience.sizes.width/this.experience.sizes.height;this.mesh.position.z=this.z+e*1e3}updateBackground(){this.material.uniforms.uTime.value=0,this.material.uniforms.uTexture1.value=this.experience.resources.items[this.name]}update(e){this.material.uniforms.uTime.value+=e}}class LM{constructor(e,t,n,s){this.experience=new gt,typeof this.experience.idDebugEffect>"u"?this.experience.idDebugEffect=0:this.experience.idDebugEffect++,this.name=e,this.params=s,this.start=t,this.end=n,this.createHTML()}createHTML(){this.element=document.createElement("div"),this.element.className="Experience_DebugEffect",this.element.id=`DebugEffect${this.experience.idDebugEffect}`;let e=`
                            <div>
                                ${this.name}
                            </div>
                            <div>
...
*/var un={autoSleep:120,force3D:"auto",nullTargetWarn:1,units:{lineHeight:""}},sr={duration:.5,overwrite:!1,delay:0},tc,Xt,ut,xn=1e8,Qe=1/xn,Sl=Math.PI*2,DM=Sl/4,IM=0,jd=Math.sqrt,UM=Math.cos,OM=Math.sin,Ut=function(e){return typeof e=="string"},ft=function(e){return typeof e=="function"},fi=function(e){return typeof e=="number"},nc=function(e){return typeof e>"u"},qn=function(e){return typeof e=="object"},Qt=function(e){return e!==!1},ic=function(){return typeof window<"u"},Ra=function(e){return ft(e)||Ut(e)},Kd=typeof ArrayBuffer=="function"&&ArrayBuffer.isView||function(){},qt=Array.isArray,Ml=/(?:-?\.?\d|\.)+/gi,$d=/[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g,ks=/[-+=.]*\d+[.e-]*\d*[a-z%]*/g,Zo=/[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi,Zd=/[+-]=-?[.\d]+/,Jd=/[^,'"\[\]\s]+/gi,NM=/^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i,st,gn,El,sc,hn={},Ha={},Qd,ef=function(e){return(Ha=ps(e,hn))&&nn},rc=function(e,t){return console.warn("Invalid property",e,"set to",t,"Missing plugin? gsap.registerPlugin()")},Va=function(e,t){return!t&&console.warn(e)},tf=function(e,t){return e&&(hn[e]=t)&&Ha&&(Ha[e]=t)||hn},Br=function(){return 0},FM={suppressEvents:!0,isStart:!0,kill:!1},Da={suppressEvents:!0,kill:!1},BM={suppressEvents:!0},ac={},Ui=[],Tl={},nf,on={},Jo={},bh=30,Ia=[],oc="",lc=function(e){var t=e[0],n,s;if(qn(t)||ft(t)||(e=[e]),!(n=(t._gsap||{}).harness)){for(s=Ia.length;s--&&!Ia[s].targetTest(t););n=Ia[s]}for(s=e.length;s--;)e[s]&&(e[s]._gsap||(e[s]._gsap=new wf(e[s],n)))||e.splice(s,1);return e},os=function(e){return e._gsap||lc(yn(e))[0]._gsap},sf=function(e,t,n){return(n=e[t])&&ft(n)?e[t]():nc(n)&&e.getAttribute&&e.getAttribute(t)||n},en=function(e,t){return(e=e.split(",")).forEach(t)||e},mt=function(e){return Math.round(e*1e5)/1e5||0},zt=function(e){return Math.round(e*1e7)/1e7||0},Xs=function(e,t){var n=t.charAt(0),s=parseFloat(t.substr(2));return e=parseFloat(e),n==="+"?e+s:n==="-"?e-s:n==="*"?e*s:e/s},zM=function(e,t){for(var n=t.length,s=0;e.indexOf(t[s])<0&&++s<n;);return s<n},Ga=function(){var e=Ui.length,t=Ui.slice(0),n,s;for(Tl={},Ui.length=0,n=0;n<e;n++)s=t[n],s&&s._lazy&&(s.render(s._lazy[0],s._lazy[1],!0)._lazy=0)},rf=function(e,t,n,s){Ui.length&&!Xt&&Ga(),e.render(t,n,s||Xt&&t<0&&(e._initted||e._startAt)),Ui.length&&!Xt&&Ga()},af=function(e){var t=parseFloat(e);return(t||t===0)&&(e+"").match(Jd).length<2?t:Ut(e)?e.trim():e},of=function(e){return e},Tn=function(e,t){for(var n in t)n in e||(e[n]=t[n]);return e},kM=function(e){return function(t,n){for(var s in n)s in t||s==="duration"&&e||s==="ease"||(t[s]=n[s])}},ps=function(e,t){for(var n in t)e[n]=t[n];return e},wh=function i(e,t){for(var n in t)n!=="__proto__"&&n!=="constructor"&&n!=="prototype"&&(e[n]=qn(t[n])?i(e[n]||(e[n]={}),t[n]):t[n]);return e},Wa=function(e,t){var n={},s;for(s in e)s in t||(n[s]=e[s]);return n},Ir=function(e){var t=e.parent||st,n=e.keyframes?kM(qt(e.keyframes)):Tn;if(Qt(e.inherit))for(;t;)n(e,t.vars.defaults),t=t.parent||t._dp;return e},HM=function(e,t){for(var n=e.length,s=n===t.length;s&&n--&&e[n]===t[n];);return n<0},lf=function(e,t,n,s,r){n===void 0&&(n="_first"),s===void 0&&(s="_last");var a=e[s],o;if(r)for(o=t[r];a&&a[r]>o;)a=a._prev;return a?(t._next=a._next,a._next=t):(t._next=e[n],e[n]=t),t._next?t._next._prev=t:e[s]=t,t._prev=a,t.parent=t._dp=e,t},no=function(e,t,n,s){n===void 0&&(n="_first"),s===void 0&&(s="_last");var r=t._prev,a=t._next;r?r._next=a:e[n]===t&&(e[n]=a),a?a._prev=r:e[s]===t&&(e[s]=r),t._next=t._prev=t.parent=null},Bi=function(e,t){e.parent&&(!t||e.parent.autoRemoveChildren)&&e.parent.remove&&e.parent.remove(e),e._act=0},ls=function(e,t){if(e&&(!t||t._end>e._dur||t._start<0))for(var n=e;n;)n._dirty=1,n=n.parent;return e},VM=function(e){for(var t=e.parent;t&&t.parent;)t._dirty=1,t.totalDuration(),t=t.parent;return e},Al=function(e,t,n,s){return e._startAt&&(Xt?e._startAt.revert(Da):e.vars.immediateRender&&!e.vars.autoRevert||e._startAt.render(t,!0,s))},GM=function i(e){return!e||e._ts&&i(e.parent)},Rh=function(e){return e._repeat?rr(e._tTime,e=e.duration()+e._rDelay)*e:0},rr=function(e,t){var n=Math.floor(e/=t);return e&&n===e?n-1:n},Xa=function(e,t){return(e-t._start)*t._ts+(t._ts>=0?0:t._dirty?t.totalDuration():t._tDur)},io=function(e){return e._end=zt(e._start+(e._tDur/Math.abs(e._ts||e._rts||Qe)||0))},so=function(e,t){var n=e._dp;return n&&n.smoothChildTiming&&e._ts&&(e._start=zt(n._time-(e._ts>0?t/e._ts:((e._dirty?e.totalDuration():e._tDur)-t)/-e._ts)),io(e),n._dirty||ls(n,e)),e},cf=function(e,t){var n;if((t._time||!t._dur&&t._initted||t._start<e._time&&(t._dur||!t.add))&&(n=Xa(e.rawTime(),t),(!t._dur||Jr(0,t.totalDuration(),n)-t._tTime>Qe)&&t.render(n,!0)),ls(e,t)._dp&&e._initted&&e._time>=e._dur&&e._ts){if(e._dur<e.duration())for(n=e;n._dp;)n.rawTime()>=0&&n.totalTime(n._tTime),n=n._dp;e._zTime=-Qe}},zn=function(e,t,n,s){return t.parent&&Bi(t),t._start=zt((fi(n)?n:n||e!==st?pn(e,n,t):e._time)+t._delay),t._end=zt(t._start+(t.totalDuration()/Math.abs(t.timeScale())||0)),lf(e,t,"_first","_last",e._sort?"_start":0),bl(t)||(e._recent=t),s||cf(e,t),e._ts<0&&so(e,e._tTime),e},uf=function(e,t){return(hn.ScrollTrigger||rc("scrollTrigger",t))&&hn.ScrollTrigger.create(t,e)},hf=function(e,t,n,s,r){if(uc(e,t,r),!e._initted)return 1;if(!n&&e._pt&&!Xt&&(e._dur&&e.vars.lazy!==!1||!e._dur&&e.vars.lazy)&&nf!==ln.frame)return Ui.push(e),e._lazy=[r,s],1},WM=function i(e){var t=e.parent;return t&&t._ts&&t._initted&&!t._lock&&(t.rawTime()<0||i(t))},bl=function(e){var t=e.data;return t==="isFromStart"||t==="isStart"},XM=function(e,t,n,s){var r=e.ratio,a=t<0||!t&&(!e._start&&WM(e)&&!(!e._initted&&bl(e))||(e._ts<0||e._dp._ts<0)&&!bl(e))?0:1,o=e._rDelay,l=0,c,u,h;if(o&&e._repeat&&(l=Jr(0,e._tDur,t),u=rr(l,o),e._yoyo&&u&1&&(a=1-a),u!==rr(e._tTime,o)&&(r=1-a,e.vars.repeatRefresh&&e._initted&&e.invalidate())),a!==r||Xt||s||e._zTime===Qe||!t&&e._zTime){if(!e._initted&&hf(e,t,s,n,l))return;for(h=e._zTime,e._zTime=t||(n?Qe:0),n||(n=t&&!h),e.ratio=a,e._from&&(a=1-a),e._time=0,e._tTime=l,c=e._pt;c;)c.r(a,c.d),c=c._next;t<0&&Al(e,t,n,!0),e._onUpdate&&!n&&Sn(e,"onUpdate"),l&&e._repeat&&!n&&e.parent&&Sn(e,"onRepeat"),(t>=e._tDur||t<0)&&e.ratio===a&&(a&&Bi(e,1),!n&&!Xt&&(Sn(e,a?"onComplete":"onReverseComplete",!0),e._prom&&e._prom()))}else e._zTime||(e._zTime=t)},qM=function(e,t,n){var s;if(n>t)for(s=e._first;s&&s._start<=n;){if(s.data==="isPause"&&s._start>t)return s;s=s._next}else for(s=e._last;s&&s._start>=n;){if(s.data==="isPause"&&s._start<t)return s;s=s._prev}},ar=function(e,t,n,s){var r=e._repeat,a=zt(t)||0,o=e._tTime/e._tDur;return o&&!s&&(e._time*=a/e._dur),e._dur=a,e._tDur=r?r<0?1e10:zt(a*(r+1)+e._rDelay*r):a,o>0&&!s&&so(e,e._tTime=e._tDur*o),e.parent&&io(e),n||ls(e.parent,e),e},Ch=function(e){return e instanceof Jt?ls(e):ar(e,e._dur)},YM={_start:0,endTime:Br,totalDuration:Br},pn=function i(e,t,n){var s=e.labels,r=e._recent||YM,a=e.duration()>=xn?r.endTime(!1):e._dur,o,l,c;return Ut(t)&&(isNaN(t)||t in s)?(l=t.charAt(0),c=t.substr(-1)==="%",o=t.indexOf("="),l==="<"||l===">"?(o>=0&&(t=t.replace(/=/,"")),(l==="<"?r._start:r.endTime(r._repeat>=0))+(parseFloat(t.substr(1))||0)*(c?(o<0?r:n).totalDuration()/100:1)):o<0?(t in s||(s[t]=a),s[t]):(l=parseFloat(t.charAt(o-1)+t.substr(o+1)),c&&n&&(l=l/100*(qt(n)?n[0]:n).totalDuration()),o>1?i(e,t.substr(0,o-1),n)+l:a+l)):t==null?a:+t},Ur=function(e,t,n){var s=fi(t[1]),r=(s?2:1)+(e<2?0:1),a=t[r],o,l;if(s&&(a.duration=t[1]),a.parent=n,e){for(o=a,l=n;l&&!("immediateRender"in o);)o=l.vars.defaults||{},l=Qt(l.vars.inherit)&&l.parent;a.immediateRender=Qt(o.immediateRender),e<2?a.runBackwards=1:a.startAt=t[r-1]}return new yt(t[0],a,t[r+1])},Vi=function(e,t){return e||e===0?t(e):t},Jr=function(e,t,n){return n<e?e:n>t?t:n},Gt=function(e,t){return!Ut(e)||!(t=NM.exec(e))?"":t[1]},jM=function(e,t,n){return Vi(n,function(s){return Jr(e,t,s)})},wl=[].slice,df=function(e,t){return e&&qn(e)&&"length"in e&&(!t&&!e.length||e.length-1 in e&&qn(e[0]))&&!e.nodeType&&e!==gn},KM=function(e,t,n){return n===void 0&&(n=[]),e.forEach(function(s){var r;return Ut(s)&&!t||df(s,1)?(r=n).push.apply(r,yn(s)):n.push(s)})||n},yn=function(e,t,n){return ut&&!t&&ut.selector?ut.selector(e):Ut(e)&&!n&&(El||!or())?wl.call((t||sc).querySelectorAll(e),0):qt(e)?KM(e,n):df(e)?wl.call(e,0):e?[e]:[]},Rl=function(e){return e=yn(e)[0]||Va("Invalid scope")||{},function(t){var n=e.current||e.nativeElement||e;return yn(t,n.querySelectorAll?n:n===e?Va("Invalid scope")||sc.createElement("div"):e)}},ff=function(e){return e.sort(function(){return .5-Math.random()})},pf=function(e){if(ft(e))return e;var t=qn(e)?e:{each:e},n=cs(t.ease),s=t.from||0,r=parseFloat(t.base)||0,a={},o=s>0&&s<1,l=isNaN(s)||o,c=t.axis,u=s,h=s;return Ut(s)?u=h={center:.5,edges:.5,end:1}[s]||0:!o&&l&&(u=s[0],h=s[1]),function(d,p,_){var g=(_||t).length,m=a[g],f,y,v,S,M,w,T,C,x;if(!m){if(x=t.grid==="auto"?0:(t.grid||[1,xn])[1],!x){for(T=-xn;T<(T=_[x++].getBoundingClientRect().left)&&x<g;);x--}for(m=a[g]=[],f=l?Math.min(x,g)*u-.5:s%x,y=x===xn?0:l?g*h/x-.5:s/x|0,T=0,C=xn,w=0;w<g;w++)v=w%x-f,S=y-(w/x|0),m[w]=M=c?Math.abs(c==="y"?S:v):jd(v*v+S*S),M>T&&(T=M),M<C&&(C=M);s==="random"&&ff(m),m.max=T-C,m.min=C,m.v=g=(parseFloat(t.amount)||parseFloat(t.each)*(x>g?g-1:c?c==="y"?g/x:x:Math.max(x,g/x))||0)*(s==="edges"?-1:1),m.b=g<0?r-g:r,m.u=Gt(t.amount||t.each)||0,n=n&&g<0?Tf(n):n}return g=(m[d]-m.min)/m.max||0,zt(m.b+(n?n(g):g)*m.v)+m.u}},Cl=function(e){var t=Math.pow(10,((e+"").split(".")[1]||"").length);return function(n){var s=zt(Math.round(parseFloat(n)/e)*e*t);return(s-s%1)/t+(fi(n)?0:Gt(n))}},mf=function(e,t){var n=qt(e),s,r;return!n&&qn(e)&&(s=n=e.radius||xn,e.values?(e=yn(e.values),(r=!fi(e[0]))&&(s*=s)):e=Cl(e.increment)),Vi(t,n?ft(e)?function(a){return r=e(a),Math.abs(r-a)<=s?r:a}:function(a){for(var o=parseFloat(r?a.x:a),l=parseFloat(r?a.y:0),c=xn,u=0,h=e.length,d,p;h--;)r?(d=e[h].x-o,p=e[h].y-l,d=d*d+p*p):d=Math.abs(e[h]-o),d<c&&(c=d,u=h);return u=!s||c<=s?e[u]:a,r||u===a||fi(a)?u:u+Gt(a)}:Cl(e))},gf=function(e,t,n,s){return Vi(qt(e)?!t:n===!0?!!(n=0):!s,function(){return qt(e)?e[~~(Math.random()*e.length)]:(n=n||1e-5)&&(s=n<1?Math.pow(10,(n+"").length-2):1)&&Math.floor(Math.round((e-n/2+Math.random()*(t-e+n*.99))/n)*n*s)/s})},$M=function(){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n];return function(s){return t.reduce(function(r,a){return a(r)},s)}},ZM=function(e,t){return function(n){return e(parseFloat(n))+(t||Gt(n))}},JM=function(e,t,n){return vf(e,t,0,1,n)},_f=function(e,t,n){return Vi(n,function(s){return e[~~t(s)]})},QM=function i(e,t,n){var s=t-e;return qt(e)?_f(e,i(0,e.length),t):Vi(n,function(r){return(s+(r-e)%s)%s+e})},eE=function i(e,t,n){var s=t-e,r=s*2;return qt(e)?_f(e,i(0,e.length-1),t):Vi(n,function(a){return a=(r+(a-e)%r)%r||0,e+(a>s?r-a:a)})},zr=function(e){for(var t=0,n="",s,r,a,o;~(s=e.indexOf("random(",t));)a=e.indexOf(")",s),o=e.charAt(s+7)==="[",r=e.substr(s+7,a-s-7).match(o?Jd:Ml),n+=e.substr(t,s-t)+gf(o?r:+r[0],o?0:+r[1],+r[2]||1e-5),t=a+1;return n+e.substr(t,e.length-t)},vf=function(e,t,n,s,r){var a=t-e,o=s-n;return Vi(r,function(l){return n+((l-e)/a*o||0)})},tE=function i(e,t,n,s){var r=isNaN(e+t)?0:function(p){return(1-p)*e+p*t};if(!r){var a=Ut(e),o={},l,c,u,h,d;if(n===!0&&(s=1)&&(n=null),a)e={p:e},t={p:t};else if(qt(e)&&!qt(t)){for(u=[],h=e.length,d=h-2,c=1;c<h;c++)u.push(i(e[c-1],e[c]));h--,r=function(_){_*=h;var g=Math.min(d,~~_);return u[g](_-g)},n=t}else s||(e=ps(qt(e)?[]:{},e));if(!u){for(l in t)cc.call(o,e,l,"get",t[l]);r=function(_){return fc(_,o)||(a?e.p:e)}}}return Vi(n,r)},Ph=function(e,t,n){var s=e.labels,r=xn,a,o,l;for(a in s)o=s[a]-t,o<0==!!n&&o&&r>(o=Math.abs(o))&&(l=a,r=o);return l},Sn=function(e,t,n){var s=e.vars,r=s[t],a=ut,o=e._ctx,l,c,u;if(r)return l=s[t+"Params"],c=s.callbackScope||e,n&&Ui.length&&Ga(),o&&(ut=o),u=l?r.apply(c,l):r.call(c),ut=a,u},wr=function(e){return Bi(e),e.scrollTrigger&&e.scrollTrigger.kill(!!Xt),e.progress()<1&&Sn(e,"onInterrupt"),e},Hs,xf=[],yf=function(e){if(ic()&&e){e=!e.name&&e.default||e;var t=e.name,n=ft(e),s=t&&!n&&e.init?function(){this._props=[]}:e,r={init:Br,render:fc,add:cc,kill:_E,modifier:gE,rawVars:0},a={targetTest:0,get:0,getSetter:dc,aliases:{},register:0};if(or(),e!==s){if(on[t])return;Tn(s,Tn(Wa(e,r),a)),ps(s.prototype,ps(r,Wa(e,a))),on[s.prop=t]=s,e.targetTest&&(Ia.push(s),ac[t]=1),t=(t==="css"?"CSS":t.charAt(0).toUpperCase()+t.substr(1))+"Plugin"}tf(t,s),e.register&&e.register(nn,s,tn)}else e&&xf.push(e)},Je=255,Rr={aqua:[0,Je,Je],lime:[0,Je,0],silver:[192,192,192],black:[0,0,0],maroon:[128,0,0],teal:[0,128,128],blue:[0,0,Je],navy:[0,0,128],white:[Je,Je,Je],olive:[128,128,0],yellow:[Je,Je,0],orange:[Je,165,0],gray:[128,128,128],purple:[128,0,128],green:[0,128,0],red:[Je,0,0],pink:[Je,192,203],cyan:[0,Je,Je],transparent:[Je,Je,Je,0]},Qo=function(e,t,n){return e+=e<0?1:e>1?-1:0,(e*6<1?t+(n-t)*e*6:e<.5?n:e*3<2?t+(n-t)*(2/3-e)*6:t)*Je+.5|0},Sf=function(e,t,n){var s=e?fi(e)?[e>>16,e>>8&Je,e&Je]:0:Rr.black,r,a,o,l,c,u,h,d,p,_;if(!s){if(e.substr(-1)===","&&(e=e.substr(0,e.length-1)),Rr[e])s=Rr[e];else if(e.charAt(0)==="#"){if(e.length<6&&(r=e.charAt(1),a=e.charAt(2),o=e.charAt(3),e="#"+r+r+a+a+o+o+(e.length===5?e.charAt(4)+e.charAt(4):"")),e.length===9)return s=parseInt(e.substr(1,6),16),[s>>16,s>>8&Je,s&Je,parseInt(e.substr(7),16)/255];e=parseInt(e.substr(1),16),s=[e>>16,e>>8&Je,e&Je]}else if(e.substr(0,3)==="hsl"){if(s=_=e.match(Ml),!t)l=+s[0]%360/360,c=+s[1]/100,u=+s[2]/100,a=u<=.5?u*(c+1):u+c-u*c,r=u*2-a,s.length>3&&(s[3]*=1),s[0]=Qo(l+1/3,r,a),s[1]=Qo(l,r,a),s[2]=Qo(l-1/3,r,a);else if(~e.indexOf("="))return s=e.match($d),n&&s.length<4&&(s[3]=1),s}else s=e.match(Ml)||Rr.transparent;s=s.map(Number)}return t&&!_&&(r=s[0]/Je,a=s[1]/Je,o=s[2]/Je,h=Math.max(r,a,o),d=Math.min(r,a,o),u=(h+d)/2,h===d?l=c=0:(p=h-d,c=u>.5?p/(2-h-d):p/(h+d),l=h===r?(a-o)/p+(a<o?6:0):h===a?(o-r)/p+2:(r-a)/p+4,l*=60),s[0]=~~(l+.5),s[1]=~~(c*100+.5),s[2]=~~(u*100+.5)),n&&s.length<4&&(s[3]=1),s},Mf=function(e){var t=[],n=[],s=-1;return e.split(Oi).forEach(function(r){var a=r.match(ks)||[];t.push.apply(t,a),n.push(s+=a.length+1)}),t.c=n,t},Lh=function(e,t,n){var s="",r=(e+s).match(Oi),a=t?"hsla(":"rgba(",o=0,l,c,u,h;if(!r)return e;if(r=r.map(function(d){return(d=Sf(d,t,1))&&a+(t?d[0]+","+d[1]+"%,"+d[2]+"%,"+d[3]:d.join(","))+")"}),n&&(u=Mf(e),l=n.c,l.join(s)!==u.c.join(s)))for(c=e.replace(Oi,"1").split(ks),h=c.length-1;o<h;o++)s+=c[o]+(~l.indexOf(o)?r.shift()||a+"0,0,0,0)":(u.length?u:r.length?r:n).shift());if(!c)for(c=e.split(Oi),h=c.length-1;o<h;o++)s+=c[o]+r[o];return s+c[h]},Oi=function(){var i="(?:\\b(?:(?:rgb|rgba|hsl|hsla)\\(.+?\\))|\\B#(?:[0-9a-f]{3,4}){1,2}\\b",e;for(e in Rr)i+="|"+e+"\\b";return new RegExp(i+")","gi")}(),nE=/hsl[a]?\(/,Ef=function(e){var t=e.join(" "),n;if(Oi.lastIndex=0,Oi.test(t))return n=nE.test(t),e[1]=Lh(e[1],n),e[0]=Lh(e[0],n,Mf(e[1])),!0},kr,ln=function(){var i=Date.now,e=500,t=33,n=i(),s=n,r=1e3/240,a=r,o=[],l,c,u,h,d,p,_=function g(m){var f=i()-s,y=m===!0,v,S,M,w;if(f>e&&(n+=f-t),s+=f,M=s-n,v=M-a,(v>0||y)&&(w=++h.frame,d=M-h.time*1e3,h.time=M=M/1e3,a+=v+(v>=r?4:r-v),S=1),y||(l=c(g)),S)for(p=0;p<o.length;p++)o[p](M,d,w,m)};return h={time:0,frame:0,tick:function(){_(!0)},deltaRatio:function(m){return d/(1e3/(m||60))},wake:function(){Qd&&(!El&&ic()&&(gn=El=window,sc=gn.document||{},hn.gsap=nn,(gn.gsapVersions||(gn.gsapVersions=[])).push(nn.version),ef(Ha||gn.GreenSockGlobals||!gn.gsap&&gn||{}),u=gn.requestAnimationFrame,xf.forEach(yf)),l&&h.sleep(),c=u||function(m){return setTimeout(m,a-h.time*1e3+1|0)},kr=1,_(2))},sleep:function(){(u?gn.cancelAnimationFrame:clearTimeout)(l),kr=0,c=Br},lagSmoothing:function(m,f){e=m||1/0,t=Math.min(f||33,e)},fps:function(m){r=1e3/(m||240),a=h.time*1e3+r},add:function(m,f,y){var v=f?function(S,M,w,T){m(S,M,w,T),h.remove(v)}:m;return h.remove(m),o[y?"unshift":"push"](v),or(),v},remove:function(m,f){~(f=o.indexOf(m))&&o.splice(f,1)&&p>=f&&p--},_listeners:o},h}(),or=function(){return!kr&&ln.wake()},We={},iE=/^[\d.\-M][\d.\-,\s]/,sE=/["']/g,rE=function(e){for(var t={},n=e.substr(1,e.length-3).split(":"),s=n[0],r=1,a=n.length,o,l,c;r<a;r++)l=n[r],o=r!==a-1?l.lastIndexOf(","):l.length,c=l.substr(0,o),t[s]=isNaN(c)?c.replace(sE,"").trim():+c,s=l.substr(o+1).trim();return t},aE=function(e){var t=e.indexOf("(")+1,n=e.indexOf(")"),s=e.indexOf("(",t);return e.substring(t,~s&&s<n?e.indexOf(")",n+1):n)},oE=function(e){var t=(e+"").split("("),n=We[t[0]];return n&&t.length>1&&n.config?n.config.apply(null,~e.indexOf("{")?[rE(t[1])]:aE(e).split(",").map(af)):We._CE&&iE.test(e)?We._CE("",e):n},Tf=function(e){return function(t){return 1-e(1-t)}},Af=function i(e,t){for(var n=e._first,s;n;)n instanceof Jt?i(n,t):n.vars.yoyoEase&&(!n._yoyo||!n._repeat)&&n._yoyo!==t&&(n.timeline?i(n.timeline,t):(s=n._ease,n._ease=n._yEase,n._yEase=s,n._yoyo=t)),n=n._next},cs=function(e,t){return e&&(ft(e)?e:We[e]||oE(e))||t},gs=function(e,t,n,s){n===void 0&&(n=function(l){return 1-t(1-l)}),s===void 0&&(s=function(l){return l<.5?t(l*2)/2:1-t((1-l)*2)/2});var r={easeIn:t,easeOut:n,easeInOut:s},a;return en(e,function(o){We[o]=hn[o]=r,We[a=o.toLowerCase()]=n;for(var l in r)We[a+(l==="easeIn"?".in":l==="easeOut"?".out":".inOut")]=We[o+"."+l]=r[l]}),r},bf=function(e){return function(t){return t<.5?(1-e(1-t*2))/2:.5+e((t-.5)*2)/2}},el=function i(e,t,n){var s=t>=1?t:1,r=(n||(e?.3:.45))/(t<1?t:1),a=r/Sl*(Math.asin(1/s)||0),o=function(u){return u===1?1:s*Math.pow(2,-10*u)*OM((u-a)*r)+1},l=e==="out"?o:e==="in"?function(c){return 1-o(1-c)}:bf(o);return r=Sl/r,l.config=function(c,u){return i(e,c,u)},l},tl=function i(e,t){t===void 0&&(t=1.70158);var n=function(a){return a?--a*a*((t+1)*a+t)+1:0},s=e==="out"?n:e==="in"?function(r){return 1-n(1-r)}:bf(n);return s.config=function(r){return i(e,r)},s};en("Linear,Quad,Cubic,Quart,Quint,Strong",function(i,e){var t=e<5?e+1:e;gs(i+",Power"+(t-1),e?function(n){return Math.pow(n,t)}:function(n){return n},function(n){return 1-Math.pow(1-n,t)},function(n){return n<.5?Math.pow(n*2,t)/2:1-Math.pow((1-n)*2,t)/2})});We.Linear.easeNone=We.none=We.Linear.easeIn;gs("Elastic",el("in"),el("out"),el());(function(i,e){var t=1/e,n=2*t,s=2.5*t,r=function(o){return o<t?i*o*o:o<n?i*Math.pow(o-1.5/e,2)+.75:o<s?i*(o-=2.25/e)*o+.9375:i*Math.pow(o-2.625/e,2)+.984375};gs("Bounce",function(a){return 1-r(1-a)},r)})(7.5625,2.75);gs("Expo",function(i){return i?Math.pow(2,10*(i-1)):0});gs("Circ",function(i){return-(jd(1-i*i)-1)});gs("Sine",function(i){return i===1?1:-UM(i*DM)+1});gs("Back",tl("in"),tl("out"),tl());We.SteppedEase=We.steps=hn.SteppedEase={config:function(e,t){e===void 0&&(e=1);var n=1/e,s=e+(t?0:1),r=t?1:0,a=1-Qe;return function(o){return((s*Jr(0,a,o)|0)+r)*n}}};sr.ease=We["quad.out"];en("onComplete,onUpdate,onStart,onRepeat,onReverseComplete,onInterrupt",function(i){return oc+=i+","+i+"Params,"});var wf=function(e,t){this.id=IM++,e._gsap=this,this.target=e,this.harness=t,this.get=t?t.get:sf,this.set=t?t.getSetter:dc},Hr=function(){function i(t){this.vars=t,this._delay=+t.delay||0,(this._repeat=t.repeat===1/0?-2:t.repeat||0)&&(this._rDelay=t.repeatDelay||0,this._yoyo=!!t.yoyo||!!t.yoyoEase),this._ts=1,ar(this,+t.duration,1,1),this.data=t.data,ut&&(this._ctx=ut,ut.data.push(this)),kr||ln.wake()}var e=i.prototype;return e.delay=function(n){return n||n===0?(this.parent&&this.parent.smoothChildTiming&&this.startTime(this._start+n-this._delay),this._delay=n,this):this._delay},e.duration=function(n){return arguments.length?this.totalDuration(this._repeat>0?n+(n+this._rDelay)*this._repeat:n):this.totalDuration()&&this._dur},e.totalDuration=function(n){return arguments.length?(this._dirty=0,ar(this,this._repeat<0?n:(n-this._repeat*this._rDelay)/(this._repeat+1))):this._tDur},e.totalTime=function(n,s){if(or(),!arguments.length)return this._tTime;var r=this._dp;if(r&&r.smoothChildTiming&&this._ts){for(so(this,n),!r._dp||r.parent||cf(r,this);r&&r.parent;)r.parent._time!==r._start+(r._ts>=0?r._tTime/r._ts:(r.totalDuration()-r._tTime)/-r._ts)&&r.totalTime(r._tTime,!0),r=r.parent;!this.parent&&this._dp.autoRemoveChildren&&(this._ts>0&&n<this._tDur||this._ts<0&&n>0||!this._tDur&&!n)&&zn(this._dp,this,this._start-this._delay)}return(this._tTime!==n||!this._dur&&!s||this._initted&&Math.abs(this._zTime)===Qe||!n&&!this._initted&&(this.add||this._ptLookup))&&(this._ts||(this._pTime=n),rf(this,n,s)),this},e.time=function(n,s){return arguments.length?this.totalTime(Math.min(this.totalDuration(),n+Rh(this))%(this._dur+this._rDelay)||(n?this._dur:0),s):this._time},e.totalProgress=function(n,s){return arguments.length?this.totalTime(this.totalDuration()*n,s):this.totalDuration()?Math.min(1,this._tTime/this._tDur):this.ratio},e.progress=function(n,s){return arguments.length?this.totalTime(this.duration()*(this._yoyo&&!(this.iteration()&1)?1-n:n)+Rh(this),s):this.duration()?Math.min(1,this._time/this._dur):this.ratio},e.iteration=function(n,s){var r=this.duration()+this._rDelay;return arguments.length?this.totalTime(this._time+(n-1)*r,s):this._repeat?rr(this._tTime,r)+1:1},e.timeScale=function(n){if(!arguments.length)return this._rts===-Qe?0:this._rts;if(this._rts===n)return this;var s=this.parent&&this._ts?Xa(this.parent._time,this):this._tTime;return this._rts=+n||0,this._ts=this._ps||n===-Qe?0:this._rts,this.totalTime(Jr(-Math.abs(this._delay),this._tDur,s),!0),io(this),VM(this)},e.paused=function(n){return arguments.length?(this._ps!==n&&(this._ps=n,n?(this._pTime=this._tTime||Math.max(-this._delay,this.rawTime()),this._ts=this._act=0):(or(),this._ts=this._rts,this.totalTime(this.parent&&!this.parent.smoothChildTiming?this.rawTime():this._tTime||this._pTime,this.progress()===1&&Math.abs(this._zTime)!==Qe&&(this._tTime-=Qe)))),this):this._ps},e.startTime=function(n){if(arguments.length){this._start=n;var s=this.parent||this._dp;return s&&(s._sort||!this.parent)&&zn(s,this,n-this._delay),this}return this._start},e.endTime=function(n){return this._start+(Qt(n)?this.totalDuration():this.duration())/Math.abs(this._ts||1)},e.rawTime=function(n){var s=this.parent||this._dp;return s?n&&(!this._ts||this._repeat&&this._time&&this.totalProgress()<1)?this._tTime%(this._dur+this._rDelay):this._ts?Xa(s.rawTime(n),this):this._tTime:this._tTime},e.revert=function(n){n===void 0&&(n=BM);var s=Xt;return Xt=n,(this._initted||this._startAt)&&(this.timeline&&this.timeline.revert(n),this.totalTime(-.01,n.suppressEvents)),this.data!=="nested"&&n.kill!==!1&&this.kill(),Xt=s,this},e.globalTime=function(n){for(var s=this,r=arguments.length?n:s.rawTime();s;)r=s._start+r/(s._ts||1),s=s._dp;return!this.parent&&this._sat?this._sat.vars.immediateRender?-1/0:this._sat.globalTime(n):r},e.repeat=function(n){return arguments.length?(this._repeat=n===1/0?-2:n,Ch(this)):this._repeat===-2?1/0:this._repeat},e.repeatDelay=function(n){if(arguments.length){var s=this._time;return this._rDelay=n,Ch(this),s?this.time(s):this}return this._rDelay},e.yoyo=function(n){return arguments.length?(this._yoyo=n,this):this._yoyo},e.seek=function(n,s){return this.totalTime(pn(this,n),Qt(s))},e.restart=function(n,s){return this.play().totalTime(n?-this._delay:0,Qt(s))},e.play=function(n,s){return n!=null&&this.seek(n,s),this.reversed(!1).paused(!1)},e.reverse=function(n,s){return n!=null&&this.seek(n||this.totalDuration(),s),this.reversed(!0).paused(!1)},e.pause=function(n,s){return n!=null&&this.seek(n,s),this.paused(!0)},e.resume=function(){return this.paused(!1)},e.reversed=function(n){return arguments.length?(!!n!==this.reversed()&&this.timeScale(-this._rts||(n?-Qe:0)),this):this._rts<0},e.invalidate=function(){return this._initted=this._act=0,this._zTime=-Qe,this},e.isActive=function(){var n=this.parent||this._dp,s=this._start,r;return!!(!n||this._ts&&this._initted&&n.isActive()&&(r=n.rawTime(!0))>=s&&r<this.endTime(!0)-Qe)},e.eventCallback=function(n,s,r){var a=this.vars;return arguments.length>1?(s?(a[n]=s,r&&(a[n+"Params"]=r),n==="onUpdate"&&(this._onUpdate=s)):delete a[n],this):a[n]},e.then=function(n){var s=this;return new Promise(function(r){var a=ft(n)?n:of,o=function(){var c=s.then;s.then=null,ft(a)&&(a=a(s))&&(a.then||a===s)&&(s.then=c),r(a),s.then=c};s._initted&&s.totalProgress()===1&&s._ts>=0||!s._tTime&&s._ts<0?o():s._prom=o})},e.kill=function(){wr(this)},i}();Tn(Hr.prototype,{_time:0,_start:0,_end:0,_tTime:0,_tDur:0,_dirty:0,_repeat:0,_yoyo:!1,parent:null,_initted:!1,_rDelay:0,_ts:1,_dp:0,ratio:0,_zTime:-Qe,_prom:0,_ps:!1,_rts:1});var Jt=function(i){Yd(e,i);function e(n,s){var r;return n===void 0&&(n={}),r=i.call(this,n)||this,r.labels={},r.smoothChildTiming=!!n.smoothChildTiming,r.autoRemoveChildren=!!n.autoRemoveChildren,r._sort=Qt(n.sortChildren),st&&zn(n.parent||st,ai(r),s),n.reversed&&r.reverse(),n.paused&&r.paused(!0),n.scrollTrigger&&uf(ai(r),n.scrollTrigger),r}var t=e.prototype;return t.to=function(s,r,a){return Ur(0,arguments,this),this},t.from=function(s,r,a){return Ur(1,arguments,this),this},t.fromTo=function(s,r,a,o){return Ur(2,arguments,this),this},t.set=function(s,r,a){return r.duration=0,r.parent=this,Ir(r).repeatDelay||(r.repeat=0),r.immediateRender=!!r.immediateRender,new yt(s,r,pn(this,a),1),this},t.call=function(s,r,a){return zn(this,yt.delayedCall(0,s,r),a)},t.staggerTo=function(s,r,a,o,l,c,u){return a.duration=r,a.stagger=a.stagger||o,a.onComplete=c,a.onCompleteParams=u,a.parent=this,new yt(s,a,pn(this,l)),this},t.staggerFrom=function(s,r,a,o,l,c,u){return a.runBackwards=1,Ir(a).immediateRender=Qt(a.immediateRender),this.staggerTo(s,r,a,o,l,c,u)},t.staggerFromTo=function(s,r,a,o,l,c,u,h){return o.startAt=a,Ir(o).immediateRender=Qt(o.immediateRender),this.staggerTo(s,r,o,l,c,u,h)},t.render=function(s,r,a){var o=this._time,l=this._dirty?this.totalDuration():this._tDur,c=this._dur,u=s<=0?0:zt(s),h=this._zTime<0!=s<0&&(this._initted||!c),d,p,_,g,m,f,y,v,S,M,w,T;if(this!==st&&u>l&&s>=0&&(u=l),u!==this._tTime||a||h){if(o!==this._time&&c&&(u+=this._time-o,s+=this._time-o),d=u,S=this._start,v=this._ts,f=!v,h&&(c||(o=this._zTime),(s||!r)&&(this._zTime=s)),this._repeat){if(w=this._yoyo,m=c+this._rDelay,this._repeat<-1&&s<0)return this.totalTime(m*100+s,r,a);if(d=zt(u%m),u===l?(g=this._repeat,d=c):(g=~~(u/m),g&&g===u/m&&(d=c,g--),d>c&&(d=c)),M=rr(this._tTime,m),!o&&this._tTime&&M!==g&&this._tTime-M*m-this._dur<=0&&(M=g),w&&g&1&&(d=c-d,T=1),g!==M&&!this._lock){var C=w&&M&1,x=C===(w&&g&1);if(g<M&&(C=!C),o=C?0:u%c?c:u,this._lock=1,this.render(o||(T?0:zt(g*m)),r,!c)._lock=0,this._tTime=u,!r&&this.parent&&Sn(this,"onRepeat"),this.vars.repeatRefresh&&!T&&(this.invalidate()._lock=1),o&&o!==this._time||f!==!this._ts||this.vars.onRepeat&&!this.parent&&!this._act)return this;if(c=this._dur,l=this._tDur,x&&(this._lock=2,o=C?c:-1e-4,this.render(o,!0),this.vars.repeatRefresh&&!T&&this.invalidate()),this._lock=0,!this._ts&&!f)return this;Af(this,T)}}if(this._hasPause&&!this._forcing&&this._lock<2&&(y=qM(this,zt(o),zt(d)),y&&(u-=d-(d=y._start))),this._tTime=u,this._time=d,this._act=!v,this._initted||(this._onUpdate=this.vars.onUpdate,this._initted=1,this._zTime=s,o=0),!o&&d&&!r&&!g&&(Sn(this,"onStart"),this._tTime!==u))return this;if(d>=o&&s>=0)for(p=this._first;p;){if(_=p._next,(p._act||d>=p._start)&&p._ts&&y!==p){if(p.parent!==this)return this.render(s,r,a);if(p.render(p._ts>0?(d-p._start)*p._ts:(p._dirty?p.totalDuration():p._tDur)+(d-p._start)*p._ts,r,a),d!==this._time||!this._ts&&!f){y=0,_&&(u+=this._zTime=-Qe);break}}p=_}else{p=this._last;for(var A=s<0?s:d;p;){if(_=p._prev,(p._act||A<=p._end)&&p._ts&&y!==p){if(p.parent!==this)return this.render(s,r,a);if(p.render(p._ts>0?(A-p._start)*p._ts:(p._dirty?p.totalDuration():p._tDur)+(A-p._start)*p._ts,r,a||Xt&&(p._initted||p._startAt)),d!==this._time||!this._ts&&!f){y=0,_&&(u+=this._zTime=A?-Qe:Qe);break}}p=_}}if(y&&!r&&(this.pause(),y.render(d>=o?0:-Qe)._zTime=d>=o?1:-1,this._ts))return this._start=S,io(this),this.render(s,r,a);this._onUpdate&&!r&&Sn(this,"onUpdate",!0),(u===l&&this._tTime>=this.totalDuration()||!u&&o)&&(S===this._start||Math.abs(v)!==Math.abs(this._ts))&&(this._lock||((s||!c)&&(u===l&&this._ts>0||!u&&this._ts<0)&&Bi(this,1),!r&&!(s<0&&!o)&&(u||o||!l)&&(Sn(this,u===l&&s>=0?"onComplete":"onReverseComplete",!0),this._prom&&!(u<l&&this.timeScale()>0)&&this._prom())))}return this},t.add=function(s,r){var a=this;if(fi(r)||(r=pn(this,r,s)),!(s instanceof Hr)){if(qt(s))return s.forEach(function(o){return a.add(o,r)}),this;if(Ut(s))return this.addLabel(s,r);if(ft(s))s=yt.delayedCall(0,s);else return this}return this!==s?zn(this,s,r):this},t.getChildren=function(s,r,a,o){s===void 0&&(s=!0),r===void 0&&(r=!0),a===void 0&&(a=!0),o===void 0&&(o=-xn);for(var l=[],c=this._first;c;)c._start>=o&&(c instanceof yt?r&&l.push(c):(a&&l.push(c),s&&l.push.apply(l,c.getChildren(!0,r,a)))),c=c._next;return l},t.getById=function(s){for(var r=this.getChildren(1,1,1),a=r.length;a--;)if(r[a].vars.id===s)return r[a]},t.remove=function(s){return Ut(s)?this.removeLabel(s):ft(s)?this.killTweensOf(s):(no(this,s),s===this._recent&&(this._recent=this._last),ls(this))},t.totalTime=function(s,r){return arguments.length?(this._forcing=1,!this._dp&&this._ts&&(this._start=zt(ln.time-(this._ts>0?s/this._ts:(this.totalDuration()-s)/-this._ts))),i.prototype.totalTime.call(this,s,r),this._forcing=0,this):this._tTime},t.addLabel=function(s,r){return this.labels[s]=pn(this,r),this},t.removeLabel=function(s){return delete this.labels[s],this},t.addPause=function(s,r,a){var o=yt.delayedCall(0,r||Br,a);return o.data="isPause",this._hasPause=1,zn(this,o,pn(this,s))},t.removePause=function(s){var r=this._first;for(s=pn(this,s);r;)r._start===s&&r.data==="isPause"&&Bi(r),r=r._next},t.killTweensOf=function(s,r,a){for(var o=this.getTweensOf(s,a),l=o.length;l--;)Ci!==o[l]&&o[l].kill(s,r);return this},t.getTweensOf=function(s,r){for(var a=[],o=yn(s),l=this._first,c=fi(r),u;l;)l instanceof yt?zM(l._targets,o)&&(c?(!Ci||l._initted&&l._ts)&&l.globalTime(0)<=r&&l.globalTime(l.totalDuration())>r:!r||l.isActive())&&a.push(l):(u=l.getTweensOf(o,r)).length&&a.push.apply(a,u),l=l._next;return a},t.tweenTo=function(s,r){r=r||{};var a=this,o=pn(a,s),l=r,c=l.startAt,u=l.onStart,h=l.onStartParams,d=l.immediateRender,p,_=yt.to(a,Tn({ease:r.ease||"none",lazy:!1,immediateRender:!1,time:o,overwrite:"auto",duration:r.duration||Math.abs((o-(c&&"time"in c?c.time:a._time))/a.timeScale())||Qe,onStart:function(){if(a.pause(),!p){var m=r.duration||Math.abs((o-(c&&"time"in c?c.time:a._time))/a.timeScale());_._dur!==m&&ar(_,m,0,1).render(_._time,!0,!0),p=1}u&&u.apply(_,h||[])}},r));return d?_.render(0):_},t.tweenFromTo=function(s,r,a){return this.tweenTo(r,Tn({startAt:{time:pn(this,s)}},a))},t.recent=function(){return this._recent},t.nextLabel=function(s){return s===void 0&&(s=this._time),Ph(this,pn(this,s))},t.previousLabel=function(s){return s===void 0&&(s=this._time),Ph(this,pn(this,s),1)},t.currentLabel=function(s){return arguments.length?this.seek(s,!0):this.previousLabel(this._time+Qe)},t.shiftChildren=function(s,r,a){a===void 0&&(a=0);for(var o=this._first,l=this.labels,c;o;)o._start>=a&&(o._start+=s,o._end+=s),o=o._next;if(r)for(c in l)l[c]>=a&&(l[c]+=s);return ls(this)},t.invalidate=function(s){var r=this._first;for(this._lock=0;r;)r.invalidate(s),r=r._next;return i.prototype.invalidate.call(this,s)},t.clear=function(s){s===void 0&&(s=!0);for(var r=this._first,a;r;)a=r._next,this.remove(r),r=a;return this._dp&&(this._time=this._tTime=this._pTime=0),s&&(this.labels={}),ls(this)},t.totalDuration=function(s){var r=0,a=this,o=a._last,l=xn,c,u,h;if(arguments.length)return a.timeScale((a._repeat<0?a.duration():a.totalDuration())/(a.reversed()?-s:s));if(a._dirty){for(h=a.parent;o;)c=o._prev,o._dirty&&o.totalDuration(),u=o._start,u>l&&a._sort&&o._ts&&!a._lock?(a._lock=1,zn(a,o,u-o._delay,1)._lock=0):l=u,u<0&&o._ts&&(r-=u,(!h&&!a._dp||h&&h.smoothChildTiming)&&(a._start+=u/a._ts,a._time-=u,a._tTime-=u),a.shiftChildren(-u,!1,-1/0),l=0),o._end>r&&o._ts&&(r=o._end),o=c;ar(a,a===st&&a._time>r?a._time:r,1,1),a._dirty=0}return a._tDur},e.updateRoot=function(s){if(st._ts&&(rf(st,Xa(s,st)),nf=ln.frame),ln.frame>=bh){bh+=un.autoSleep||120;var r=st._first;if((!r||!r._ts)&&un.autoSleep&&ln._listeners.length<2){for(;r&&!r._ts;)r=r._next;r||ln.sleep()}}},e}(Hr);Tn(Jt.prototype,{_lock:0,_hasPause:0,_forcing:0});var lE=function(e,t,n,s,r,a,o){var l=new tn(this._pt,e,t,0,1,If,null,r),c=0,u=0,h,d,p,_,g,m,f,y;for(l.b=n,l.e=s,n+="",s+="",(f=~s.indexOf("random("))&&(s=zr(s)),a&&(y=[n,s],a(y,e,t),n=y[0],s=y[1]),d=n.match(Zo)||[];h=Zo.exec(s);)_=h[0],g=s.substring(c,h.index),p?p=(p+1)%5:g.substr(-5)==="rgba("&&(p=1),_!==d[u++]&&(m=parseFloat(d[u-1])||0,l._pt={_next:l._pt,p:g||u===1?g:",",s:m,c:_.charAt(1)==="="?Xs(m,_)-m:parseFloat(_)-m,m:p&&p<4?Math.round:0},c=Zo.lastIndex);return l.c=c<s.length?s.substring(c,s.length):"",l.fp=o,(Zd.test(s)||f)&&(l.e=0),this._pt=l,l},cc=function(e,t,n,s,r,a,o,l,c,u){ft(s)&&(s=s(r||0,e,a));var h=e[t],d=n!=="get"?n:ft(h)?c?e[t.indexOf("set")||!ft(e["get"+t.substr(3)])?t:"get"+t.substr(3)](c):e[t]():h,p=ft(h)?c?fE:Lf:hc,_;if(Ut(s)&&(~s.indexOf("random(")&&(s=zr(s)),s.charAt(1)==="="&&(_=Xs(d,s)+(Gt(d)||0),(_||_===0)&&(s=_))),!u||d!==s||Pl)return!isNaN(d*s)&&s!==""?(_=new tn(this._pt,e,t,+d||0,s-(d||0),typeof h=="boolean"?mE:Df,0,p),c&&(_.fp=c),o&&_.modifier(o,this,e),this._pt=_):(!h&&!(t in e)&&rc(t,s),lE.call(this,e,t,d,s,p,l||un.stringFilter,c))},cE=function(e,t,n,s,r){if(ft(e)&&(e=Or(e,r,t,n,s)),!qn(e)||e.style&&e.nodeType||qt(e)||Kd(e))return Ut(e)?Or(e,r,t,n,s):e;var a={},o;for(o in e)a[o]=Or(e[o],r,t,n,s);return a},Rf=function(e,t,n,s,r,a){var o,l,c,u;if(on[e]&&(o=new on[e]).init(r,o.rawVars?t[e]:cE(t[e],s,r,a,n),n,s,a)!==!1&&(n._pt=l=new tn(n._pt,r,e,0,1,o.render,o,0,o.priority),n!==Hs))for(c=n._ptLookup[n._targets.indexOf(r)],u=o._props.length;u--;)c[o._props[u]]=l;return o},Ci,Pl,uc=function i(e,t,n){var s=e.vars,r=s.ease,a=s.startAt,o=s.immediateRender,l=s.lazy,c=s.onUpdate,u=s.onUpdateParams,h=s.callbackScope,d=s.runBackwards,p=s.yoyoEase,_=s.keyframes,g=s.autoRevert,m=e._dur,f=e._startAt,y=e._targets,v=e.parent,S=v&&v.data==="nested"?v.vars.targets:y,M=e._overwrite==="auto"&&!tc,w=e.timeline,T,C,x,A,W,q,I,O,N,$,V,Y,Q;if(w&&(!_||!r)&&(r="none"),e._ease=cs(r,sr.ease),e._yEase=p?Tf(cs(p===!0?r:p,sr.ease)):0,p&&e._yoyo&&!e._repeat&&(p=e._yEase,e._yEase=e._ease,e._ease=p),e._from=!w&&!!s.runBackwards,!w||_&&!s.stagger){if(O=y[0]?os(y[0]).harness:0,Y=O&&s[O.prop],T=Wa(s,ac),f&&(f._zTime<0&&f.progress(1),t<0&&d&&o&&!g?f.render(-1,!0):f.revert(d&&m?Da:FM),f._lazy=0),a){if(Bi(e._startAt=yt.set(y,Tn({data:"isStart",overwrite:!1,parent:v,immediateRender:!0,lazy:!f&&Qt(l),startAt:null,delay:0,onUpdate:c,onUpdateParams:u,callbackScope:h,stagger:0},a))),e._startAt._dp=0,e._startAt._sat=e,t<0&&(Xt||!o&&!g)&&e._startAt.revert(Da),o&&m&&t<=0&&n<=0){t&&(e._zTime=t);return}}else if(d&&m&&!f){if(t&&(o=!1),x=Tn({overwrite:!1,data:"isFromStart",lazy:o&&!f&&Qt(l),immediateRender:o,stagger:0,parent:v},T),Y&&(x[O.prop]=Y),Bi(e._startAt=yt.set(y,x)),e._startAt._dp=0,e._startAt._sat=e,t<0&&(Xt?e._startAt.revert(Da):e._startAt.render(-1,!0)),e._zTime=t,!o)i(e._startAt,Qe,Qe);else if(!t)return}for(e._pt=e._ptCache=0,l=m&&Qt(l)||l&&!m,C=0;C<y.length;C++){if(W=y[C],I=W._gsap||lc(y)[C]._gsap,e._ptLookup[C]=$={},Tl[I.id]&&Ui.length&&Ga(),V=S===y?C:S.indexOf(W),O&&(N=new O).init(W,Y||T,e,V,S)!==!1&&(e._pt=A=new tn(e._pt,W,N.name,0,1,N.render,N,0,N.priority),N._props.forEach(function(Z){$[Z]=A}),N.priority&&(q=1)),!O||Y)for(x in T)on[x]&&(N=Rf(x,T,e,V,W,S))?N.priority&&(q=1):$[x]=A=cc.call(e,W,x,"get",T[x],V,S,0,s.stringFilter);e._op&&e._op[C]&&e.kill(W,e._op[C]),M&&e._pt&&(Ci=e,st.killTweensOf(W,$,e.globalTime(t)),Q=!e.parent,Ci=0),e._pt&&l&&(Tl[I.id]=1)}q&&Uf(e),e._onInit&&e._onInit(e)}e._onUpdate=c,e._initted=(!e._op||e._pt)&&!Q,_&&t<=0&&w.render(xn,!0,!0)},uE=function(e,t,n,s,r,a,o){var l=(e._pt&&e._ptCache||(e._ptCache={}))[t],c,u,h,d;if(!l)for(l=e._ptCache[t]=[],h=e._ptLookup,d=e._targets.length;d--;){if(c=h[d][t],c&&c.d&&c.d._pt)for(c=c.d._pt;c&&c.p!==t&&c.fp!==t;)c=c._next;if(!c)return Pl=1,e.vars[t]="+=0",uc(e,o),Pl=0,1;l.push(c)}for(d=l.length;d--;)u=l[d],c=u._pt||u,c.s=(s||s===0)&&!r?s:c.s+(s||0)+a*c.c,c.c=n-c.s,u.e&&(u.e=mt(n)+Gt(u.e)),u.b&&(u.b=c.s+Gt(u.b))},hE=function(e,t){var n=e[0]?os(e[0]).harness:0,s=n&&n.aliases,r,a,o,l;if(!s)return t;r=ps({},t);for(a in s)if(a in r)for(l=s[a].split(","),o=l.length;o--;)r[l[o]]=r[a];return r},dE=function(e,t,n,s){var r=t.ease||s||"power1.inOut",a,o;if(qt(t))o=n[e]||(n[e]=[]),t.forEach(function(l,c){return o.push({t:c/(t.length-1)*100,v:l,e:r})});else for(a in t)o=n[a]||(n[a]=[]),a==="ease"||o.push({t:parseFloat(e),v:t[a],e:r})},Or=function(e,t,n,s,r){return ft(e)?e.call(t,n,s,r):Ut(e)&&~e.indexOf("random(")?zr(e):e},Cf=oc+"repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,autoRevert",Pf={};en(Cf+",id,stagger,delay,duration,paused,scrollTrigger",function(i){return Pf[i]=1});var yt=function(i){Yd(e,i);function e(n,s,r,a){var o;typeof s=="number"&&(r.duration=s,s=r,r=null),o=i.call(this,a?s:Ir(s))||this;var l=o.vars,c=l.duration,u=l.delay,h=l.immediateRender,d=l.stagger,p=l.overwrite,_=l.keyframes,g=l.defaults,m=l.scrollTrigger,f=l.yoyoEase,y=s.parent||st,v=(qt(n)||Kd(n)?fi(n[0]):"length"in s)?[n]:yn(n),S,M,w,T,C,x,A,W;if(o._targets=v.length?lc(v):Va("GSAP target "+n+" not found. https://greensock.com",!un.nullTargetWarn)||[],o._ptLookup=[],o._overwrite=p,_||d||Ra(c)||Ra(u)){if(s=o.vars,S=o.timeline=new Jt({data:"nested",defaults:g||{},targets:y&&y.data==="nested"?y.vars.targets:v}),S.kill(),S.parent=S._dp=ai(o),S._start=0,d||Ra(c)||Ra(u)){if(T=v.length,A=d&&pf(d),qn(d))for(C in d)~Cf.indexOf(C)&&(W||(W={}),W[C]=d[C]);for(M=0;M<T;M++)w=Wa(s,Pf),w.stagger=0,f&&(w.yoyoEase=f),W&&ps(w,W),x=v[M],w.duration=+Or(c,ai(o),M,x,v),w.delay=(+Or(u,ai(o),M,x,v)||0)-o._delay,!d&&T===1&&w.delay&&(o._delay=u=w.delay,o._start+=u,w.delay=0),S.to(x,w,A?A(M,x,v):0),S._ease=We.none;S.duration()?c=u=0:o.timeline=0}else if(_){Ir(Tn(S.vars.defaults,{ease:"none"})),S._ease=cs(_.ease||s.ease||"none");var q=0,I,O,N;if(qt(_))_.forEach(function($){return S.to(v,$,">")}),S.duration();else{w={};for(C in _)C==="ease"||C==="easeEach"||dE(C,_[C],w,_.easeEach);for(C in w)for(I=w[C].sort(function($,V){return $.t-V.t}),q=0,M=0;M<I.length;M++)O=I[M],N={ease:O.e,duration:(O.t-(M?I[M-1].t:0))/100*c},N[C]=O.v,S.to(v,N,q),q+=N.duration;S.duration()<c&&S.to({},{duration:c-S.duration()})}}c||o.duration(c=S.duration())}else o.timeline=0;return p===!0&&!tc&&(Ci=ai(o),st.killTweensOf(v),Ci=0),zn(y,ai(o),r),s.reversed&&o.reverse(),s.paused&&o.paused(!0),(h||!c&&!_&&o._start===zt(y._time)&&Qt(h)&&GM(ai(o))&&y.data!=="nested")&&(o._tTime=-Qe,o.render(Math.max(0,-u)||0)),m&&uf(ai(o),m),o}var t=e.prototype;return t.render=function(s,r,a){var o=this._time,l=this._tDur,c=this._dur,u=s<0,h=s>l-Qe&&!u?l:s<Qe?0:s,d,p,_,g,m,f,y,v,S;if(!c)XM(this,s,r,a);else if(h!==this._tTime||!s||a||!this._initted&&this._tTime||this._startAt&&this._zTime<0!==u){if(d=h,v=this.timeline,this._repeat){if(g=c+this._rDelay,this._repeat<-1&&u)return this.totalTime(g*100+s,r,a);if(d=zt(h%g),h===l?(_=this._repeat,d=c):(_=~~(h/g),_&&_===h/g&&(d=c,_--),d>c&&(d=c)),f=this._yoyo&&_&1,f&&(S=this._yEase,d=c-d),m=rr(this._tTime,g),d===o&&!a&&this._initted)return this._tTime=h,this;_!==m&&(v&&this._yEase&&Af(v,f),this.vars.repeatRefresh&&!f&&!this._lock&&(this._lock=a=1,this.render(zt(g*_),!0).invalidate()._lock=0))}if(!this._initted){if(hf(this,u?s:d,a,r,h))return this._tTime=0,this;if(o!==this._time)return this;if(c!==this._dur)return this.render(s,r,a)}if(this._tTime=h,this._time=d,!this._act&&this._ts&&(this._act=1,this._lazy=0),this.ratio=y=(S||this._ease)(d/c),this._from&&(this.ratio=y=1-y),d&&!o&&!r&&!_&&(Sn(this,"onStart"),this._tTime!==h))return this;for(p=this._pt;p;)p.r(y,p.d),p=p._next;v&&v.render(s<0?s:!d&&f?-Qe:v._dur*v._ease(d/this._dur),r,a)||this._startAt&&(this._zTime=s),this._onUpdate&&!r&&(u&&Al(this,s,r,a),Sn(this,"onUpdate")),this._repeat&&_!==m&&this.vars.onRepeat&&!r&&this.parent&&Sn(this,"onRepeat"),(h===this._tDur||!h)&&this._tTime===h&&(u&&!this._onUpdate&&Al(this,s,!0,!0),(s||!c)&&(h===this._tDur&&this._ts>0||!h&&this._ts<0)&&Bi(this,1),!r&&!(u&&!o)&&(h||o||f)&&(Sn(this,h===l?"onComplete":"onReverseComplete",!0),this._prom&&!(h<l&&this.timeScale()>0)&&this._prom()))}return this},t.targets=function(){return this._targets},t.invalidate=function(s){return(!s||!this.vars.runBackwards)&&(this._startAt=0),this._pt=this._op=this._onUpdate=this._lazy=this.ratio=0,this._ptLookup=[],this.timeline&&this.timeline.invalidate(s),i.prototype.invalidate.call(this,s)},t.resetTo=function(s,r,a,o){kr||ln.wake(),this._ts||this.play();var l=Math.min(this._dur,(this._dp._time-this._start)*this._ts),c;return this._initted||uc(this,l),c=this._ease(l/this._dur),uE(this,s,r,a,o,c,l)?this.resetTo(s,r,a,o):(so(this,0),this.parent||lf(this._dp,this,"_first","_last",this._dp._sort?"_start":0),this.render(0))},t.kill=function(s,r){if(r===void 0&&(r="all"),!s&&(!r||r==="all"))return this._lazy=this._pt=0,this.parent?wr(this):this;if(this.timeline){var a=this.timeline.totalDuration();return this.timeline.killTweensOf(s,r,Ci&&Ci.vars.overwrite!==!0)._first||wr(this),this.parent&&a!==this.timeline.totalDuration()&&ar(this,this._dur*this.timeline._tDur/a,0,1),this}var o=this._targets,l=s?yn(s):o,c=this._ptLookup,u=this._pt,h,d,p,_,g,m,f;if((!r||r==="all")&&HM(o,l))return r==="all"&&(this._pt=0),wr(this);for(h=this._op=this._op||[],r!=="all"&&(Ut(r)&&(g={},en(r,function(y){return g[y]=1}),r=g),r=hE(o,r)),f=o.length;f--;)if(~l.indexOf(o[f])){d=c[f],r==="all"?(h[f]=r,_=d,p={}):(p=h[f]=h[f]||{},_=r);for(g in _)m=d&&d[g],m&&((!("kill"in m.d)||m.d.kill(g)===!0)&&no(this,m,"_pt"),delete d[g]),p!=="all"&&(p[g]=1)}return this._initted&&!this._pt&&u&&wr(this),this},e.to=function(s,r){return new e(s,r,arguments[2])},e.from=function(s,r){return Ur(1,arguments)},e.delayedCall=function(s,r,a,o){return new e(r,0,{immediateRender:!1,lazy:!1,overwrite:!1,delay:s,onComplete:r,onReverseComplete:r,onCompleteParams:a,onReverseCompleteParams:a,callbackScope:o})},e.fromTo=function(s,r,a){return Ur(2,arguments)},e.set=function(s,r){return r.duration=0,r.repeatDelay||(r.repeat=0),new e(s,r)},e.killTweensOf=function(s,r,a){return st.killTweensOf(s,r,a)},e}(Hr);Tn(yt.prototype,{_targets:[],_lazy:0,_startAt:0,_op:0,_onInit:0});en("staggerTo,staggerFrom,staggerFromTo",function(i){yt[i]=function(){var e=new Jt,t=wl.call(arguments,0);return t.splice(i==="staggerFromTo"?5:4,0,0),e[i].apply(e,t)}});var hc=function(e,t,n){return e[t]=n},Lf=function(e,t,n){return e[t](n)},fE=function(e,t,n,s){return e[t](s.fp,n)},pE=function(e,t,n){return e.setAttribute(t,n)},dc=function(e,t){return ft(e[t])?Lf:nc(e[t])&&e.setAttribute?pE:hc},Df=function(e,t){return t.set(t.t,t.p,Math.round((t.s+t.c*e)*1e6)/1e6,t)},mE=function(e,t){return t.set(t.t,t.p,!!(t.s+t.c*e),t)},If=function(e,t){var n=t._pt,s="";if(!e&&t.b)s=t.b;else if(e===1&&t.e)s=t.e;else{for(;n;)s=n.p+(n.m?n.m(n.s+n.c*e):Math.round((n.s+n.c*e)*1e4)/1e4)+s,n=n._next;s+=t.c}t.set(t.t,t.p,s,t)},fc=function(e,t){for(var n=t._pt;n;)n.r(e,n.d),n=n._next},gE=function(e,t,n,s){for(var r=this._pt,a;r;)a=r._next,r.p===s&&r.modifier(e,t,n),r=a},_E=function(e){for(var t=this._pt,n,s;t;)s=t._next,t.p===e&&!t.op||t.op===e?no(this,t,"_pt"):t.dep||(n=1),t=s;return!n},vE=function(e,t,n,s){s.mSet(e,t,s.m.call(s.tween,n,s.mt),s)},Uf=function(e){for(var t=e._pt,n,s,r,a;t;){for(n=t._next,s=r;s&&s.pr>t.pr;)s=s._next;(t._prev=s?s._prev:a)?t._prev._next=t:r=t,(t._next=s)?s._prev=t:a=t,t=n}e._pt=r},tn=function(){function i(t,n,s,r,a,o,l,c,u){this.t=n,this.s=r,this.c=a,this.p=s,this.r=o||Df,this.d=l||this,this.set=c||hc,this.pr=u||0,this._next=t,t&&(t._prev=this)}var e=i.prototype;return e.modifier=function(n,s,r){this.mSet=this.mSet||this.set,this.set=vE,this.m=n,this.mt=r,this.tween=s},i}();en(oc+"parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger",function(i){return ac[i]=1});hn.TweenMax=hn.TweenLite=yt;hn.TimelineLite=hn.TimelineMax=Jt;st=new Jt({sortChildren:!1,defaults:sr,autoRemoveChildren:!0,id:"root",smoothChildTiming:!0});un.stringFilter=Ef;var us=[],Ua={},xE=[],Dh=0,yE=0,nl=function(e){return(Ua[e]||xE).map(function(t){return t()})},Ll=function(){var e=Date.now(),t=[];e-Dh>2&&(nl("matchMediaInit"),us.forEach(function(n){var s=n.queries,r=n.conditions,a,o,l,c;for(o in s)a=gn.matchMedia(s[o]).matches,a&&(l=1),a!==r[o]&&(r[o]=a,c=1);c&&(n.revert(),l&&t.push(n))}),nl("matchMediaRevert"),t.forEach(function(n){return n.onMatch(n)}),Dh=e,nl("matchMedia"))},Of=function(){function i(t,n){this.selector=n&&Rl(n),this.data=[],this._r=[],this.isReverted=!1,this.id=yE++,t&&this.add(t)}var e=i.prototype;return e.add=function(n,s,r){ft(n)&&(r=s,s=n,n=ft);var a=this,o=function(){var c=ut,u=a.selector,h;return c&&c!==a&&c.data.push(a),r&&(a.selector=Rl(r)),ut=a,h=s.apply(a,arguments),ft(h)&&a._r.push(h),ut=c,a.selector=u,a.isReverted=!1,h};return a.last=o,n===ft?o(a):n?a[n]=o:o},e.ignore=function(n){var s=ut;ut=null,n(this),ut=s},e.getTweens=function(){var n=[];return this.data.forEach(function(s){return s instanceof i?n.push.apply(n,s.getTweens()):s instanceof yt&&!(s.parent&&s.parent.data==="nested")&&n.push(s)}),n},e.clear=function(){this._r.length=this.data.length=0},e.kill=function(n,s){var r=this;if(n){var a=this.getTweens();this.data.forEach(function(l){l.data==="isFlip"&&(l.revert(),l.getChildren(!0,!0,!1).forEach(function(c){return a.splice(a.indexOf(c),1)}))}),a.map(function(l){return{g:l.globalTime(0),t:l}}).sort(function(l,c){return c.g-l.g||-1/0}).forEach(function(l){return l.t.revert(n)}),this.data.forEach(function(l){return!(l instanceof yt)&&l.revert&&l.revert(n)}),this._r.forEach(function(l){return l(n,r)}),this.isReverted=!0}else this.data.forEach(function(l){return l.kill&&l.kill()});if(this.clear(),s)for(var o=us.length;o--;)us[o].id===this.id&&us.splice(o,1)},e.revert=function(n){this.kill(n||{})},i}(),SE=function(){function i(t){this.contexts=[],this.scope=t}var e=i.prototype;return e.add=function(n,s,r){qn(n)||(n={matches:n});var a=new Of(0,r||this.scope),o=a.conditions={},l,c,u;ut&&!a.selector&&(a.selector=ut.selector),this.contexts.push(a),s=a.add("onMatch",s),a.queries=n;for(c in n)c==="all"?u=1:(l=gn.matchMedia(n[c]),l&&(us.indexOf(a)<0&&us.push(a),(o[c]=l.matches)&&(u=1),l.addListener?l.addListener(Ll):l.addEventListener("change",Ll)));return u&&s(a),this},e.revert=function(n){this.kill(n||{})},e.kill=function(n){this.contexts.forEach(function(s){return s.kill(n,!0)})},i}(),qa={registerPlugin:function(){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n];t.forEach(function(s){return yf(s)})},timeline:function(e){return new Jt(e)},getTweensOf:function(e,t){return st.getTweensOf(e,t)},getProperty:function(e,t,n,s){Ut(e)&&(e=yn(e)[0]);var r=os(e||{}).get,a=n?of:af;return n==="native"&&(n=""),e&&(t?a((on[t]&&on[t].get||r)(e,t,n,s)):function(o,l,c){return a((on[o]&&on[o].get||r)(e,o,l,c))})},quickSetter:function(e,t,n){if(e=yn(e),e.length>1){var s=e.map(function(u){return nn.quickSetter(u,t,n)}),r=s.length;return function(u){for(var h=r;h--;)s[h](u)}}e=e[0]||{};var a=on[t],o=os(e),l=o.harness&&(o.harness.aliases||{})[t]||t,c=a?function(u){var h=new a;Hs._pt=0,h.init(e,n?u+n:u,Hs,0,[e]),h.render(1,h),Hs._pt&&fc(1,Hs)}:o.set(e,l);return a?c:function(u){return c(e,l,n?u+n:u,o,1)}},quickTo:function(e,t,n){var s,r=nn.to(e,ps((s={},s[t]="+=0.1",s.paused=!0,s),n||{})),a=function(l,c,u){return r.resetTo(t,l,c,u)};return a.tween=r,a},isTweening:function(e){return st.getTweensOf(e,!0).length>0},defaults:function(e){return e&&e.ease&&(e.ease=cs(e.ease,sr.ease)),wh(sr,e||{})},config:function(e){return wh(un,e||{})},registerEffect:function(e){var t=e.name,n=e.effect,s=e.plugins,r=e.defaults,a=e.extendTimeline;(s||"").split(",").forEach(function(o){return o&&!on[o]&&!hn[o]&&Va(t+" effect requires "+o+" plugin.")}),Jo[t]=function(o,l,c){return n(yn(o),Tn(l||{},r),c)},a&&(Jt.prototype[t]=function(o,l,c){return this.add(Jo[t](o,qn(l)?l:(c=l)&&{},this),c)})},registerEase:function(e,t){We[e]=cs(t)},parseEase:function(e,t){return arguments.length?cs(e,t):We},getById:function(e){return st.getById(e)},exportRoot:function(e,t){e===void 0&&(e={});var n=new Jt(e),s,r;for(n.smoothChildTiming=Qt(e.smoothChildTiming),st.remove(n),n._dp=0,n._time=n._tTime=st._time,s=st._first;s;)r=s._next,(t||!(!s._dur&&s instanceof yt&&s.vars.onComplete===s._targets[0]))&&zn(n,s,s._start-s._delay),s=r;return zn(st,n,0),n},context:function(e,t){return e?new Of(e,t):ut},matchMedia:function(e){return new SE(e)},matchMediaRefresh:function(){return us.forEach(function(e){var t=e.conditions,n,s;for(s in t)t[s]&&(t[s]=!1,n=1);n&&e.revert()})||Ll()},addEventListener:function(e,t){var n=Ua[e]||(Ua[e]=[]);~n.indexOf(t)||n.push(t)},removeEventListener:function(e,t){var n=Ua[e],s=n&&n.indexOf(t);s>=0&&n.splice(s,1)},utils:{wrap:QM,wrapYoyo:eE,distribute:pf,random:gf,snap:mf,normalize:JM,getUnit:Gt,clamp:jM,splitColor:Sf,toArray:yn,selector:Rl,mapRange:vf,pipe:$M,unitize:ZM,interpolate:tE,shuffle:ff},install:ef,effects:Jo,ticker:ln,updateRoot:Jt.updateRoot,plugins:on,globalTimeline:st,core:{PropTween:tn,globals:tf,Tween:yt,Timeline:Jt,Animation:Hr,getCache:os,_removeLinkedListItem:no,reverting:function(){return Xt},context:function(e){return e&&ut&&(ut.data.push(e),e._ctx=ut),ut},suppressOverwrites:function(e){return tc=e}}};en("to,from,fromTo,delayedCall,set,killTweensOf",function(i){return qa[i]=yt[i]});ln.add(Jt.updateRoot);Hs=qa.to({},{duration:0});var ME=function(e,t){for(var n=e._pt;n&&n.p!==t&&n.op!==t&&n.fp!==t;)n=n._next;return n},EE=function(e,t){var n=e._targets,s,r,a;for(s in t)for(r=n.length;r--;)a=e._ptLookup[r][s],a&&(a=a.d)&&(a._pt&&(a=ME(a,s)),a&&a.modifier&&a.modifier(t[s],e,n[r],s))},il=function(e,t){return{name:e,rawVars:1,init:function(s,r,a){a._onInit=function(o){var l,c;if(Ut(r)&&(l={},en(r,function(u){return l[u]=1}),r=l),t){l={};for(c in r)l[c]=t(r[c]);r=l}EE(o,r)}}}},nn=qa.registerPlugin({name:"attr",init:function(e,t,n,s,r){var a,o,l;this.tween=n;for(a in t)l=e.getAttribute(a)||"",o=this.add(e,"setAttribute",(l||0)+"",t[a],s,r,0,0,a),o.op=a,o.b=l,this._props.push(a)},render:function(e,t){for(var n=t._pt;n;)Xt?n.set(n.t,n.p,n.b,n):n.r(e,n.d),n=n._next}},{name:"endArray",init:function(e,t){for(var n=t.length;n--;)this.add(e,n,e[n]||0,t[n],0,0,0,0,0,1)}},il("roundProps",Cl),il("modifiers"),il("snap",mf))||qa;yt.version=Jt.version=nn.version="3.12.2";Qd=1;ic()&&or();We.Power0;We.Power1;We.Power2;We.Power3;We.Power4;We.Linear;We.Quad;We.Cubic;We.Quart;We.Quint;We.Strong;We.Elastic;We.Back;We.SteppedEase;We.Bounce;We.Sine;We.Expo;We.Circ;/*!
 * CSSPlugin 3.12.2
 * https://greensock.com
 *
 ...
 * Club GreenSock members, the agreement issued with that membership.
 * @author: Jack Doyle, jack@greensock.com
*/var Ih,Pi,qs,pc,ss,Uh,mc,TE=function(){return typeof window<"u"},pi={},ts=180/Math.PI,Ys=Math.PI/180,Fs=Math.atan2,Oh=1e8,gc=/([A-Z])/g,AE=/(left|right|width|margin|padding|x)/i,bE=/[\s,\(]\S/,kn={autoAlpha:"opacity,visibility",scale:"scaleX,scaleY",alpha:"opacity"},Dl=function(e,t){return t.set(t.t,t.p,Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},wE=function(e,t){return t.set(t.t,t.p,e===1?t.e:Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},RE=function(e,t){return t.set(t.t,t.p,e?Math.round((t.s+t.c*e)*1e4)/1e4+t.u:t.b,t)},CE=function(e,t){var n=t.s+t.c*e;t.set(t.t,t.p,~~(n+(n<0?-.5:.5))+t.u,t)},Nf=function(e,t){return t.set(t.t,t.p,e?t.e:t.b,t)},Ff=function(e,t){return t.set(t.t,t.p,e!==1?t.b:t.e,t)},PE=function(e,t,n){return e.style[t]=n},LE=function(e,t,n){return e.style.setProperty(t,n)},DE=function(e,t,n){return e._gsap[t]=n},IE=function(e,t,n){return e._gsap.scaleX=e._gsap.scaleY=n},UE=function(e,t,n,s,r){var a=e._gsap;a.scaleX=a.scaleY=n,a.renderTransform(r,a)},OE=function(e,t,n,s,r){var a=e._gsap;a[t]=n,a.renderTransform(r,a)},rt="transform",Un=rt+"Origin",NE=function i(e,t){var n=this,s=this.target,r=s.style;if(e in pi&&r){if(this.tfm=this.tfm||{},e!=="transform")e=kn[e]||e,~e.indexOf(",")?e.split(",").forEach(function(a){return n.tfm[a]=oi(s,a)}):this.tfm[e]=s._gsap.x?s._gsap[e]:oi(s,e);else return kn.transform.split(",").forEach(function(a){return i.call(n,a,t)});if(this.props.indexOf(rt)>=0)return;s._gsap.svg&&(this.svgo=s.getAttribute("data-svg-origin"),this.props.push(Un,t,"")),e=rt}(r||t)&&this.props.push(e,t,r[e])},Bf=function(e){e.translate&&(e.removeProperty("translate"),e.removeProperty("scale"),e.removeProperty("rotate"))},FE=function(){var e=this.props,t=this.target,n=t.style,s=t._gsap,r,a;for(r=0;r<e.length;r+=3)e[r+1]?t[e[r]]=e[r+2]:e[r+2]?n[e[r]]=e[r+2]:n.removeProperty(e[r].substr(0,2)==="--"?e[r]:e[r].replace(gc,"-$1").toLowerCase());if(this.tfm){for(a in this.tfm)s[a]=this.tfm[a];s.svg&&(s.renderTransform(),t.setAttribute("data-svg-origin",this.svgo||"")),r=mc(),(!r||!r.isStart)&&!n[rt]&&(Bf(n),s.uncache=1)}},zf=function(e,t){var n={target:e,props:[],revert:FE,save:NE};return e._gsap||nn.core.getCache(e),t&&t.split(",").forEach(function(s){return n.save(s)}),n},kf,Il=function(e,t){var n=Pi.createElementNS?Pi.createElementNS((t||"http://www.w3.org/1999/xhtml").replace(/^https/,"http"),e):Pi.createElement(e);return n.style?n:Pi.createElement(e)},Hn=function i(e,t,n){var s=getComputedStyle(e);return s[t]||s.getPropertyValue(t.replace(gc,"-$1").toLowerCase())||s.getPropertyValue(t)||!n&&i(e,lr(t)||t,1)||""},Nh="O,Moz,ms,Ms,Webkit".split(","),lr=function(e,t,n){var s=t||ss,r=s.style,a=5;if(e in r&&!n)return e;for(e=e.charAt(0).toUpperCase()+e.substr(1);a--&&!(Nh[a]+e in r););return a<0?null:(a===3?"ms":a>=0?Nh[a]:"")+e},Ul=function(){TE()&&window.document&&(Ih=window,Pi=Ih.document,qs=Pi.documentElement,ss=Il("div")||{style:{}},Il("div"),rt=lr(rt),Un=rt+"Origin",ss.style.cssText="border-width:0;line-height:0;position:absolute;padding:0",kf=!!lr("perspective"),mc=nn.core.reverting,pc=1)},sl=function i(e){var t=Il("svg",this.ownerSVGElement&&this.ownerSVGElement.getAttribute("xmlns")||"http://www.w3.org/2000/svg"),n=this.parentNode,s=this.nextSibling,r=this.style.cssText,a;if(qs.appendChild(t),t.appendChild(this),this.style.display="block",e)try{a=this.getBBox(),this._gsapBBox=this.getBBox,this.getBBox=i}catch{}else this._gsapBBox&&(a=this._gsapBBox());return n&&(s?n.insertBefore(this,s):n.appendChild(this)),qs.removeChild(t),this.style.cssText=r,a},Fh=function(e,t){for(var n=t.length;n--;)if(e.hasAttribute(t[n]))return e.getAttribute(t[n])},Hf=function(e){var t;try{t=e.getBBox()}catch{t=sl.call(e,!0)}return t&&(t.width||t.height)||e.getBBox===sl||(t=sl.call(e,!0)),t&&!t.width&&!t.x&&!t.y?{x:+Fh(e,["x","cx","x1"])||0,y:+Fh(e,["y","cy","y1"])||0,width:0,height:0}:t},Vf=function(e){return!!(e.getCTM&&(!e.parentNode||e.ownerSVGElement)&&Hf(e))},Vr=function(e,t){if(t){var n=e.style;t in pi&&t!==Un&&(t=rt),n.removeProperty?((t.substr(0,2)==="ms"||t.substr(0,6)==="webkit")&&(t="-"+t),n.removeProperty(t.replace(gc,"-$1").toLowerCase())):n.removeAttribute(t)}},Li=function(e,t,n,s,r,a){var o=new tn(e._pt,t,n,0,1,a?Ff:Nf);return e._pt=o,o.b=s,o.e=r,e._props.push(n),o},Bh={deg:1,rad:1,turn:1},BE={grid:1,flex:1},zi=function i(e,t,n,s){var r=parseFloat(n)||0,a=(n+"").trim().substr((r+"").length)||"px",o=ss.style,l=AE.test(t),c=e.tagName.toLowerCase()==="svg",u=(c?"client":"offset")+(l?"Width":"Height"),h=100,d=s==="px",p=s==="%",_,g,m,f;return s===a||!r||Bh[s]||Bh[a]?r:(a!=="px"&&!d&&(r=i(e,t,n,"px")),f=e.getCTM&&Vf(e),(p||a==="%")&&(pi[t]||~t.indexOf("adius"))?(_=f?e.getBBox()[l?"width":"height"]:e[u],mt(p?r/_*h:r/100*_)):(o[l?"width":"height"]=h+(d?a:s),g=~t.indexOf("adius")||s==="em"&&e.appendChild&&!c?e:e.parentNode,f&&(g=(e.ownerSVGElement||{}).parentNode),(!g||g===Pi||!g.appendChild)&&(g=Pi.body),m=g._gsap,m&&p&&m.width&&l&&m.time===ln.time&&!m.uncache?mt(r/m.width*h):((p||a==="%")&&!BE[Hn(g,"display")]&&(o.position=Hn(e,"position")),g===e&&(o.position="static"),g.appendChild(ss),_=ss[u],g.removeChild(ss),o.position="absolute",l&&p&&(m=os(g),m.time=ln.time,m.width=g[u]),mt(d?_*r/h:_&&r?h/_*r:0))))},oi=function(e,t,n,s){var r;return pc||Ul(),t in kn&&t!=="transform"&&(t=kn[t],~t.indexOf(",")&&(t=t.split(",")[0])),pi[t]&&t!=="transform"?(r=Wr(e,s),r=t!=="transformOrigin"?r[t]:r.svg?r.origin:ja(Hn(e,Un))+" "+r.zOrigin+"px"):(r=e.style[t],(!r||r==="auto"||s||~(r+"").indexOf("calc("))&&(r=Ya[t]&&Ya[t](e,t,n)||Hn(e,t)||sf(e,t)||(t==="opacity"?1:0))),n&&!~(r+"").trim().indexOf(" ")?zi(e,t,r,n)+n:r},zE=function(e,t,n,s){if(!n||n==="none"){var r=lr(t,e,1),a=r&&Hn(e,r,1);a&&a!==n?(t=r,n=a):t==="borderColor"&&(n=Hn(e,"borderTopColor"))}var o=new tn(this._pt,e.style,t,0,1,If),l=0,c=0,u,h,d,p,_,g,m,f,y,v,S,M;if(o.b=n,o.e=s,n+="",s+="",s==="auto"&&(e.style[t]=s,s=Hn(e,t)||s,e.style[t]=n),u=[n,s],Ef(u),n=u[0],s=u[1],d=n.match(ks)||[],M=s.match(ks)||[],M.length){for(;h=ks.exec(s);)m=h[0],y=s.substring(l,h.index),_?_=(_+1)%5:(y.substr(-5)==="rgba("||y.substr(-5)==="hsla(")&&(_=1),m!==(g=d[c++]||"")&&(p=parseFloat(g)||0,S=g.substr((p+"").length),m.charAt(1)==="="&&(m=Xs(p,m)+S),f=parseFloat(m),v=m.substr((f+"").length),l=ks.lastIndex-v.length,v||(v=v||un.units[t]||S,l===s.length&&(s+=v,o.e+=v)),S!==v&&(p=zi(e,t,g,v)||0),o._pt={_next:o._pt,p:y||c===1?y:",",s:p,c:f-p,m:_&&_<4||t==="zIndex"?Math.round:0});o.c=l<s.length?s.substring(l,s.length):""}else o.r=t==="display"&&s==="none"?Ff:Nf;return Zd.test(s)&&(o.e=0),this._pt=o,o},zh={top:"0%",bottom:"100%",left:"0%",right:"100%",center:"50%"},kE=function(e){var t=e.split(" "),n=t[0],s=t[1]||"50%";return(n==="top"||n==="bottom"||s==="left"||s==="right")&&(e=n,n=s,s=e),t[0]=zh[n]||n,t[1]=zh[s]||s,t.join(" ")},HE=function(e,t){if(t.tween&&t.tween._time===t.tween._dur){var n=t.t,s=n.style,r=t.u,a=n._gsap,o,l,c;if(r==="all"||r===!0)s.cssText="",l=1;else for(r=r.split(","),c=r.length;--c>-1;)o=r[c],pi[o]&&(l=1,o=o==="transformOrigin"?Un:rt),Vr(n,o);l&&(Vr(n,rt),a&&(a.svg&&n.removeAttribute("transform"),Wr(n,1),a.uncache=1,Bf(s)))}},Ya={clearProps:function(e,t,n,s,r){if(r.data!=="isFromStart"){var a=e._pt=new tn(e._pt,t,n,0,0,HE);return a.u=s,a.pr=-10,a.tween=r,e._props.push(n),1}}},Gr=[1,0,0,1,0,0],Gf={},Wf=function(e){return e==="matrix(1, 0, 0, 1, 0, 0)"||e==="none"||!e},kh=function(e){var t=Hn(e,rt);return Wf(t)?Gr:t.substr(7).match($d).map(mt)},_c=function(e,t){var n=e._gsap||os(e),s=e.style,r=kh(e),a,o,l,c;return n.svg&&e.getAttribute("transform")?(l=e.transform.baseVal.consolidate().matrix,r=[l.a,l.b,l.c,l.d,l.e,l.f],r.join(",")==="1,0,0,1,0,0"?Gr:r):(r===Gr&&!e.offsetParent&&e!==qs&&!n.svg&&(l=s.display,s.display="block",a=e.parentNode,(!a||!e.offsetParent)&&(c=1,o=e.nextElementSibling,qs.appendChild(e)),r=kh(e),l?s.display=l:Vr(e,"display"),c&&(o?a.insertBefore(e,o):a?a.appendChild(e):qs.removeChild(e))),t&&r.length>6?[r[0],r[1],r[4],r[5],r[12],r[13]]:r)},Ol=function(e,t,n,s,r,a){var o=e._gsap,l=r||_c(e,!0),c=o.xOrigin||0,u=o.yOrigin||0,h=o.xOffset||0,d=o.yOffset||0,p=l[0],_=l[1],g=l[2],m=l[3],f=l[4],y=l[5],v=t.split(" "),S=parseFloat(v[0])||0,M=parseFloat(v[1])||0,w,T,C,x;n?l!==Gr&&(T=p*m-_*g)&&(C=S*(m/T)+M*(-g/T)+(g*y-m*f)/T,x=S*(-_/T)+M*(p/T)-(p*y-_*f)/T,S=C,M=x):(w=Hf(e),S=w.x+(~v[0].indexOf("%")?S/100*w.width:S),M=w.y+(~(v[1]||v[0]).indexOf("%")?M/100*w.height:M)),s||s!==!1&&o.smooth?(f=S-c,y=M-u,o.xOffset=h+(f*p+y*g)-f,o.yOffset=d+(f*_+y*m)-y):o.xOffset=o.yOffset=0,o.xOrigin=S,o.yOrigin=M,o.smooth=!!s,o.origin=t,o.originIsAbsolute=!!n,e.style[Un]="0px 0px",a&&(Li(a,o,"xOrigin",c,S),Li(a,o,"yOrigin",u,M),Li(a,o,"xOffset",h,o.xOffset),Li(a,o,"yOffset",d,o.yOffset)),e.setAttribute("data-svg-origin",S+" "+M)},Wr=function(e,t){var n=e._gsap||new wf(e);if("x"in n&&!t&&!n.uncache)return n;var s=e.style,r=n.scaleX<0,a="px",o="deg",l=getComputedStyle(e),c=Hn(e,Un)||"0",u,h,d,p,_,g,m,f,y,v,S,M,w,T,C,x,A,W,q,I,O,N,$,V,Y,Q,Z,z,X,he,re,le;return u=h=d=g=m=f=y=v=S=0,p=_=1,n.svg=!!(e.getCTM&&Vf(e)),l.translate&&((l.translate!=="none"||l.scale!=="none"||l.rotate!=="none")&&(s[rt]=(l.translate!=="none"?"translate3d("+(l.translate+" 0 0").split(" ").slice(0,3).join(", ")+") ":"")+(l.rotate!=="none"?"rotate("+l.rotate+") ":"")+(l.scale!=="none"?"scale("+l.scale.split(" ").join(",")+") ":"")+(l[rt]!=="none"?l[rt]:"")),s.scale=s.rotate=s.translate="none"),T=_c(e,n.svg),n.svg&&(n.uncache?(Y=e.getBBox(),c=n.xOrigin-Y.x+"px "+(n.yOrigin-Y.y)+"px",V=""):V=!t&&e.getAttribute("data-svg-origin"),Ol(e,V||c,!!V||n.originIsAbsolute,n.smooth!==!1,T)),M=n.xOrigin||0,w=n.yOrigin||0,T!==Gr&&(W=T[0],q=T[1],I=T[2],O=T[3],u=N=T[4],h=$=T[5],T.length===6?(p=Math.sqrt(W*W+q*q),_=Math.sqrt(O*O+I*I),g=W||q?Fs(q,W)*ts:0,y=I||O?Fs(I,O)*ts+g:0,y&&(_*=Math.abs(Math.cos(y*Ys))),n.svg&&(u-=M-(M*W+w*I),h-=w-(M*q+w*O))):(le=T[6],he=T[7],Z=T[8],z=T[9],X=T[10],re=T[11],u=T[12],h=T[13],d=T[14],C=Fs(le,X),m=C*ts,C&&(x=Math.cos(-C),A=Math.sin(-C),V=N*x+Z*A,Y=$*x+z*A,Q=le*x+X*A,Z=N*-A+Z*x,z=$*-A+z*x,X=le*-A+X*x,re=he*-A+re*x,N=V,$=Y,le=Q),C=Fs(-I,X),f=C*ts,C&&(x=Math.cos(-C),A=Math.sin(-C),V=W*x-Z*A,Y=q*x-z*A,Q=I*x-X*A,re=O*A+re*x,W=V,q=Y,I=Q),C=Fs(q,W),g=C*ts,C&&(x=Math.cos(C),A=Math.sin(C),V=W*x+q*A,Y=N*x+$*A,q=q*x-W*A,$=$*x-N*A,W=V,N=Y),m&&Math.abs(m)+Math.abs(g)>359.9&&(m=g=0,f=180-f),p=mt(Math.sqrt(W*W+q*q+I*I)),_=mt(Math.sqrt($*$+le*le)),C=Fs(N,$),y=Math.abs(C)>2e-4?C*ts:0,S=re?1/(re<0?-re:re):0),n.svg&&(V=e.getAttribute("transform"),n.forceCSS=e.setAttribute("transform","")||!Wf(Hn(e,rt)),V&&e.setAttribute("transform",V))),Math.abs(y)>90&&Math.abs(y)<270&&(r?(p*=-1,y+=g<=0?180:-180,g+=g<=0?180:-180):(_*=-1,y+=y<=0?180:-180)),t=t||n.uncache,n.x=u-((n.xPercent=u&&(!t&&n.xPercent||(Math.round(e.offsetWidth/2)===Math.round(-u)?-50:0)))?e.offsetWidth*n.xPercent/100:0)+a,n.y=h-((n.yPercent=h&&(!t&&n.yPercent||(Math.round(e.offsetHeight/2)===Math.round(-h)?-50:0)))?e.offsetHeight*n.yPercent/100:0)+a,n.z=d+a,n.scaleX=mt(p),n.scaleY=mt(_),n.rotation=mt(g)+o,n.rotationX=mt(m)+o,n.rotationY=mt(f)+o,n.skewX=y+o,n.skewY=v+o,n.transformPerspective=S+a,(n.zOrigin=parseFloat(c.split(" ")[2])||0)&&(s[Un]=ja(c)),n.xOffset=n.yOffset=0,n.force3D=un.force3D,n.renderTransform=n.svg?GE:kf?Xf:VE,n.uncache=0,n},ja=function(e){return(e=e.split(" "))[0]+" "+e[1]},rl=function(e,t,n){var s=Gt(t);return mt(parseFloat(t)+parseFloat(zi(e,"x",n+"px",s)))+s},VE=function(e,t){t.z="0px",t.rotationY=t.rotationX="0deg",t.force3D=0,Xf(e,t)},Zi="0deg",Tr="0px",Ji=") ",Xf=function(e,t){var n=t||this,s=n.xPercent,r=n.yPercent,a=n.x,o=n.y,l=n.z,c=n.rotation,u=n.rotationY,h=n.rotationX,d=n.skewX,p=n.skewY,_=n.scaleX,g=n.scaleY,m=n.transformPerspective,f=n.force3D,y=n.target,v=n.zOrigin,S="",M=f==="auto"&&e&&e!==1||f===!0;if(v&&(h!==Zi||u!==Zi)){var w=parseFloat(u)*Ys,T=Math.sin(w),C=Math.cos(w),x;w=parseFloat(h)*Ys,x=Math.cos(w),a=rl(y,a,T*x*-v),o=rl(y,o,-Math.sin(w)*-v),l=rl(y,l,C*x*-v+v)}m!==Tr&&(S+="perspective("+m+Ji),(s||r)&&(S+="translate("+s+"%, "+r+"%) "),(M||a!==Tr||o!==Tr||l!==Tr)&&(S+=l!==Tr||M?"translate3d("+a+", "+o+", "+l+") ":"translate("+a+", "+o+Ji),c!==Zi&&(S+="rotate("+c+Ji),u!==Zi&&(S+="rotateY("+u+Ji),h!==Zi&&(S+="rotateX("+h+Ji),(d!==Zi||p!==Zi)&&(S+="skew("+d+", "+p+Ji),(_!==1||g!==1)&&(S+="scale("+_+", "+g+Ji),y.style[rt]=S||"translate(0, 0)"},GE=function(e,t){var n=t||this,s=n.xPercent,r=n.yPercent,a=n.x,o=n.y,l=n.rotation,c=n.skewX,u=n.skewY,h=n.scaleX,d=n.scaleY,p=n.target,_=n.xOrigin,g=n.yOrigin,m=n.xOffset,f=n.yOffset,y=n.forceCSS,v=parseFloat(a),S=parseFloat(o),M,w,T,C,x;l=parseFloat(l),c=parseFloat(c),u=parseFloat(u),u&&(u=parseFloat(u),c+=u,l+=u),l||c?(l*=Ys,c*=Ys,M=Math.cos(l)*h,w=Math.sin(l)*h,T=Math.sin(l-c)*-d,C=Math.cos(l-c)*d,c&&(u*=Ys,x=Math.tan(c-u),x=Math.sqrt(1+x*x),T*=x,C*=x,u&&(x=Math.tan(u),x=Math.sqrt(1+x*x),M*=x,w*=x)),M=mt(M),w=mt(w),T=mt(T),C=mt(C)):(M=h,C=d,w=T=0),(v&&!~(a+"").indexOf("px")||S&&!~(o+"").indexOf("px"))&&(v=zi(p,"x",a,"px"),S=zi(p,"y",o,"px")),(_||g||m||f)&&(v=mt(v+_-(_*M+g*T)+m),S=mt(S+g-(_*w+g*C)+f)),(s||r)&&(x=p.getBBox(),v=mt(v+s/100*x.width),S=mt(S+r/100*x.height)),x="matrix("+M+","+w+","+T+","+C+","+v+","+S+")",p.setAttribute("transform",x),y&&(p.style[rt]=x)},WE=function(e,t,n,s,r){var a=360,o=Ut(r),l=parseFloat(r)*(o&&~r.indexOf("rad")?ts:1),c=l-s,u=s+c+"deg",h,d;return o&&(h=r.split("_")[1],h==="short"&&(c%=a,c!==c%(a/2)&&(c+=c<0?a:-a)),h==="cw"&&c<0?c=(c+a*Oh)%a-~~(c/a)*a:h==="ccw"&&c>0&&(c=(c-a*Oh)%a-~~(c/a)*a)),e._pt=d=new tn(e._pt,t,n,s,c,wE),d.e=u,d.u="deg",e._props.push(n),d},Hh=function(e,t){for(var n in t)e[n]=t[n];return e},XE=function(e,t,n){var s=Hh({},n._gsap),r="perspective,force3D,transformOrigin,svgOrigin",a=n.style,o,l,c,u,h,d,p,_;s.svg?(c=n.getAttribute("transform"),n.setAttribute("transform",""),a[rt]=t,o=Wr(n,1),Vr(n,rt),n.setAttribute("transform",c)):(c=getComputedStyle(n)[rt],a[rt]=t,o=Wr(n,1),a[rt]=c);for(l in pi)c=s[l],u=o[l],c!==u&&r.indexOf(l)<0&&(p=Gt(c),_=Gt(u),h=p!==_?zi(n,l,c,_):parseFloat(c),d=parseFloat(u),e._pt=new tn(e._pt,o,l,h,d-h,Dl),e._pt.u=_||0,e._props.push(l));Hh(o,s)};en("padding,margin,Width,Radius",function(i,e){var t="Top",n="Right",s="Bottom",r="Left",a=(e<3?[t,n,s,r]:[t+r,t+n,s+n,s+r]).map(function(o){return e<2?i+o:"border"+o+i});Ya[e>1?"border"+i:i]=function(o,l,c,u,h){var d,p;if(arguments.length<4)return d=a.map(function(_){return oi(o,_,c)}),p=d.join(" "),p.split(d[0]).length===5?d[0]:p;d=(u+"").split(" "),p={},a.forEach(function(_,g){return p[_]=d[g]=d[g]||d[(g-1)/2|0]}),o.init(l,p,h)}});var qf={name:"css",register:Ul,targetTest:function(e){return e.style&&e.nodeType},init:function(e,t,n,s,r){var a=this._props,o=e.style,l=n.vars.startAt,c,u,h,d,p,_,g,m,f,y,v,S,M,w,T,C;pc||Ul(),this.styles=this.styles||zf(e),C=this.styles.props,this.tween=n;for(g in t)if(g!=="autoRound"&&(u=t[g],!(on[g]&&Rf(g,t,n,s,e,r)))){if(p=typeof u,_=Ya[g],p==="function"&&(u=u.call(n,s,e,r),p=typeof u),p==="string"&&~u.indexOf("random(")&&(u=zr(u)),_)_(this,e,g,u,n)&&(T=1);else if(g.substr(0,2)==="--")c=(getComputedStyle(e).getPropertyValue(g)+"").trim(),u+="",Oi.lastIndex=0,Oi.test(c)||(m=Gt(c),f=Gt(u)),f?m!==f&&(c=zi(e,g,c,f)+f):m&&(u+=m),this.add(o,"setProperty",c,u,s,r,0,0,g),a.push(g),C.push(g,0,o[g]);else if(p!=="undefined"){if(l&&g in l?(c=typeof l[g]=="function"?l[g].call(n,s,e,r):l[g],Ut(c)&&~c.indexOf("random(")&&(c=zr(c)),Gt(c+"")||(c+=un.units[g]||Gt(oi(e,g))||""),(c+"").charAt(1)==="="&&(c=oi(e,g))):c=oi(e,g),d=parseFloat(c),y=p==="string"&&u.charAt(1)==="="&&u.substr(0,2),y&&(u=u.substr(2)),h=parseFloat(u),g in kn&&(g==="autoAlpha"&&(d===1&&oi(e,"visibility")==="hidden"&&h&&(d=0),C.push("visibility",0,o.visibility),Li(this,o,"visibility",d?"inherit":"hidden",h?"inherit":"hidden",!h)),g!=="scale"&&g!=="transform"&&(g=kn[g],~g.indexOf(",")&&(g=g.split(",")[0]))),v=g in pi,v){if(this.styles.save(g),S||(M=e._gsap,M.renderTransform&&!t.parseTransform||Wr(e,t.parseTransform),w=t.smoothOrigin!==!1&&M.smooth,S=this._pt=new tn(this._pt,o,rt,0,1,M.renderTransform,M,0,-1),S.dep=1),g==="scale")this._pt=new tn(this._pt,M,"scaleY",M.scaleY,(y?Xs(M.scaleY,y+h):h)-M.scaleY||0,Dl),this._pt.u=0,a.push("scaleY",g),g+="X";else if(g==="transformOrigin"){C.push(Un,0,o[Un]),u=kE(u),M.svg?Ol(e,u,0,w,0,this):(f=parseFloat(u.split(" ")[2])||0,f!==M.zOrigin&&Li(this,M,"zOrigin",M.zOrigin,f),Li(this,o,g,ja(c),ja(u)));continue}else if(g==="svgOrigin"){Ol(e,u,1,w,0,this);continue}else if(g in Gf){WE(this,M,g,d,y?Xs(d,y+u):u);continue}else if(g==="smoothOrigin"){Li(this,M,"smooth",M.smooth,u);continue}else if(g==="force3D"){M[g]=u;continue}else if(g==="transform"){XE(this,u,e);continue}}else g in o||(g=lr(g)||g);if(v||(h||h===0)&&(d||d===0)&&!bE.test(u)&&g in o)m=(c+"").substr((d+"").length),h||(h=0),f=Gt(u)||(g in un.units?un.units[g]:m),m!==f&&(d=zi(e,g,c,f)),this._pt=new tn(this._pt,v?M:o,g,d,(y?Xs(d,y+h):h)-d,!v&&(f==="px"||g==="zIndex")&&t.autoRound!==!1?CE:Dl),this._pt.u=f||0,m!==f&&f!=="%"&&(this._pt.b=c,this._pt.r=RE);else if(g in o)zE.call(this,e,g,c,y?y+u:u);else if(g in e)this.add(e,g,c||e[g],y?y+u:u,s,r);else if(g!=="parseTransform"){rc(g,u);continue}v||(g in o?C.push(g,0,o[g]):C.push(g,1,c||e[g])),a.push(g)}}T&&Uf(this)},render:function(e,t){if(t.tween._time||!mc())for(var n=t._pt;n;)n.r(e,n.d),n=n._next;else t.styles.revert()},get:oi,aliases:kn,getSetter:function(e,t,n){var s=kn[t];return s&&s.indexOf(",")<0&&(t=s),t in pi&&t!==Un&&(e._gsap.x||oi(e,"x"))?n&&Uh===n?t==="scale"?IE:DE:(Uh=n||{})&&(t==="scale"?UE:OE):e.style&&!nc(e.style[t])?PE:~t.indexOf("-")?LE:dc(e,t)},core:{_removeProperty:Vr,_getMatrix:_c}};nn.utils.checkPrefix=lr;nn.core.getStyleSaver=zf;(function(i,e,t,n){var s=en(i+","+e+","+t,function(r){pi[r]=1});en(e,function(r){un.units[r]="deg",Gf[r]=1}),kn[s[13]]=i+","+e,en(n,function(r){var a=r.split(":");kn[a[1]]=s[a[0]]})})("x,y,z,scale,scaleX,scaleY,xPercent,yPercent","rotation,rotationX,rotationY,skewX,skewY","transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective","0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY");en("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective",function(i){un.units[i]="px"});nn.registerPlugin(qf);var Cr=nn.registerPlugin(qf)||nn;Cr.core.Tween;class Ar extends ms{constructor({originPow:e=[3,3,3],originMul:t=[2,2,2],originAdd:n=[.05,.05,.05],destPow:s=[3,3,3],destMul:r=[2,2,2],destAdd:a=[.05,.05,.05],ease:o="none",yoyo:l=!1}){super(),this.ease=o,this.yoyo=l,this.name="ColorCorrection",this.params="(...)",this.dest=[s[0],s[1],s[2],r[0],r[1],r[2],a[0],a[1],a[2]],this.origin=[e[0],e[1],e[2],t[0],t[1],t[2],n[0],n[1],n[2]]}setupAnimation(e,t,n){this.start=t,this.duration=n,this.colorCorrectionEffect=this.experience.renderer.colorCorrectionEffect,this.powOrigin=this.colorCorrectionEffect.uniforms.get("powRGB").value,this.mulOrigin=this.colorCorrectionEffect.uniforms.get("mulRGB").value,this.addOrigin=this.colorCorrectionEffect.uniforms.get("addRGB").value,e.to(this.origin,{id:this.id,ease:this.ease,repeat:this.yoyo===!0?1:0,yoyo:this.yoyo,duration:this.duration,endArray:this.dest,onUpdate:this.onUpdate,onUpdateParams:[this],onStart:this.onStart,onStartParams:[this],onComplete:this.onComplete,onCompleteParams:[this]},this.start)}onUpdate(e){e.colorCorrectionEffect.uniforms.get("powRGB").value.x=this.targets()[0][0],e.colorCorrectionEffect.uniforms.get("powRGB").value.y=this.targets()[0][1],e.colorCorrectionEffect.uniforms.get("powRGB").value.z=this.targets()[0][2],e.colorCorrectionEffect.uniforms.get("mulRGB").value.x=this.targets()[0][3],e.colorCorrectionEffect.uniforms.get("mulRGB").value.y=this.targets()[0][4],e.colorCorrectionEffect.uniforms.get("mulRGB").value.z=this.targets()[0][5],e.colorCorrectionEffect.uniforms.get("addRGB").value.x=this.targets()[0][6],e.colorCorrectionEffect.uniforms.get("addRGB").value.y=this.targets()[0][7],e.colorCorrectionEffect.uniforms.get("addRGB").value.z=this.targets()[0][8],e.onUpdateProgress(this._tTime,this._tDur)}}class Vh extends ms{constructor({animationIn:e=.5,animationOut:t=.5,displacement:n=.125,ease:s="none",yoyo:r=!1}){super(),this.dest=[1],this.animationIn=e,this.animationOut=t,this.displacement=n,this.name="MirrorMode",this.params=`(${t})`,this.ease=s,this.yoyo=r}setupAnimation(e,t,n){this.start=t,this.duration=n,this.mirrorEffect=this.experience.renderer.mirrorModeEffect,this.origin=[0],e.to(this.origin,{id:this.id,ease:this.ease,repeat:this.yoyo===!0?1:0,yoyo:this.yoyo,duration:this.duration,endArray:this.dest,onUpdate:this.onUpdate,onUpdateParams:[this],onStart:this.onStart,onStartParams:[this],onComplete:this.onComplete,onCompleteParams:[this]},this.start)}onUpdate(e){this.targets()[0][0]>0&&e.mirrorEffect.init(e.start,e.start+e.duration,e.experience.sizes.width,e.experience.sizes.height,e.animationIn,e.animationOut,e.displacement),e.onUpdateProgress(this._tTime,this._tDur)}}class qE{constructor(e){Ct(this,"effects",[{start:1,end:30,effect:new Ar({destPow:[3,3,8],destMul:[2,2,15],destAdd:[.05,.05,.5]})},{start:8.5,end:9,effect:new it({scaleX:2,scaleZ:.65,ease:"bounce"})},{start:9,end:9.5,effect:new it({scaleZ:3,scaleX:.75,scaleY:.63,ease:"bounce"})},{start:12,end:12.5,effect:new si({position:50,ease:"bounce"})},{start:24.75,end:25.25,effect:new it({scaleX:3.5,ease:"bounce"})},{start:33,end:41,effect:new $i({audioStrength:1.75,thickness:.15,color:new ve(2,2,0)})},{start:49,end:51,effect:new $i({audioStrength:1.5,thickness:.2,color:new ve(2,0,0)})},{start:73,end:77,effect:new Nt({destThickness:.35})},{start:89,end:93,effect:new Nt({destThickness:.5})},{start:89,end:93,effect:new Zt({destIntensity:2.48,destRadius:1.15,yoyo:!0})},{start:113.5,end:115,effect:new Ar({originPow:[3,3,8],originMul:[2,2,15],originAdd:[.05,.05,.5],destPow:[8,3,8],destMul:[15,2,15],destAdd:[.6,.05,.5],yoyo:!0})},{start:114,end:114.5,effect:new si({position:50,ease:"bounce"})},{start:114,end:114.25,effect:new it({scaleX:2.3,scaleZ:.75,ease:"bounce-inOut"})},{start:144,end:146,effect:new Zt({destIntensity:1.48,destRadius:1.15,yoyo:!0})},{start:144.5,end:145,effect:new Nt({destThickness:.15,destAudioStrength:.75,ease:"bounce"})},{start:144.5,end:145,effect:new si({position:50,ease:"bounce"})},{start:144.5,end:145,effect:new Nt({originMirrors:1,destMirrors:2,yoyo:!1})},{start:145.5,end:146,effect:new Nt({originMirrors:2,destMirrors:2,destThickness:.15,destAudioStrength:.75,ease:"bounce"})},{start:145.5,end:146,effect:new si({position:50,ease:"bounce"})},{start:161.5,end:162,effect:new it({scaleX:2.3,scaleY:1.3,scaleZ:.75,ease:"bounce-inOut"})},{start:175,end:178.5,effect:new Nt({destThickness:.35,originMirrors:2,destMirrors:2})},{start:182.5,end:184,effect:new Zt({destIntensity:-1.1,destRadius:-1.85,yoyo:!0})},{start:184.5,end:185.5,effect:new Zt({destIntensity:-3,destRadius:.85,yoyo:!0})},{start:192.5,end:194,effect:new Zt({destIntensity:3,destRadius:1.35,yoyo:!0})},{start:202,end:206.5,effect:new Nt({destThickness:.35,originMirrors:2,destMirrors:2})},{start:211,end:211.5,effect:new si({position:50,ease:"bounce"})},{start:218,end:223.25,effect:new Nt({destThickness:.5,originMirrors:2,destMirrors:2})},{start:243.5,end:245,effect:new Ar({originPow:[3,3,8],originMul:[2,2,15],originAdd:[.05,.05,.5],destPow:[8,3,8],destMul:[15,2,15],destAdd:[.6,.05,.5],yoyo:!0})},{start:244,end:244.5,effect:new si({position:50,ease:"bounce"})},{start:244,end:244.25,effect:new it({scaleX:2.3,scaleZ:.75,ease:"bounce-inOut"})},{start:274,end:274.75,effect:new it({scaleX:3.5,ease:"bounce"})},{start:274.75,end:275.5,effect:new it({scaleZ:2.75,ease:"bounce"})},{start:291,end:291.5,effect:new Zt({destIntensity:3,destRadius:1.35,yoyo:!0})},{start:291.25,end:291.75,effect:new si({position:25,ease:"bounce"})},{start:304,end:308,effect:new Nt({destThickness:.35,originMirrors:2,destMirrors:2})},{start:312.5,end:313.5,effect:new Zt({destIntensity:-3,destRadius:.85,yoyo:!0})},{start:314.5,end:315.5,effect:new Zt({destIntensity:-3,destRadius:.85,yoyo:!0})},{start:322.5,end:324,effect:new Zt({destIntensity:3,destRadius:1.35,yoyo:!0})},{start:326,end:332.5,effect:new Nt({destThickness:.35,originMirrors:2,destMirrors:2})},{start:341,end:347.5,effect:new Nt({destThickness:.5,originMirrors:2,destMirrors:2})},{start:356,end:361,effect:new $i({audioStrength:.75,thickness:.25,color:new ve(0,2,3)})},{start:390,end:394,effect:new Nt({destThickness:.25,originMirrors:2,destMirrors:64,destAudioStrength:.5,yoyo:!1})},{start:394,end:395,effect:new si({position:50,ease:"elastic"})},{start:393.5,end:399.5,effect:new Vh({animationIn:.5,animationOut:1.5,displacement:.2})},{start:399,end:402,effect:new Nt({originAudioStrength:.5,destAudioStrength:.5,originThickness:.25,originMirrors:64,destMirrors:64,destThickness:.15,yoyo:!1})},{start:404,end:408,effect:new Zt({destIntensity:2,destRadius:1.12,yoyo:!1})},{start:406,end:415,effect:new Nt({originAudioStrength:.5,originThickness:.15,originMirrors:64,destMirrors:3,yoyo:!1})},{start:406,end:406.5,effect:new it({scaleX:1.75,ease:"bounce"})},{start:410,end:410.5,effect:new it({scaleX:.25,ease:"bounce"})},{start:413,end:427,effect:new Vh({animationIn:1,animationOut:2.5,displacement:.2})},{start:419,end:423,effect:new Zt({originIntensity:2,originRadius:1.12,yoyo:!1})},{start:430,end:430.5,effect:new it({scaleX:2,scaleZ:.65,ease:"bounce"})},{start:430.5,end:431,effect:new it({scaleZ:3,scaleX:.75,scaleY:.63,ease:"bounce"})},{start:434,end:434.5,effect:new it({scaleX:.375,ease:"bounce"})},{start:445,end:449,effect:new Ar({originPow:[3,3,8],originMul:[2,2,15],originAdd:[.05,.05,.5],destPow:[3,8,8],destMul:[2,15,15],destAdd:[.05,.5,.5],yoyo:!0})},{start:446.75,end:447.25,effect:new it({scaleX:3.5,ease:"bounce"})},{start:454,end:460,effect:new $i({audioStrength:.75,thickness:.15,color:new ve(2,0,0)})},{start:467,end:470,effect:new Nt({destThickness:.35,originMirrors:3,destMirrors:3})},{start:475,end:476,effect:new Zt({destIntensity:-3,destRadius:.85,yoyo:!0})},{start:477.5,end:478.5,effect:new Zt({destIntensity:-3,destRadius:.85,yoyo:!0})},{start:485.5,end:487,effect:new Zt({destIntensity:3,destRadius:1.35,yoyo:!0})},{start:488,end:493.5,effect:new Nt({destThickness:.35,originMirrors:3,destMirrors:3})},{start:503,end:508.5,effect:new Nt({destThickness:.5,originMirrors:3,destMirrors:3})},{start:520,end:521,effect:new $i({audioStrength:1.5,thickness:.15,color:new ve(2,0,0)})},{start:535,end:540,effect:new $i({audioStrength:1.75,thickness:.2,color:new ve(0,0,2)})},{start:553,end:556,effect:new $i({audioStrength:1.5,thickness:.15,color:new ve(2,0,0)})},{start:553,end:553.5,effect:new si({position:50,ease:"bounce"})},{start:552.5,end:553,effect:new it({scaleX:2.3,scaleZ:.75,ease:"bounce-inOut"})},{start:560,end:561,effect:new Ar({originPow:[3,3,8],originMul:[2,2,15],originAdd:[.05,.05,.5],destPow:[3,3,3],destMul:[2,2,2],destAdd:[.05,.05,.05]})}]);this.channels={LateralBars1:e.channelOther,LateralBars2:e.channelBass,LateralOsciloscope:e.channelDrum,Sun:e.channelVocal,SunRays:e.channelVocal,SpiralBars:e.channelSong,SpiralOsciloscope:e.channelVocal}}}class YE{constructor(e){Ct(this,"effects",[]);this.channels={LateralBars1:e.channelOther,LateralBars2:e.channelPiano,LateralOsciloscope:e.channelDrum,Sun:e.channelVocal,SunRays:e.channelVocal,SpiralBars:e.channelSong,SpiralOsciloscope:e.channelVocal}}}class jE{constructor(e){Ct(this,"effects",[]);this.channels={LateralBars1:e.channelOther,LateralBars2:e.channelBass,LateralOsciloscope:e.channelDrum,Sun:e.channelVocal,SunRays:e.channelVocal,SpiralBars:e.channelSong,SpiralOsciloscope:e.channelVocal}}}class KE{constructor(e){Ct(this,"effects",[]);this.channels={LateralBars1:e.channelOther,LateralBars2:e.channelBass,LateralOsciloscope:e.channelDrum,Sun:e.channelVocal,SunRays:e.channelVocal,SpiralBars:e.channelSong,SpiralOsciloscope:e.channelVocal}}}class $E{constructor(e){Ct(this,"effects",[]);this.channels={LateralBars1:e.channelOther,LateralBars2:e.channelBass,LateralOsciloscope:e.channelDrum,Sun:e.channelVocal,SunRays:e.channelVocal,SpiralBars:e.channelSong,SpiralOsciloscope:e.channelVocal}}}class ZE{constructor(e){Ct(this,"effects",[]);this.channels={LateralBars1:e.channelOther,LateralBars2:e.channelBass,LateralOsciloscope:e.channelDrum,Sun:e.channelVocal,SunRays:e.channelVocal,SpiralBars:e.channelSong,SpiralOsciloscope:e.channelVocal}}}class JE{constructor(e){Ct(this,"effects",[]);this.channels={LateralBars1:e.channelOther,LateralBars2:e.channelBass,LateralOsciloscope:e.channelDrum,Sun:e.channelVocal,SunRays:e.channelVocal,SpiralBars:e.channelSong,SpiralOsciloscope:e.channelVocal}}}class QE{constructor(e){Ct(this,"effects",[{start:1.5,end:2,effect:new it({scaleX:2,scaleZ:.5,ease:"bounce"})},{start:9,end:9.5,effect:new it({scaleX:.125,scaleZ:2,ease:"bounce"})},{start:17,end:17.5,effect:new it({scaleX:2,scaleZ:.25,ease:"bounce"})},{start:24.5,end:25,effect:new it({scaleX:.125,scaleZ:2,ease:"bounce"})},{start:32.5,end:33,effect:new it({scaleX:2,scaleZ:.25,ease:"bounce"})},{start:40,end:40.5,effect:new it({scaleX:.25,scaleZ:2,ease:"bounce"})},{start:48,end:48.5,effect:new it({scaleX:2,scaleZ:.25,ease:"bounce"})},{start:56,end:56.5,effect:new it({scaleX:.25,scaleZ:2,ease:"bounce"})}]);this.channels={LateralBars1:e.channelOther,LateralBars2:e.channelBass,LateralOsciloscope:e.channelDrum,Sun:e.channelVocal,SunRays:e.channelVocal,SpiralBars:e.channelSong,SpiralOsciloscope:e.channelVocal}}}class eT{constructor(){this.experience=new gt,this.audioAnalizer=this.experience.audioAnalizer,this.killCityKills=new qE(this.audioAnalizer),this.nothingsOver=new YE(this.audioAnalizer),this.oneChance=new jE(this.audioAnalizer),this.quantumOcean=new KE(this.audioAnalizer),this.sixFeetUnder=new $E(this.audioAnalizer),this.theDeep=new ZE(this.audioAnalizer),this.alone=new JE(this.audioAnalizer),this.lost=new QE(this.audioAnalizer),this.songChannels=[this.killCityKills.channels,this.nothingsOver.channels,this.oneChance.channels,this.quantumOcean.channels,this.sixFeetUnder.channels,this.theDeep.channels,this.alone.channels,this.lost.channels],this.songsEffects=[this.killCityKills.effects,this.nothingsOver.effects,this.oneChance.effects,this.quantumOcean.effects,this.sixFeetUnder.effects,this.theDeep.effects,this.alone.effects,this.lost.effects]}RecalculateAnimations(e){console.log("recalculate animations");const t=this.experience.currentSong,n=this.experience.song.bpmMS;this.songsEffects[t].forEach(s=>{let r=s.start*n/1e3,a=s.end*n/1e3-r;s.effect.setupAnimation(e,r,a)})}}class tT{constructor(){this.experience=new gt,this.canvas=this.experience.canvas,this.scene=this.experience.scene,this.resources=this.experience.resources,this.camera=this.experience.camera.instance,this.sizes=this.experience.sizes,this.time=this.experience.time,this.ready=!1,this.setup()}setup(){this.group=new Ri,this.scene.add(this.group),this.backgroundPosition=0,this.background=new PM(this,"background1"),this.group.position.z=5}setQuality(){Cr.ticker.remove(Cr.updateRoot),this.timeline=Cr.timeline(),this.spirals=new pM(this),this.sun=new _M(this),this.raysToHole=new SM,this.hmlBars=new TM(this),this.hmlOsciloscope=new wM(this),this.bpmEffects=new eT(this),this.songChannels=this.bpmEffects.songChannels[this.experience.currentSong],this.update=this.updateQuality}resourcesLoaded(){this.background.updateBackground(),this.ready=!0}update(e){const t=e/1e3;this.background.update(t),this.background.mesh.rotation.z+=t/75,this.group.rotation.z+=e/7500}updateQuality(){const e=this.time.delta/1e3;this.background.update(e),this.background.mesh.rotation.z+=e/75,this.timeline.time(this.experience.audioAnalizer.channelSong.song.currentTime),this.spirals.update(e),this.sun.update(e),this.raysToHole.update(),this.hmlOsciloscope.update(e),this.hmlBars.update(e),this.group.rotation.z+=this.time.delta/7500}asociateChannels(){this.songChannels=this.bpmEffects.songChannels[this.experience.currentSong],this.hmlBars.material.uniforms.uAudioTexture.value=this.songChannels.LateralBars1.bufferCanvasLinear.texture,this.hmlBars.material.uniforms.uAudioTexture2.value=this.songChannels.LateralBars2.bufferCanvasLinear.texture,this.hmlOsciloscope.material.uniforms.uAudioTexture.value=this.songChannels.LateralOsciloscope.bufferCanvasLinear.texture,this.sun.material.uniforms.uAudioTexture.value=this.songChannels.Sun.bufferCanvasLinear.texture,this.spirals.material.uniforms.uAudioTexture.value=this.songChannels.SpiralBars.bufferCanvasLinear.texture,this.spirals.material.uniforms.uAudioTexture2.value=this.songChannels.SpiralOsciloscope.bufferCanvasLinear.texture}setupSong(){this.asociateChannels(),this.timeline.kill(),this.timeline=Cr.timeline(),this.bpmEffects.RecalculateAnimations(this.timeline)}}/**
 * lil-gui
 * https://lil-gui.georgealways.com
 * @version 0.17.0
 * @author George Michael Brower
 * @license MIT
 */class Vn{constructor(e,t,n,s,r="div"){this.parent=e,this.object=t,this.property=n,this._disabled=!1,this._hidden=!1,this.initialValue=this.getValue(),this.domElement=document.createElement("div"),this.domElement.classList.add("controller"),this.domElement.classList.add(s),this.$name=document.createElement("div"),this.$name.classList.add("name"),Vn.nextNameID=Vn.nextNameID||0,this.$name.id=`lil-gui-name-${++Vn.nextNameID}`,this.$widget=document.createElement(r),this.$widget.classList.add("widget"),this.$disable=this.$widget,this.domElement.appendChild(this.$name),this.domElement.appendChild(this.$widget),this.parent.children.push(this),this.parent.controllers.push(this),this.parent.$children.appendChild(this.domElement),this._listenCallback=this._listenCallback.bind(this),this.name(n)}name(e){return this._name=e,this.$name.innerHTML=e,this}onChange(e){return this._onChange=e,this}_callOnChange(){this.parent._callOnChange(this),this._onChange!==void 0&&this._onChange.call(this,this.getValue()),this._changed=!0}onFinishChange(e){return this._onFinishChange=e,this}_callOnFinishChange(){this._changed&&(this.parent._callOnFinishChange(this),this._onFinishChange!==void 0&&this._onFinishChange.call(this,this.getValue())),this._changed=!1}reset(){return this.setValue(this.initialValue),this._callOnFinishChange(),this}enable(e=!0){return this.disable(!e)}disable(e=!0){return e===this._disabled?this:(this._disabled=e,this.domElement.classList.toggle("disabled",e),this.$disable.toggleAttribute("disabled",e),this)}show(e=!0){return this._hidden=!e,this.domElement.style.display=this._hidden?"none":"",this}hide(){return this.show(!1)}options(e){const t=this.parent.add(this.object,this.property,e);return t.name(this._name),this.destroy(),t}min(e){return this}max(e){return this}step(e){return this}decimals(e){return this}listen(e=!0){return this._listening=e,this._listenCallbackID!==void 0&&(cancelAnimationFrame(this._listenCallbackID),this._listenCallbackID=void 0),this._listening&&this._listenCallback(),this}_listenCallback(){this._listenCallbackID=requestAnimationFrame(this._listenCallback);const e=this.save();e!==this._listenPrevValue&&this.updateDisplay(),this._listenPrevValue=e}getValue(){return this.object[this.property]}setValue(e){return this.object[this.property]=e,this._callOnChange(),this.updateDisplay(),this}updateDisplay(){return this}load(e){return this.setValue(e),this._callOnFinishChange(),this}save(){return this.getValue()}destroy(){this.listen(!1),this.parent.children.splice(this.parent.children.indexOf(this),1),this.parent.controllers.splice(this.parent.controllers.indexOf(this),1),this.parent.$children.removeChild(this.domElement)}}class nT extends Vn{constructor(e,t,n){super(e,t,n,"boolean","label"),this.$input=document.createElement("input"),this.$input.setAttribute("type","checkbox"),this.$input.setAttribute("aria-labelledby",this.$name.id),this.$widget.appendChild(this.$input),this.$input.addEventListener("change",()=>{this.setValue(this.$input.checked),this._callOnFinishChange()}),this.$disable=this.$input,this.updateDisplay()}updateDisplay(){return this.$input.checked=this.getValue(),this}}function Nl(i){let e,t;return(e=i.match(/(#|0x)?([a-f0-9]{6})/i))?t=e[2]:(e=i.match(/rgb\(\s*(\d*)\s*,\s*(\d*)\s*,\s*(\d*)\s*\)/))?t=parseInt(e[1]).toString(16).padStart(2,0)+parseInt(e[2]).toString(16).padStart(2,0)+parseInt(e[3]).toString(16).padStart(2,0):(e=i.match(/^#?([a-f0-9])([a-f0-9])([a-f0-9])$/i))&&(t=e[1]+e[1]+e[2]+e[2]+e[3]+e[3]),t?"#"+t:!1}const iT={isPrimitive:!0,match:i=>typeof i=="string",fromHexString:Nl,toHexString:Nl},Xr={isPrimitive:!0,match:i=>typeof i=="number",fromHexString:i=>parseInt(i.substring(1),16),toHexString:i=>"#"+i.toString(16).padStart(6,0)},sT={isPrimitive:!1,match:Array.isArray,fromHexString(i,e,t=1){const n=Xr.fromHexString(i);e[0]=(n>>16&255)/255*t,e[1]=(n>>8&255)/255*t,e[2]=(n&255)/255*t},toHexString([i,e,t],n=1){n=255/n;const s=i*n<<16^e*n<<8^t*n<<0;return Xr.toHexString(s)}},rT={isPrimitive:!1,match:i=>Object(i)===i,fromHexString(i,e,t=1){const n=Xr.fromHexString(i);e.r=(n>>16&255)/255*t,e.g=(n>>8&255)/255*t,e.b=(n&255)/255*t},toHexString({r:i,g:e,b:t},n=1){n=255/n;const s=i*n<<16^e*n<<8^t*n<<0;return Xr.toHexString(s)}},aT=[iT,Xr,sT,rT];function oT(i){return aT.find(e=>e.match(i))}class lT extends Vn{constructor(e,t,n,s){super(e,t,n,"color"),this.$input=document.createElement("input"),this.$input.setAttribute("type","color"),this.$input.setAttribute("tabindex",-1),this.$input.setAttribute("aria-labelledby",this.$name.id),this.$text=document.createElement("input"),this.$text.setAttribute("type","text"),this.$text.setAttribute("spellcheck","false"),this.$text.setAttribute("aria-labelledby",this.$name.id),this.$display=document.createElement("div"),this.$display.classList.add("display"),this.$display.appendChild(this.$input),this.$widget.appendChild(this.$display),this.$widget.appendChild(this.$text),this._format=oT(this.initialValue),this._rgbScale=s,this._initialValueHexString=this.save(),this._textFocused=!1,this.$input.addEventListener("input",()=>{this._setValueFromHexString(this.$input.value)}),this.$input.addEventListener("blur",()=>{this._callOnFinishChange()}),this.$text.addEventListener("input",()=>{const r=Nl(this.$text.value);r&&this._setValueFromHexString(r)}),this.$text.addEventListener("focus",()=>{this._textFocused=!0,this.$text.select()}),this.$text.addEventListener("blur",()=>{this._textFocused=!1,this.updateDisplay(),this._callOnFinishChange()}),this.$disable=this.$text,this.updateDisplay()}reset(){return this._setValueFromHexString(this._initialValueHexString),this}_setValueFromHexString(e){if(this._format.isPrimitive){const t=this._format.fromHexString(e);this.setValue(t)}else this._format.fromHexString(e,this.getValue(),this._rgbScale),this._callOnChange(),this.updateDisplay()}save(){return this._format.toHexString(this.getValue(),this._rgbScale)}load(e){return this._setValueFromHexString(e),this._callOnFinishChange(),this}updateDisplay(){return this.$input.value=this._format.toHexString(this.getValue(),this._rgbScale),this._textFocused||(this.$text.value=this.$input.value.substring(1)),this.$display.style.backgroundColor=this.$input.value,this}}class al extends Vn{constructor(e,t,n){super(e,t,n,"function"),this.$button=document.createElement("button"),this.$button.appendChild(this.$name),this.$widget.appendChild(this.$button),this.$button.addEventListener("click",s=>{s.preventDefault(),this.getValue().call(this.object)}),this.$button.addEventListener("touchstart",()=>{},{passive:!0}),this.$disable=this.$button}}class cT extends Vn{constructor(e,t,n,s,r,a){super(e,t,n,"number"),this._initInput(),this.min(s),this.max(r);const o=a!==void 0;this.step(o?a:this._getImplicitStep(),o),this.updateDisplay()}decimals(e){return this._decimals=e,this.updateDisplay(),this}min(e){return this._min=e,this._onUpdateMinMax(),this}max(e){return this._max=e,this._onUpdateMinMax(),this}step(e,t=!0){return this._step=e,this._stepExplicit=t,this}updateDisplay(){const e=this.getValue();if(this._hasSlider){let t=(e-this._min)/(this._max-this._min);t=Math.max(0,Math.min(t,1)),this.$fill.style.width=t*100+"%"}return this._inputFocused||(this.$input.value=this._decimals===void 0?e:e.toFixed(this._decimals)),this}_initInput(){this.$input=document.createElement("input"),this.$input.setAttribute("type","number"),this.$input.setAttribute("step","any"),this.$input.setAttribute("aria-labelledby",this.$name.id),this.$widget.appendChild(this.$input),this.$disable=this.$input;const e=()=>{let f=parseFloat(this.$input.value);isNaN(f)||(this._stepExplicit&&(f=this._snap(f)),this.setValue(this._clamp(f)))},t=f=>{const y=parseFloat(this.$input.value);isNaN(y)||(this._snapClampSetValue(y+f),this.$input.value=this.getValue())},n=f=>{f.code==="Enter"&&this.$input.blur(),f.code==="ArrowUp"&&(f.preventDefault(),t(this._step*this._arrowKeyMultiplier(f))),f.code==="ArrowDown"&&(f.preventDefault(),t(this._step*this._arrowKeyMultiplier(f)*-1))},s=f=>{this._inputFocused&&(f.preventDefault(),t(this._step*this._normalizeMouseWheel(f)))};let r=!1,a,o,l,c,u;const h=5,d=f=>{a=f.clientX,o=l=f.clientY,r=!0,c=this.getValue(),u=0,window.addEventListener("mousemove",p),window.addEventListener("mouseup",_)},p=f=>{if(r){const y=f.clientX-a,v=f.clientY-o;Math.abs(v)>h?(f.preventDefault(),this.$input.blur(),r=!1,this._setDraggingStyle(!0,"vertical")):Math.abs(y)>h&&_()}if(!r){const y=f.clientY-l;u-=y*this._step*this._arrowKeyMultiplier(f),c+u>this._max?u=this._max-c:c+u<this._min&&(u=this._min-c),this._snapClampSetValue(c+u)}l=f.clientY},_=()=>{this._setDraggingStyle(!1,"vertical"),this._callOnFinishChange(),window.removeEventListener("mousemove",p),window.removeEventListener("mouseup",_)},g=()=>{this._inputFocused=!0},m=()=>{this._inputFocused=!1,this.updateDisplay(),this._callOnFinishChange()};this.$input.addEventListener("input",e),this.$input.addEventListener("keydown",n),this.$input.addEventListener("wheel",s,{passive:!1}),this.$input.addEventListener("mousedown",d),this.$input.addEventListener("focus",g),this.$input.addEventListener("blur",m)}_initSlider(){this._hasSlider=!0,this.$slider=document.createElement("div"),this.$slider.classList.add("slider"),this.$fill=document.createElement("div"),this.$fill.classList.add("fill"),this.$slider.appendChild(this.$fill),this.$widget.insertBefore(this.$slider,this.$input),this.domElement.classList.add("hasSlider");const e=(f,y,v,S,M)=>(f-y)/(v-y)*(M-S)+S,t=f=>{const y=this.$slider.getBoundingClientRect();let v=e(f,y.left,y.right,this._min,this._max);this._snapClampSetValue(v)},n=f=>{this._setDraggingStyle(!0),t(f.clientX),window.addEventListener("mousemove",s),window.addEventListener("mouseup",r)},s=f=>{t(f.clientX)},r=()=>{this._callOnFinishChange(),this._setDraggingStyle(!1),window.removeEventListener("mousemove",s),window.removeEventListener("mouseup",r)};let a=!1,o,l;const c=f=>{f.preventDefault(),this._setDraggingStyle(!0),t(f.touches[0].clientX),a=!1},u=f=>{f.touches.length>1||(this._hasScrollBar?(o=f.touches[0].clientX,l=f.touches[0].clientY,a=!0):c(f),window.addEventListener("touchmove",h,{passive:!1}),window.addEventListener("touchend",d))},h=f=>{if(a){const y=f.touches[0].clientX-o,v=f.touches[0].clientY-l;Math.abs(y)>Math.abs(v)?c(f):(window.removeEventListener("touchmove",h),window.removeEventListener("touchend",d))}else f.preventDefault(),t(f.touches[0].clientX)},d=()=>{this._callOnFinishChange(),this._setDraggingStyle(!1),window.removeEventListener("touchmove",h),window.removeEventListener("touchend",d)},p=this._callOnFinishChange.bind(this),_=400;let g;const m=f=>{if(Math.abs(f.deltaX)<Math.abs(f.deltaY)&&this._hasScrollBar)return;f.preventDefault();const v=this._normalizeMouseWheel(f)*this._step;this._snapClampSetValue(this.getValue()+v),this.$input.value=this.getValue(),clearTimeout(g),g=setTimeout(p,_)};this.$slider.addEventListener("mousedown",n),this.$slider.addEventListener("touchstart",u,{passive:!1}),this.$slider.addEventListener("wheel",m,{passive:!1})}_setDraggingStyle(e,t="horizontal"){this.$slider&&this.$slider.classList.toggle("active",e),document.body.classList.toggle("lil-gui-dragging",e),document.body.classList.toggle(`lil-gui-${t}`,e)}_getImplicitStep(){return this._hasMin&&this._hasMax?(this._max-this._min)/1e3:.1}_onUpdateMinMax(){!this._hasSlider&&this._hasMin&&this._hasMax&&(this._stepExplicit||this.step(this._getImplicitStep(),!1),this._initSlider(),this.updateDisplay())}_normalizeMouseWheel(e){let{deltaX:t,deltaY:n}=e;return Math.floor(e.deltaY)!==e.deltaY&&e.wheelDelta&&(t=0,n=-e.wheelDelta/120,n*=this._stepExplicit?1:10),t+-n}_arrowKeyMultiplier(e){let t=this._stepExplicit?1:10;return e.shiftKey?t*=10:e.altKey&&(t/=10),t}_snap(e){const t=Math.round(e/this._step)*this._step;return parseFloat(t.toPrecision(15))}_clamp(e){return e<this._min&&(e=this._min),e>this._max&&(e=this._max),e}_snapClampSetValue(e){this.setValue(this._clamp(this._snap(e)))}get _hasScrollBar(){const e=this.parent.root.$children;return e.scrollHeight>e.clientHeight}get _hasMin(){return this._min!==void 0}get _hasMax(){return this._max!==void 0}}class uT extends Vn{constructor(e,t,n,s){super(e,t,n,"option"),this.$select=document.createElement("select"),this.$select.setAttribute("aria-labelledby",this.$name.id),this.$display=document.createElement("div"),this.$display.classList.add("display"),this._values=Array.isArray(s)?s:Object.values(s),this._names=Array.isArray(s)?s:Object.keys(s),this._names.forEach(r=>{const a=document.createElement("option");a.innerHTML=r,this.$select.appendChild(a)}),this.$select.addEventListener("change",()=>{this.setValue(this._values[this.$select.selectedIndex]),this._callOnFinishChange()}),this.$select.addEventListener("focus",()=>{this.$display.classList.add("focus")}),this.$select.addEventListener("blur",()=>{this.$display.classList.remove("focus")}),this.$widget.appendChild(this.$select),this.$widget.appendChild(this.$display),this.$disable=this.$select,this.updateDisplay()}updateDisplay(){const e=this.getValue(),t=this._values.indexOf(e);return this.$select.selectedIndex=t,this.$display.innerHTML=t===-1?e:this._names[t],this}}class hT extends Vn{constructor(e,t,n){super(e,t,n,"string"),this.$input=document.createElement("input"),this.$input.setAttribute("type","text"),this.$input.setAttribute("aria-labelledby",this.$name.id),this.$input.addEventListener("input",()=>{this.setValue(this.$input.value)}),this.$input.addEventListener("keydown",s=>{s.code==="Enter"&&this.$input.blur()}),this.$input.addEventListener("blur",()=>{this._callOnFinishChange()}),this.$widget.appendChild(this.$input),this.$disable=this.$input,this.updateDisplay()}updateDisplay(){return this.$input.value=this.getValue(),this}}const dT=`.lil-gui {
